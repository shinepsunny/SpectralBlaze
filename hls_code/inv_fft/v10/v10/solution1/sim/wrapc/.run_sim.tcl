...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "vr_ifft.autotvin.dat"
	set constFileTvOut       "vr_ifft.autotvout.dat"
	set constFileHdlTvIn     "vr_ifft.autohdltvin.dat"
	set constFileHdlTvOut    "vr_ifft.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
