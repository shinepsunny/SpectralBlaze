...
// wrapc file define:
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.vr_ifft.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.vr_ifft.autotvout_gmem.dat"
// wrapc file define:
#define AUTOTB_TVIN_in "../tv/cdatafile/c.vr_ifft.autotvin_in_r.dat"
#define AUTOTB_TVOUT_in "../tv/cdatafile/c.vr_ifft.autotvout_in_r.dat"
// wrapc file define:
#define AUTOTB_TVIN_out "../tv/cdatafile/c.vr_ifft.autotvin_out_r.dat"
#define AUTOTB_TVOUT_out "../tv/cdatafile/c.vr_ifft.autotvout_out_r.dat"
// wrapc file define:
#define AUTOTB_TVIN_ctrl1_reg "../tv/cdatafile/c.vr_ifft.autotvin_ctrl1_reg.dat"
#define AUTOTB_TVOUT_ctrl1_reg "../tv/cdatafile/c.vr_ifft.autotvout_ctrl1_reg.dat"
// wrapc file define:
#define AUTOTB_TVIN_ctrl2_reg "../tv/cdatafile/c.vr_ifft.autotvin_ctrl2_reg.dat"
#define AUTOTB_TVOUT_ctrl2_reg "../tv/cdatafile/c.vr_ifft.autotvout_ctrl2_reg.dat"
// wrapc file define:
#define AUTOTB_TVIN_layer1_reg "../tv/cdatafile/c.vr_ifft.autotvin_layer1_reg.dat"
#define AUTOTB_TVOUT_layer1_reg "../tv/cdatafile/c.vr_ifft.autotvout_layer1_reg.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.vr_ifft.autotvout_gmem.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_in "../tv/rtldatafile/rtl.vr_ifft.autotvout_in_r.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_out "../tv/rtldatafile/rtl.vr_ifft.autotvout_out_r.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_ctrl1_reg "../tv/rtldatafile/rtl.vr_ifft.autotvout_ctrl1_reg.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_ctrl2_reg "../tv/rtldatafile/rtl.vr_ifft.autotvout_ctrl2_reg.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_layer1_reg "../tv/rtldatafile/rtl.vr_ifft.autotvout_layer1_reg.dat"
...
extern "C" void vr_ifft_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);

extern "C" void apatb_vr_ifft_hw(volatile void * __xlx_apatb_param_in, volatile void * __xlx_apatb_param_out, volatile void * __xlx_apatb_param_ctrl1_reg, volatile void * __xlx_apatb_param_ctrl2_reg, volatile void * __xlx_apatb_param_layer1_reg) {
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<128> > gmem_pc_buffer(2048);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 1024; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_in)[j*2+0] = gmem_pc_buffer[i].range(63,0).to_int64();
((long long*)__xlx_apatb_param_in)[j*2+1] = gmem_pc_buffer[i].range(127,64).to_int64();
}
...
// print gmem Transactions
{
  ...
  {  __xlx_offset_byte_param_in = 0*16;
...
__xlx_tmp_lv.range(127,64) = ((long long*)__xlx_apatb_param_in)[j*2+1];
  ...
  __xlx_offset_byte_param_out = 1024*16;
...
__xlx_tmp_lv.range(127,64) = ((long long*)__xlx_apatb_param_out)[j*2+1];
  ...
  tcl_file.set_num(2048, &tcl_file.gmem_depth);
...
vr_ifft_hw_stub_wrapper(__xlx_apatb_param_in, __xlx_apatb_param_out, __xlx_apatb_param_ctrl1_reg, __xlx_apatb_param_ctrl2_reg, __xlx_apatb_param_layer1_reg);
