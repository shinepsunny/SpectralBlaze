set moduleName rd_data_Pipeline_VITIS_LOOP_157_1_VITIS_LOOP_160_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {rd_data_Pipeline_VITIS_LOOP_157_1_VITIS_LOOP_160_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 128 regular {axi_master 0}  }
	{ sext_ln157_1 int 60 regular  }
	{ mul_ln157_2 int 38 regular  }
	{ in_st int 128 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "ctrl_bus"},"direction": "READONLY"},{"cName": "out1","offset": { "type": "dynamic","port_name": "out1","bundle": "ctrl_bus"},"direction": "WRITEONLY"},{"cName": "out2","offset": { "type": "dynamic","port_name": "out2","bundle": "ctrl_bus"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln157_1", "interface" : "wire", "bitwidth" : 60, "direction" : "READONLY"} , 
 	{ "Name" : "mul_ln157_2", "interface" : "wire", "bitwidth" : 38, "direction" : "READONLY"} , 
 	{ "Name" : "in_st", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ in_st_din sc_out sc_lv 128 signal 3 } 
	{ in_st_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ in_st_fifo_cap sc_in sc_lv 2 signal 3 } 
	{ in_st_full_n sc_in sc_logic 1 signal 3 } 
	{ in_st_write sc_out sc_logic 1 signal 3 } 
	{ sext_ln157_1 sc_in sc_lv 60 signal 1 } 
	{ mul_ln157_2 sc_in sc_lv 38 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_st_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "in_st", "role": "din" }} , 
 	...
 	{ "name": "in_st_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_st", "role": "full_n" }} , 
 	{ "name": "in_st_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_st", "role": "write" }} , 
 	{ "name": "sext_ln157_1", "direction": "in", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "sext_ln157_1", "role": "default" }} , 
 	{ "name": "mul_ln157_2", "direction": "in", "datatype": "sc_lv", "bitwidth":38, "type": "signal", "bundle":{"name": "mul_ln157_2", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln157_1 { ap_none {  { sext_ln157_1 in_data 0 60 } } }
	mul_ln157_2 { ap_none {  { mul_ln157_2 in_data 0 38 } } }
	in_st { ap_fifo {  { in_st_din fifo_port_we 1 128 }  { in_st_num_data_valid fifo_status_num_data_valid 0 2 }  { in_st_fifo_cap fifo_update 0 2 }  { in_st_full_n fifo_status 0 1 }  { in_st_write fifo_data 1 1 } } }
}
