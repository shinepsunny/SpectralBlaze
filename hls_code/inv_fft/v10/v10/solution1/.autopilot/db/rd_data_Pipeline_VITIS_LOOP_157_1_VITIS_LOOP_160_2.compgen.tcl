...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { sext_ln157_1 { I 60 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln157_2 \
    op interface \
    ports { mul_ln157_2 { I 38 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_in_st \
    op interface \
    ports { in_st_din { O 128 vector } in_st_num_data_valid { I 2 vector } in_st_fifo_cap { I 2 vector } in_st_full_n { I 1 bit } in_st_write { O 1 bit } } \
} "
}
