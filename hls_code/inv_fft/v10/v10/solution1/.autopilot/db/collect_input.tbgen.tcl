...
set portList { 
	...
	{ in_st_dout sc_in sc_lv 128 signal 0 } 
	{ in_st_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ in_st_fifo_cap sc_in sc_lv 2 signal 0 } 
	{ in_st_empty_n sc_in sc_logic 1 signal 0 } 
	{ in_st_read sc_out sc_logic 1 signal 0 } 
	{ I_address0 sc_out sc_lv 12 signal 1 } 
	{ I_ce0 sc_out sc_logic 1 signal 1 } 
	{ I_we0 sc_out sc_logic 1 signal 1 } 
	{ I_d0 sc_out sc_lv 32 signal 1 } 
	{ I_address1 sc_out sc_lv 12 signal 1 } 
	{ I_ce1 sc_out sc_logic 1 signal 1 } 
	{ I_we1 sc_out sc_logic 1 signal 1 } 
	{ I_d1 sc_out sc_lv 32 signal 1 } 
	{ ctrl1_regp_dout sc_in sc_lv 32 signal 2 } 
	{ ctrl1_regp_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ ctrl1_regp_fifo_cap sc_in sc_lv 2 signal 2 } 
	{ ctrl1_regp_empty_n sc_in sc_logic 1 signal 2 } 
	{ ctrl1_regp_read sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ctrl1_regp_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ctrl1_regp", "role": "dout" }} , 
 	{ "name": "ctrl1_regp_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "ctrl1_regp", "role": "num_data_valid" }} , 
 	{ "name": "ctrl1_regp_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "ctrl1_regp", "role": "fifo_cap" }} , 
 	{ "name": "ctrl1_regp_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ctrl1_regp", "role": "empty_n" }} , 
 	{ "name": "ctrl1_regp_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ctrl1_regp", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "in_st", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_collect_input_Pipeline_VITIS_LOOP_91_2_fu_78", "Port" : "in_st", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "I", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_collect_input_Pipeline_VITIS_LOOP_91_2_fu_78", "Port" : "I", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "ctrl1_regp", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "ctrl1_regp_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_88_1", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "3", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state3"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_collect_input_Pipeline_VITIS_LOOP_91_2_fu_78", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_collect_input_Pipeline_VITIS_LOOP_91_2_fu_78.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "193"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "193"}
]}
...
set Spec2ImplPortList { 
	...
	ctrl1_regp { ap_fifo {  { ctrl1_regp_dout fifo_port_we 0 32 }  { ctrl1_regp_num_data_valid fifo_status_num_data_valid 0 2 }  { ctrl1_regp_fifo_cap fifo_update 0 2 }  { ctrl1_regp_empty_n fifo_status 0 1 }  { ctrl1_regp_read fifo_data 1 1 } } }
}
