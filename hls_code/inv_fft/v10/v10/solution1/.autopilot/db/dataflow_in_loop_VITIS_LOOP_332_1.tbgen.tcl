set moduleName dataflow_in_loop_VITIS_LOOP_332_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dataflow_in_loop_VITIS_LOOP_332_1}
...
set portList { 
	...
	{ ctrl1_reg_ls sc_in sc_lv 8 signal 1 } 
	{ ctrl2_reg_pn sc_in sc_lv 8 signal 2 } 
	{ actp_reg_pool_size sc_in sc_lv 8 signal 3 } 
	...
	{ out1 sc_in sc_lv 64 signal 5 } 
	{ out2 sc_in sc_lv 64 signal 6 } 
	{ layer2_reg_ifs sc_in sc_lv 16 signal 7 } 
	{ out1_ap_vld sc_in sc_logic 1 invld 5 } 
	{ out2_ap_vld sc_in sc_logic 1 invld 6 } 
	{ layer2_reg_ifs_ap_vld sc_in sc_logic 1 invld 7 } 
	{ ap_start sc_in sc_logic 1 start -1 } 
	{ ctrl1_reg_ls_ap_vld sc_in sc_logic 1 invld 1 } 
	{ ctrl2_reg_pn_ap_vld sc_in sc_logic 1 invld 2 } 
	{ actp_reg_pool_size_ap_vld sc_in sc_logic 1 invld 3 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "11", "18", "19", "20", "21", "22"],
		...
		"Port" : [
			{"Name" : "out_st", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "buffer_U0", "Port" : "out_st"}]},
			...
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "write_U0", "Port" : "gmem"}]},
			...
			{"Name" : "wr_ptr1", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "write_U0", "Port" : "wr_ptr1"}]},
			{"Name" : "wr_ptr2", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "write_U0", "Port" : "wr_ptr2"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.buffer1_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.buffer1_1_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.entry_proc_U0", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "out1", "Type" : "None", "Direction" : "I"},
			{"Name" : "out1_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["11"], "DependentChan" : "18", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "out1_c_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "out2", "Type" : "None", "Direction" : "I"},
			{"Name" : "out2_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["11"], "DependentChan" : "19", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "out2_c_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer2_reg_ifs", "Type" : "None", "Direction" : "I"},
			{"Name" : "layer2_reg_ifs_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["11"], "DependentChan" : "20", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "layer2_reg_ifs_c_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.buffer_U0", "Parent" : "0", "Child" : ["5", "8", "9", "10"],
		"CDFG" : "buffer_r",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "out_st", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_buffer_Pipeline_VITIS_LOOP_304_1_VITIS_LOOP_307_2_VITIS_LOOP_310_3_fu_58", "Port" : "out_st", "Inst_start_state" : "16", "Inst_end_state" : "17"}]},
			{"Name" : "buffer1_0", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["11"], "DependentChan" : "1",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_buffer_Pipeline_VITIS_LOOP_304_1_VITIS_LOOP_307_2_VITIS_LOOP_310_3_fu_58", "Port" : "buffer1_0", "Inst_start_state" : "16", "Inst_end_state" : "17"}]},
			{"Name" : "buffer1_1", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["11"], "DependentChan" : "2",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_buffer_Pipeline_VITIS_LOOP_304_1_VITIS_LOOP_307_2_VITIS_LOOP_310_3_fu_58", "Port" : "buffer1_1", "Inst_start_state" : "16", "Inst_end_state" : "17"}]},
			{"Name" : "ctrl1_reg_3", "Type" : "None", "Direction" : "I"},
			{"Name" : "ctrl2_reg_0", "Type" : "None", "Direction" : "I"},
			{"Name" : "actp_reg_3", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.buffer_U0.grp_buffer_Pipeline_VITIS_LOOP_304_1_VITIS_LOOP_307_2_VITIS_LOOP_310_3_fu_58", "Parent" : "4", "Child" : ["6", "7"],
	...
	{"ID" : "6", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.buffer_U0.grp_buffer_Pipeline_VITIS_LOOP_304_1_VITIS_LOOP_307_2_VITIS_LOOP_310_3_fu_58.mul_8ns_8ns_16_1_1_U369", "Parent" : "5"},
	{"ID" : "7", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.buffer_U0.grp_buffer_Pipeline_VITIS_LOOP_304_1_VITIS_LOOP_307_2_VITIS_LOOP_310_3_fu_58.flow_control_loop_pipe_sequential_init_U", "Parent" : "5"},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.buffer_U0.udiv_8ns_8ns_8_12_seq_1_U378", "Parent" : "4"},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.buffer_U0.mul_8ns_8ns_39_1_1_U379", "Parent" : "4"},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.buffer_U0.mul_8ns_16ns_47_1_1_U380", "Parent" : "4"},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.write_U0", "Parent" : "0", "Child" : ["12", "14", "16", "17"],
		"CDFG" : "write_r",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "buffer1_0", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["4"], "DependentChan" : "1",
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_write_Pipeline_VITIS_LOOP_286_5_fu_173", "Port" : "buffer1_0", "Inst_start_state" : "45", "Inst_end_state" : "46"},
					{"ID" : "12", "SubInstance" : "grp_write_Pipeline_VITIS_LOOP_273_2_fu_160", "Port" : "buffer1_0", "Inst_start_state" : "36", "Inst_end_state" : "37"}]},
			{"Name" : "buffer1_1", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["4"], "DependentChan" : "2",
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_write_Pipeline_VITIS_LOOP_286_5_fu_173", "Port" : "buffer1_1", "Inst_start_state" : "45", "Inst_end_state" : "46"},
					{"ID" : "12", "SubInstance" : "grp_write_Pipeline_VITIS_LOOP_273_2_fu_160", "Port" : "buffer1_1", "Inst_start_state" : "36", "Inst_end_state" : "37"}]},
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "gmem_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "gmem_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_write_Pipeline_VITIS_LOOP_286_5_fu_173", "Port" : "gmem", "Inst_start_state" : "45", "Inst_end_state" : "46"},
					{"ID" : "12", "SubInstance" : "grp_write_Pipeline_VITIS_LOOP_273_2_fu_160", "Port" : "gmem", "Inst_start_state" : "36", "Inst_end_state" : "37"}]},
			{"Name" : "out1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["3"], "DependentChan" : "18", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "out1_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "out2", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["3"], "DependentChan" : "19", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "out2_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "p_read", "Type" : "None", "Direction" : "I", "DependentProc" : ["4"], "DependentChan" : "21", "DependentChanDepth" : "2", "DependentChanType" : "1"},
			{"Name" : "layer2_reg_2", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["3"], "DependentChan" : "20", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "layer2_reg_2_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "p_read1", "Type" : "None", "Direction" : "I", "DependentProc" : ["4"], "DependentChan" : "22", "DependentChanDepth" : "2", "DependentChanType" : "1"},
			{"Name" : "wr_ptr1", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "wr_ptr2", "Type" : "OVld", "Direction" : "IO"}],
		"Loop" : [
	...
	{"ID" : "12", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.write_U0.grp_write_Pipeline_VITIS_LOOP_273_2_fu_160", "Parent" : "11", "Child" : ["13"],
	...
	{"ID" : "13", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.write_U0.grp_write_Pipeline_VITIS_LOOP_273_2_fu_160.flow_control_loop_pipe_sequential_init_U", "Parent" : "12"},
	{"ID" : "14", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.write_U0.grp_write_Pipeline_VITIS_LOOP_286_5_fu_173", "Parent" : "11", "Child" : ["15"],
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_286_5", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "2", "FirstState" : "ap_ST_fsm_pp0_stage1", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage1_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter2", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage1", "QuitStateIter" : "ap_enable_reg_pp0_iter1", "QuitStateBlock" : "ap_block_pp0_stage1_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "15", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.write_U0.grp_write_Pipeline_VITIS_LOOP_286_5_fu_173.flow_control_loop_pipe_sequential_init_U", "Parent" : "14"},
	{"ID" : "16", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.write_U0.udiv_8ns_8ns_8_12_seq_1_U401", "Parent" : "11"},
	{"ID" : "17", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.write_U0.udiv_16ns_8ns_16_20_seq_1_U402", "Parent" : "11"},
	{"ID" : "18", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.out1_c_U", "Parent" : "0"},
	{"ID" : "19", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.out2_c_U", "Parent" : "0"},
	{"ID" : "20", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.layer2_reg_ifs_c_U", "Parent" : "0"},
	{"ID" : "21", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ctrl1_reg_ls_c_channel_U", "Parent" : "0"},
	{"ID" : "22", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.actp_reg_pool_size_c_channel_U", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "34", "Max" : "3555"}
	, {"Name" : "Interval", "Min" : "21", "Max" : "1967"}
]}
