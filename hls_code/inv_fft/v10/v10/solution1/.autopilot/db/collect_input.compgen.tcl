...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ctrl1_regp_dout { I 32 vector } ctrl1_regp_num_data_valid { I 2 vector } ctrl1_regp_fifo_cap { I 2 vector } ctrl1_regp_empty_n { I 1 bit } ctrl1_regp_read { O 1 bit } } \
} "
}
