...
module IFFT_AP_fft_stage_4_Pipeline_VITIS_LOOP_66_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln70_3_fu_198_p1;
reg   [63:0] zext_ln70_3_reg_296;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln66_fu_173_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        zext_ln70_3_reg_296[11 : 0] <= zext_ln70_3_fu_198_p1[11 : 0];
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            ...
            I_address1 = zext_ln70_3_fu_198_p1;
        end else begin
            I_address1 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        X_address1 = zext_ln70_3_reg_296;
    end else begin
        X_address1 = 'bx;
    end
end
...
assign zext_ln70_3_fu_198_p1 = add_ln70_fu_192_p2;
...
always @ (posedge ap_clk) begin
    zext_ln70_3_reg_296[63:12] <= 52'b0000000000000000000000000000000000000000000000000000;
...
endmodule //IFFT_AP_fft_stage_4_Pipeline_VITIS_LOOP_66_2
