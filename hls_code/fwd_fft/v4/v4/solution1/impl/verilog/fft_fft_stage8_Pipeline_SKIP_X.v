...
module fft_fft_stage8_Pipeline_SKIP_X (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
wire   [7:0] w_M_real14_address0;
reg    w_M_real14_ce0;
wire   [15:0] w_M_real14_q0;
...
wire   [0:0] icmp_ln33_fu_284_p2;
wire   [31:0] add_ln36_fu_290_p2;
...
wire   [15:0] trunc_ln388_2_fu_347_p4;
wire   [15:0] bitcast_ln176_fu_400_p1;
wire   [15:0] bitcast_ln173_fu_397_p1;
wire   [15:0] bitcast_ln176_2_fu_415_p1;
wire   [15:0] bitcast_ln173_2_fu_412_p1;
reg    ap_done_reg;
...
fft_hadd_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hadd_16ns_16ns_16_2_full_dsp_1_U61(
    .clk(ap_clk),
    .reset(ap_rst),
...
fft_hadd_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hadd_16ns_16ns_16_2_full_dsp_1_U62(
    .clk(ap_clk),
    .reset(ap_rst),
...
fft_hadd_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hadd_16ns_16ns_16_2_full_dsp_1_U63(
    .clk(ap_clk),
    .reset(ap_rst),
...
fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U64(
    .clk(ap_clk),
    .reset(ap_rst),
...
fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U65(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(t1_M_real_fu_387_p1),
    .din1(p_r_reg_546),
...
fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U66(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(t1_M_imag_fu_392_p1),
    .din1(p_r_M_imag_12_reg_552),
...
fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U67(
    .clk(ap_clk),
    .reset(ap_rst),
...
fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U68(
    .clk(ap_clk),
    .reset(ap_rst),
...
fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U69(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(p_r_M_real_fu_357_p1),
    .din1(w_M_imag10_q0),
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        trunc_ln21_2_reg_541 <= {{IN_r_q0[31:16]}};
...
assign OUT_r_d0 = {{bitcast_ln176_2_fu_415_p1}, {bitcast_ln173_2_fu_412_p1}};

assign OUT_r_d1 = {{bitcast_ln176_fu_400_p1}, {bitcast_ln173_fu_397_p1}};

assign add_ln20_fu_243_p2 = (trunc_ln20_fu_239_p1 + 8'd96);

assign add_ln21_fu_255_p2 = (trunc_ln1057_2_fu_235_p1 + trunc_ln1057_fu_231_p1);

assign add_ln22_fu_261_p2 = (add_ln21_fu_255_p2 + 6'd8);

assign add_ln36_fu_290_p2 = (m1_fu_66 + 32'd16);
...
assign bitcast_ln173_2_fu_412_p1 = p_r_M_real_12_reg_580;

assign bitcast_ln173_fu_397_p1 = p_r_M_real_11_reg_570;

assign bitcast_ln176_2_fu_415_p1 = p_r_M_imag_14_reg_585;

assign bitcast_ln176_fu_400_p1 = p_r_M_imag_13_reg_575;

assign icmp_ln1057_fu_214_p2 = ((k1_fu_58 == trunc_ln5) ? 1'b1 : 1'b0);

assign icmp_ln29_fu_272_p2 = ((j1_fu_62 < 32'd7) ? 1'b1 : 1'b0);

assign icmp_ln33_fu_284_p2 = ((j1_fu_62 == 32'd7) ? 1'b1 : 1'b0);

assign j1_4_fu_278_p2 = (j1_fu_62 + 32'd1);

assign j1_5_fu_296_p3 = ((icmp_ln33_fu_284_p2[0:0] == 1'b1) ? 32'd0 : j1_fu_62);

assign j1_6_fu_312_p3 = ((icmp_ln29_fu_272_p2[0:0] == 1'b1) ? j1_4_fu_278_p2 : j1_5_fu_296_p3);

assign k1_4_fu_219_p2 = (k1_fu_58 + 7'd1);

assign m1_3_fu_304_p3 = ((icmp_ln33_fu_284_p2[0:0] == 1'b1) ? add_ln36_fu_290_p2 : m1_fu_66);

assign m1_4_fu_320_p3 = ((icmp_ln29_fu_272_p2[0:0] == 1'b1) ? m1_fu_66 : m1_3_fu_304_p3);

assign p_r_M_imag_fu_363_p1 = trunc_ln388_2_fu_347_p4;

assign p_r_M_real_fu_357_p1 = trunc_ln388_fu_343_p1;

assign t1_M_imag_fu_392_p1 = trunc_ln21_2_reg_541;

assign t1_M_real_fu_387_p1 = trunc_ln21_reg_536;

assign trunc_ln1057_2_fu_235_p1 = j1_fu_62[5:0];
...
assign trunc_ln388_2_fu_347_p4 = {{IN_r_q1[31:16]}};

assign trunc_ln388_fu_343_p1 = IN_r_q1[15:0];

assign w_M_imag10_address0 = zext_ln20_fu_249_p1;

assign w_M_real14_address0 = zext_ln20_fu_249_p1;
...
endmodule //fft_fft_stage8_Pipeline_SKIP_X
