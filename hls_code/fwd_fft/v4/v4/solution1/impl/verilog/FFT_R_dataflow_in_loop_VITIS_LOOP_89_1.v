...
module FFT_R_dataflow_in_loop_VITIS_LOOP_89_1 (
        ap_clk,
        ap_rst,
        in_stream_V_dout,
        in_stream_V_empty_n,
...
wire   [63:0] buf_2_stream_U0_out_stream_V_din;
...
FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_input_data1 #(
    .DataWidth( 64 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
input_data1_U(
...
FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_input_data_rev2 #(
    .DataWidth( 64 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
input_data_rev2_U(
...
FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_out_data_13 #(
    .DataWidth( 64 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
out_data_13_U(
...
FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_out_data_68 #(
    .DataWidth( 64 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
out_data_68_U(
...
FFT_R_bit_reversal bit_reversal_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
FFT_R_fifo_w32_d2_S ctrl1_reg_c7_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //FFT_R_dataflow_in_loop_VITIS_LOOP_89_1
