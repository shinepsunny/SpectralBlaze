...
module fwd_fft_VITIS_LOOP_255_8_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] or_ln260_reg_251;
wire   [7:0] empty_fu_138_p1;
reg   [7:0] empty_reg_246;
wire   [0:0] or_ln260_fu_186_p2;
wire   [7:0] add_ln255_fu_211_p2;
reg   [7:0] add_ln255_reg_258;
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (ctrl1_reg_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        x_fu_70 <= 8'd0;
    end else if ((~((c_fft_row_op_st_full_n == 1'b0) | ((or_ln260_reg_251 == 1'd0) & (1'b0 == Row_Buffer_full_n))) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if (((or_ln260_reg_251 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if ((~((c_fft_row_op_st_full_n == 1'b0) | ((or_ln260_reg_251 == 1'd0) & (1'b0 == Row_Buffer_full_n))) & (or_ln260_reg_251 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if (((c_fft_row_op_st_full_n == 1'b0) | ((or_ln260_reg_251 == 1'd0) & (1'b0 == Row_Buffer_full_n)))) begin
...
always @ (*) begin
    if ((~((c_fft_row_op_st_full_n == 1'b0) | ((or_ln260_reg_251 == 1'd0) & (1'b0 == Row_Buffer_full_n))) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign add_ln255_fu_211_p2 = (x_fu_70 + 8'd1);
...
always @ (*) begin
    ap_block_state3 = ((c_fft_row_op_st_full_n == 1'b0) | ((or_ln260_reg_251 == 1'd0) & (1'b0 == Row_Buffer_full_n)));
end
...
assign icmp_ln260_fu_180_p2 = (($signed(zext_ln1061_fu_176_p1) > $signed(p_read2)) ? 1'b1 : 1'b0);

assign lshr_ln_fu_166_p4 = {{ctrl1_reg_dout[31:24]}};

assign or_ln260_fu_186_p2 = (icmp_ln260_fu_180_p2 | cmp_i_i_fu_160_p2);
...
endmodule //fwd_fft_VITIS_LOOP_255_8_proc
