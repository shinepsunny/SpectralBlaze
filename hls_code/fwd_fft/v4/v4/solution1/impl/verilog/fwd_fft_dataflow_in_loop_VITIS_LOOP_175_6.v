...
module fwd_fft_dataflow_in_loop_VITIS_LOOP_175_6 (
        ap_clk,
        ap_rst,
        p_read,
...
wire    VITIS_LOOP_179_7_proc_U0_ap_start;
wire    VITIS_LOOP_179_7_proc_U0_ap_done;
wire    VITIS_LOOP_179_7_proc_U0_ap_continue;
wire    VITIS_LOOP_179_7_proc_U0_ap_idle;
wire    VITIS_LOOP_179_7_proc_U0_ap_ready;
wire    VITIS_LOOP_179_7_proc_U0_c_ifmap_col_op_st_read;
wire   [5:0] VITIS_LOOP_179_7_proc_U0_in_fft_M_value1_address0;
wire    VITIS_LOOP_179_7_proc_U0_in_fft_M_value1_ce0;
wire    VITIS_LOOP_179_7_proc_U0_in_fft_M_value1_we0;
wire   [31:0] VITIS_LOOP_179_7_proc_U0_in_fft_M_value1_d0;
wire   [5:0] VITIS_LOOP_179_7_proc_U0_in_fft_M_value_22_address0;
wire    VITIS_LOOP_179_7_proc_U0_in_fft_M_value_22_ce0;
wire    VITIS_LOOP_179_7_proc_U0_in_fft_M_value_22_we0;
wire   [31:0] VITIS_LOOP_179_7_proc_U0_in_fft_M_value_22_d0;
wire   [31:0] VITIS_LOOP_179_7_proc_U0_ctrl1_reg_c_din;
wire    VITIS_LOOP_179_7_proc_U0_ctrl1_reg_c_write;
wire    ap_channel_done_in_fft_M_value_1;
wire    VITIS_LOOP_179_7_proc_U0_in_fft_M_value_22_full_n;
...
wire    VITIS_LOOP_179_7_proc_U0_in_fft_M_value1_full_n;
...
wire    VITIS_LOOP_188_8_proc_U0_ap_start;
wire    VITIS_LOOP_188_8_proc_U0_ap_done;
wire    VITIS_LOOP_188_8_proc_U0_ap_continue;
wire    VITIS_LOOP_188_8_proc_U0_ap_idle;
wire    VITIS_LOOP_188_8_proc_U0_ap_ready;
wire    VITIS_LOOP_188_8_proc_U0_ctrl1_reg_read;
wire    VITIS_LOOP_188_8_proc_U0_out_fft3_read;
wire   [31:0] VITIS_LOOP_188_8_proc_U0_c_fft_row_op_st_din;
wire    VITIS_LOOP_188_8_proc_U0_c_fft_row_op_st_write;
wire   [31:0] VITIS_LOOP_188_8_proc_U0_Row_Buffer_din;
wire    VITIS_LOOP_188_8_proc_U0_Row_Buffer_write;
...
reg    ap_sync_reg_VITIS_LOOP_179_7_proc_U0_ap_ready;
wire    ap_sync_VITIS_LOOP_179_7_proc_U0_ap_ready;
wire    ap_ce_reg;
...
#0 ap_sync_reg_VITIS_LOOP_179_7_proc_U0_ap_ready = 1'b0;
end

fwd_fft_dataflow_in_loop_VITIS_LOOP_175_6_in_fft_M_value #(
    .DataWidth( 32 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
in_fft_M_value_U(
...
fwd_fft_VITIS_LOOP_179_7_proc VITIS_LOOP_179_7_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
fwd_fft_VITIS_LOOP_188_8_proc VITIS_LOOP_188_8_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_VITIS_LOOP_179_7_proc_U0_ap_ready <= 1'b0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((VITIS_LOOP_179_7_proc_U0_ap_done & VITIS_LOOP_179_7_proc_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_in_fft_M_value <= 1'b0;
        end else begin
...
assign Row_Buffer_din = VITIS_LOOP_188_8_proc_U0_Row_Buffer_din;

assign Row_Buffer_write = VITIS_LOOP_188_8_proc_U0_Row_Buffer_write;

assign VITIS_LOOP_179_7_proc_U0_ap_continue = (ap_sync_channel_write_in_fft_M_value_1 & ap_sync_channel_write_in_fft_M_value);

assign VITIS_LOOP_179_7_proc_U0_ap_start = ((ap_sync_reg_VITIS_LOOP_179_7_proc_U0_ap_ready ^ 1'b1) & ap_start);

assign VITIS_LOOP_179_7_proc_U0_in_fft_M_value1_full_n = in_fft_M_value_i_full_n;

assign VITIS_LOOP_179_7_proc_U0_in_fft_M_value_22_full_n = in_fft_M_value_1_i_full_n;

assign VITIS_LOOP_188_8_proc_U0_ap_continue = ap_continue;

assign VITIS_LOOP_188_8_proc_U0_ap_start = (y_7_c_channel_empty_n & pny_c_channel_empty_n & ctrl2_reg_c_channel_empty_n);
...
assign ap_channel_done_in_fft_M_value = ((ap_sync_reg_channel_write_in_fft_M_value ^ 1'b1) & VITIS_LOOP_179_7_proc_U0_ap_done);

assign ap_channel_done_in_fft_M_value_1 = ((ap_sync_reg_channel_write_in_fft_M_value_1 ^ 1'b1) & VITIS_LOOP_179_7_proc_U0_ap_done);
...
assign ap_done = VITIS_LOOP_188_8_proc_U0_ap_done;

assign ap_idle = (fft_param1_15_U0_ap_idle & (fft_config1_data_V_c_channel_empty_n ^ 1'b1) & (pny_c_channel_empty_n ^ 1'b1) & (ctrl2_reg_c_channel_empty_n ^ 1'b1) & (y_7_c_channel_empty_n ^ 1'b1) & (in_fft_M_value_1_t_empty_n ^ 1'b1) & (in_fft_M_value_t_empty_n ^ 1'b1) & entry_proc21_U0_ap_idle & VITIS_LOOP_188_8_proc_U0_ap_idle & VITIS_LOOP_179_7_proc_U0_ap_idle);

assign ap_ready = ap_sync_ready;

assign ap_sync_VITIS_LOOP_179_7_proc_U0_ap_ready = (ap_sync_reg_VITIS_LOOP_179_7_proc_U0_ap_ready | VITIS_LOOP_179_7_proc_U0_ap_ready);
...
assign ap_sync_channel_write_in_fft_M_value = ((ap_channel_done_in_fft_M_value & VITIS_LOOP_179_7_proc_U0_in_fft_M_value1_full_n) | ap_sync_reg_channel_write_in_fft_M_value);

assign ap_sync_channel_write_in_fft_M_value_1 = ((ap_channel_done_in_fft_M_value_1 & VITIS_LOOP_179_7_proc_U0_in_fft_M_value_22_full_n) | ap_sync_reg_channel_write_in_fft_M_value_1);
...
assign ap_sync_ready = (ap_sync_entry_proc21_U0_ap_ready & ap_sync_VITIS_LOOP_179_7_proc_U0_ap_ready);

assign c_fft_row_op_st_din = VITIS_LOOP_188_8_proc_U0_c_fft_row_op_st_din;

assign c_fft_row_op_st_write = VITIS_LOOP_188_8_proc_U0_c_fft_row_op_st_write;

assign c_ifmap_col_op_st_read = VITIS_LOOP_179_7_proc_U0_c_ifmap_col_op_st_read;
...
endmodule //fwd_fft_dataflow_in_loop_VITIS_LOOP_175_6
