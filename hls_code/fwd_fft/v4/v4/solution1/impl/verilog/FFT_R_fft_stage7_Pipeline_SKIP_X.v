...
module FFT_R_fft_stage7_Pipeline_SKIP_X (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln21_fu_255_p2 = (trunc_ln1057_3_fu_235_p1 + trunc_ln1057_fu_231_p1);
...
assign j1_8_fu_296_p3 = ((icmp_ln30_fu_284_p2[0:0] == 1'b1) ? 32'd0 : j1_fu_62);

assign j1_9_fu_312_p3 = ((icmp_ln26_fu_272_p2[0:0] == 1'b1) ? j1_7_fu_278_p2 : j1_8_fu_296_p3);

assign k1_6_fu_219_p2 = (k1_fu_58 + 7'd1);

assign m1_5_fu_304_p3 = ((icmp_ln30_fu_284_p2[0:0] == 1'b1) ? add_ln33_fu_290_p2 : m1_fu_66);

assign m1_6_fu_320_p3 = ((icmp_ln26_fu_272_p2[0:0] == 1'b1) ? m1_fu_66 : m1_5_fu_304_p3);
...
assign w_M_imag11_address0 = zext_ln20_fu_249_p1;
...
endmodule //FFT_R_fft_stage7_Pipeline_SKIP_X
