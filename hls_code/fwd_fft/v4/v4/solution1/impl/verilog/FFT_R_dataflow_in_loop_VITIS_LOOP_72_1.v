...
module FFT_R_dataflow_in_loop_VITIS_LOOP_72_1 (
        ap_clk,
        ap_rst,
        in_stream_V_dout,
        in_stream_V_empty_n,
...
wire    fft_stage4_U0_ap_start;
wire    fft_stage4_U0_ap_done;
wire    fft_stage4_U0_ap_continue;
wire    fft_stage4_U0_ap_idle;
wire    fft_stage4_U0_ap_ready;
wire   [5:0] fft_stage4_U0_IN_r_address0;
wire    fft_stage4_U0_IN_r_ce0;
wire   [5:0] fft_stage4_U0_IN_r_address1;
wire    fft_stage4_U0_IN_r_ce1;
wire   [5:0] fft_stage4_U0_OUT_r_address0;
wire    fft_stage4_U0_OUT_r_ce0;
wire    fft_stage4_U0_OUT_r_we0;
wire   [31:0] fft_stage4_U0_OUT_r_d0;
wire   [5:0] fft_stage4_U0_OUT_r_address1;
wire    fft_stage4_U0_OUT_r_ce1;
wire    fft_stage4_U0_OUT_r_we1;
wire   [31:0] fft_stage4_U0_OUT_r_d1;
wire   [31:0] fft_stage4_U0_ap_return;
...
wire    fft_stage4_U0_OUT_r_full_n;
reg    ap_sync_reg_channel_write_out_data_12;
wire    ap_sync_channel_write_out_data_12;
wire    fft_stage5_U0_ap_start;
wire    fft_stage5_U0_ap_done;
wire    fft_stage5_U0_ap_continue;
wire    fft_stage5_U0_ap_idle;
wire    fft_stage5_U0_ap_ready;
wire   [5:0] fft_stage5_U0_IN_r_address0;
wire    fft_stage5_U0_IN_r_ce0;
wire   [5:0] fft_stage5_U0_IN_r_address1;
wire    fft_stage5_U0_IN_r_ce1;
wire   [5:0] fft_stage5_U0_OUT_r_address0;
wire    fft_stage5_U0_OUT_r_ce0;
wire    fft_stage5_U0_OUT_r_we0;
wire   [31:0] fft_stage5_U0_OUT_r_d0;
wire   [5:0] fft_stage5_U0_OUT_r_address1;
wire    fft_stage5_U0_OUT_r_ce1;
wire    fft_stage5_U0_OUT_r_we1;
wire   [31:0] fft_stage5_U0_OUT_r_d1;
wire   [31:0] fft_stage5_U0_ap_return;
...
wire    fft_stage5_U0_OUT_r_full_n;
...
wire   [7:0] fft_stage9_U0_ap_return;
...
FFT_R_dataflow_in_loop_VITIS_LOOP_72_1_input_data1 #(
    .DataWidth( 32 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
input_data1_U(
    ...
    .t_address0(fft_stage4_U0_IN_r_address0),
    .t_ce0(fft_stage4_U0_IN_r_ce0),
    .t_we0(1'b0),
    .t_d0(32'd0),
    .t_q0(input_data1_t_q0),
    .t_address1(fft_stage4_U0_IN_r_address1),
    .t_ce1(fft_stage4_U0_IN_r_ce1),
    ...
    .t_read(fft_stage4_U0_ap_ready)
);

FFT_R_dataflow_in_loop_VITIS_LOOP_72_1_out_data_12 #(
    .DataWidth( 32 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
out_data_12_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .i_address0(fft_stage4_U0_OUT_r_address0),
    .i_ce0(fft_stage4_U0_OUT_r_ce0),
    .i_we0(fft_stage4_U0_OUT_r_we0),
    .i_d0(fft_stage4_U0_OUT_r_d0),
    .i_q0(out_data_12_i_q0),
    .i_address1(fft_stage4_U0_OUT_r_address1),
    .i_ce1(fft_stage4_U0_OUT_r_ce1),
    .i_we1(fft_stage4_U0_OUT_r_we1),
    .i_d1(fft_stage4_U0_OUT_r_d1),
    .i_q1(out_data_12_i_q1),
    .t_address0(fft_stage5_U0_IN_r_address0),
    .t_ce0(fft_stage5_U0_IN_r_ce0),
    .t_we0(1'b0),
    .t_d0(32'd0),
    .t_q0(out_data_12_t_q0),
    .t_address1(fft_stage5_U0_IN_r_address1),
    .t_ce1(fft_stage5_U0_IN_r_ce1),
    .t_we1(1'b0),
    .t_d1(32'd0),
...
out_data_23_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .i_address0(fft_stage5_U0_OUT_r_address0),
    .i_ce0(fft_stage5_U0_OUT_r_ce0),
    .i_we0(fft_stage5_U0_OUT_r_we0),
    .i_d0(fft_stage5_U0_OUT_r_d0),
    .i_q0(out_data_23_i_q0),
    .i_address1(fft_stage5_U0_OUT_r_address1),
    .i_ce1(fft_stage5_U0_OUT_r_ce1),
    .i_we1(fft_stage5_U0_OUT_r_we1),
    .i_d1(fft_stage5_U0_OUT_r_d1),
...
FFT_R_dataflow_in_loop_VITIS_LOOP_72_1_out_data_67 #(
    .DataWidth( 32 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
out_data_67_U(
...
FFT_R_fft_stage4 fft_stage4_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(fft_stage4_U0_ap_start),
    .ap_done(fft_stage4_U0_ap_done),
    .ap_continue(fft_stage4_U0_ap_continue),
    .ap_idle(fft_stage4_U0_ap_idle),
    .ap_ready(fft_stage4_U0_ap_ready),
    .IN_r_address0(fft_stage4_U0_IN_r_address0),
    .IN_r_ce0(fft_stage4_U0_IN_r_ce0),
    .IN_r_q0(input_data1_t_q0),
    .IN_r_address1(fft_stage4_U0_IN_r_address1),
    .IN_r_ce1(fft_stage4_U0_IN_r_ce1),
    .IN_r_q1(input_data1_t_q1),
    .OUT_r_address0(fft_stage4_U0_OUT_r_address0),
    .OUT_r_ce0(fft_stage4_U0_OUT_r_ce0),
    .OUT_r_we0(fft_stage4_U0_OUT_r_we0),
    .OUT_r_d0(fft_stage4_U0_OUT_r_d0),
    .OUT_r_address1(fft_stage4_U0_OUT_r_address1),
    .OUT_r_ce1(fft_stage4_U0_OUT_r_ce1),
    .OUT_r_we1(fft_stage4_U0_OUT_r_we1),
    .OUT_r_d1(fft_stage4_U0_OUT_r_d1),
    .p_read(ctrl1_reg_c6_channel_dout),
    .ap_return(fft_stage4_U0_ap_return)
);

FFT_R_fft_stage5 fft_stage5_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(fft_stage5_U0_ap_start),
    .ap_done(fft_stage5_U0_ap_done),
    .ap_continue(fft_stage5_U0_ap_continue),
    .ap_idle(fft_stage5_U0_ap_idle),
    .ap_ready(fft_stage5_U0_ap_ready),
    .IN_r_address0(fft_stage5_U0_IN_r_address0),
    .IN_r_ce0(fft_stage5_U0_IN_r_ce0),
    .IN_r_q0(out_data_12_t_q0),
    .IN_r_address1(fft_stage5_U0_IN_r_address1),
    .IN_r_ce1(fft_stage5_U0_IN_r_ce1),
    .IN_r_q1(out_data_12_t_q1),
    .OUT_r_address0(fft_stage5_U0_OUT_r_address0),
    .OUT_r_ce0(fft_stage5_U0_OUT_r_ce0),
    .OUT_r_we0(fft_stage5_U0_OUT_r_we0),
    .OUT_r_d0(fft_stage5_U0_OUT_r_d0),
    .OUT_r_address1(fft_stage5_U0_OUT_r_address1),
    .OUT_r_ce1(fft_stage5_U0_OUT_r_ce1),
    .OUT_r_we1(fft_stage5_U0_OUT_r_we1),
    .OUT_r_d1(fft_stage5_U0_OUT_r_d1),
    .p_read(ctrl1_reg_c5_channel_dout),
    .ap_return(fft_stage5_U0_ap_return)
);

FFT_R_fft_stage6 fft_stage6_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
FFT_R_fft_stage7 fft_stage7_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
FFT_R_fft_stage8 fft_stage8_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
FFT_R_fft_stage9 fft_stage9_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
FFT_R_fifo_w32_d2_S ctrl1_reg_c6_channel_U(
    ...
    .if_read(fft_stage4_U0_ap_ready)
);
...
FFT_R_fifo_w32_d2_S ctrl1_reg_c5_channel_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(fft_stage4_U0_ap_return),
    ...
    .if_read(fft_stage5_U0_ap_ready)
);
...
FFT_R_fifo_w32_d2_S ctrl1_reg_c4_channel_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(fft_stage5_U0_ap_return),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((fft_stage5_U0_ap_done & fft_stage5_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_ctrl1_reg_c4_channel <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((fft_stage4_U0_ap_done & fft_stage4_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_ctrl1_reg_c5_channel <= 1'b0;
        end else begin
...
assign ap_channel_done_ctrl1_reg_c1_channel = (fft_stage8_U0_ap_done & (ap_sync_reg_channel_write_ctrl1_reg_c1_channel ^ 1'b1));

assign ap_channel_done_ctrl1_reg_c2_channel = (fft_stage7_U0_ap_done & (ap_sync_reg_channel_write_ctrl1_reg_c2_channel ^ 1'b1));

assign ap_channel_done_ctrl1_reg_c3_channel = (fft_stage6_U0_ap_done & (ap_sync_reg_channel_write_ctrl1_reg_c3_channel ^ 1'b1));

assign ap_channel_done_ctrl1_reg_c4_channel = (fft_stage5_U0_ap_done & (ap_sync_reg_channel_write_ctrl1_reg_c4_channel ^ 1'b1));

assign ap_channel_done_ctrl1_reg_c5_channel = (fft_stage4_U0_ap_done & (ap_sync_reg_channel_write_ctrl1_reg_c5_channel ^ 1'b1));
...
assign ap_channel_done_out_data_12 = (fft_stage4_U0_ap_done & (ap_sync_reg_channel_write_out_data_12 ^ 1'b1));

assign ap_channel_done_out_data_23 = (fft_stage5_U0_ap_done & (ap_sync_reg_channel_write_out_data_23 ^ 1'b1));

assign ap_channel_done_out_data_34 = (fft_stage6_U0_ap_done & (ap_sync_reg_channel_write_out_data_34 ^ 1'b1));

assign ap_channel_done_out_data_45 = (fft_stage7_U0_ap_done & (ap_sync_reg_channel_write_out_data_45 ^ 1'b1));

assign ap_channel_done_out_data_56 = (fft_stage8_U0_ap_done & (ap_sync_reg_channel_write_out_data_56 ^ 1'b1));

assign ap_channel_done_out_data_67 = (fft_stage9_U0_ap_done & (ap_sync_reg_channel_write_out_data_67 ^ 1'b1));

assign ap_done = buf_2_stream_U0_ap_done;

assign ap_idle = (stream_2_buf_U0_ap_idle & fft_stage9_U0_ap_idle & fft_stage8_U0_ap_idle & fft_stage7_U0_ap_idle & fft_stage6_U0_ap_idle & fft_stage5_U0_ap_idle & fft_stage4_U0_ap_idle & (ctrl1_reg_c_channel_empty_n ^ 1'b1) & (ctrl1_reg_c1_channel_empty_n ^ 1'b1) & (ctrl1_reg_c2_channel_empty_n ^ 1'b1) & (ctrl1_reg_c3_channel_empty_n ^ 1'b1) & (ctrl1_reg_c4_channel_empty_n ^ 1'b1) & (ctrl1_reg_c5_channel_empty_n ^ 1'b1) & (ctrl1_reg_c6_channel_empty_n ^ 1'b1) & (out_data_67_t_empty_n ^ 1'b1) & (out_data_56_t_empty_n ^ 1'b1) & (out_data_45_t_empty_n ^ 1'b1) & (out_data_34_t_empty_n ^ 1'b1) & (out_data_23_t_empty_n ^ 1'b1) & (out_data_12_t_empty_n ^ 1'b1) & (input_data1_t_empty_n ^ 1'b1) & buf_2_stream_U0_ap_idle);
...
assign ap_sync_channel_write_out_data_12 = ((fft_stage4_U0_OUT_r_full_n & ap_channel_done_out_data_12) | ap_sync_reg_channel_write_out_data_12);

assign ap_sync_channel_write_out_data_23 = ((fft_stage5_U0_OUT_r_full_n & ap_channel_done_out_data_23) | ap_sync_reg_channel_write_out_data_23);

assign ap_sync_channel_write_out_data_34 = ((fft_stage6_U0_OUT_r_full_n & ap_channel_done_out_data_34) | ap_sync_reg_channel_write_out_data_34);

assign ap_sync_channel_write_out_data_45 = ((fft_stage7_U0_OUT_r_full_n & ap_channel_done_out_data_45) | ap_sync_reg_channel_write_out_data_45);

assign ap_sync_channel_write_out_data_56 = ((fft_stage8_U0_OUT_r_full_n & ap_channel_done_out_data_56) | ap_sync_reg_channel_write_out_data_56);

assign ap_sync_channel_write_out_data_67 = ((fft_stage9_U0_OUT_r_full_n & ap_channel_done_out_data_67) | ap_sync_reg_channel_write_out_data_67);
...
assign fft_stage4_U0_OUT_r_full_n = out_data_12_i_full_n;

assign fft_stage4_U0_ap_continue = (ap_sync_channel_write_out_data_12 & ap_sync_channel_write_ctrl1_reg_c5_channel);

assign fft_stage4_U0_ap_start = (input_data1_t_empty_n & ctrl1_reg_c6_channel_empty_n);

assign fft_stage5_U0_OUT_r_full_n = out_data_23_i_full_n;

assign fft_stage5_U0_ap_continue = (ap_sync_channel_write_out_data_23 & ap_sync_channel_write_ctrl1_reg_c4_channel);

assign fft_stage5_U0_ap_start = (out_data_12_t_empty_n & ctrl1_reg_c5_channel_empty_n);

assign fft_stage6_U0_OUT_r_full_n = out_data_34_i_full_n;

assign fft_stage6_U0_ap_continue = (ap_sync_channel_write_out_data_34 & ap_sync_channel_write_ctrl1_reg_c3_channel);

assign fft_stage6_U0_ap_start = (out_data_23_t_empty_n & ctrl1_reg_c4_channel_empty_n);

assign fft_stage7_U0_OUT_r_full_n = out_data_45_i_full_n;

assign fft_stage7_U0_ap_continue = (ap_sync_channel_write_out_data_45 & ap_sync_channel_write_ctrl1_reg_c2_channel);

assign fft_stage7_U0_ap_start = (out_data_34_t_empty_n & ctrl1_reg_c3_channel_empty_n);

assign fft_stage8_U0_OUT_r_full_n = out_data_56_i_full_n;

assign fft_stage8_U0_ap_continue = (ap_sync_channel_write_out_data_56 & ap_sync_channel_write_ctrl1_reg_c1_channel);

assign fft_stage8_U0_ap_start = (out_data_45_t_empty_n & ctrl1_reg_c2_channel_empty_n);

assign fft_stage9_U0_OUT_r_full_n = out_data_67_i_full_n;

assign fft_stage9_U0_ap_continue = (ap_sync_channel_write_out_data_67 & ap_sync_channel_write_ctrl1_reg_c_channel);

assign fft_stage9_U0_ap_start = (out_data_56_t_empty_n & ctrl1_reg_c1_channel_empty_n);
...
endmodule //FFT_R_dataflow_in_loop_VITIS_LOOP_72_1
