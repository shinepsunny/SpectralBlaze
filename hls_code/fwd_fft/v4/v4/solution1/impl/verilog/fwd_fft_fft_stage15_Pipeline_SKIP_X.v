...
module fwd_fft_fft_stage15_Pipeline_SKIP_X (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
fwd_fft_hadd_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hadd_16ns_16ns_16_2_full_dsp_1_U376(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hadd_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hadd_16ns_16ns_16_2_full_dsp_1_U377(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hadd_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hadd_16ns_16ns_16_2_full_dsp_1_U378(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U379(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U380(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(t1_M_real_fu_387_p1),
    .din1(p_r_reg_546),
...
fwd_fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U381(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(t1_M_imag_fu_392_p1),
    .din1(p_r_M_imag_5_reg_552),
...
fwd_fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U382(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U383(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U384(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(p_r_M_real_fu_357_p1),
    .din1(w_M_imag34_q0),
...
fwd_fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U385(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(p_r_M_imag_fu_363_p1),
    .din1(w_M_real43_q0),
...
assign icmp_ln1057_fu_214_p2 = ((k1_fu_58 == trunc_ln6) ? 1'b1 : 1'b0);
...
assign w_M_imag34_address0 = zext_ln20_fu_249_p1;

assign w_M_real43_address0 = zext_ln20_fu_249_p1;
...
endmodule //fwd_fft_fft_stage15_Pipeline_SKIP_X
