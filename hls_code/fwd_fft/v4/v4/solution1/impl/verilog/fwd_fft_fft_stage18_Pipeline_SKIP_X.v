...
module fwd_fft_fft_stage18_Pipeline_SKIP_X (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
wire   [7:0] w_M_real30_address0;
reg    w_M_real30_ce0;
wire   [15:0] w_M_real30_q0;
...
fwd_fft_fft_stage17_Pipeline_SKIP_X_w_M_real31 #(
    .DataWidth( 16 ),
    .AddressRange( 192 ),
    .AddressWidth( 8 ))
w_M_real30_U(
...
fwd_fft_fft_stage17_Pipeline_SKIP_X_w_M_imag25 #(
    .DataWidth( 16 ),
    .AddressRange( 192 ),
    .AddressWidth( 8 ))
w_M_imag24_U(
...
fwd_fft_hadd_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hadd_16ns_16ns_16_2_full_dsp_1_U118(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hadd_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hadd_16ns_16ns_16_2_full_dsp_1_U119(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U121(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U122(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(t1_M_real_fu_389_p1),
    .din1(p_r_reg_548),
...
fwd_fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U125(
    .clk(ap_clk),
    .reset(ap_rst),
...
assign add_ln21_fu_257_p2 = (trunc_ln1057_5_fu_237_p1 + trunc_ln1057_fu_233_p1);

assign add_ln22_fu_263_p2 = (add_ln21_fu_257_p2 + 6'd4);

assign add_ln33_fu_292_p2 = (m1_fu_68 + 32'd8);
...
assign icmp_ln26_fu_274_p2 = ((j1_fu_64 < 32'd3) ? 1'b1 : 1'b0);

assign icmp_ln30_fu_286_p2 = ((j1_fu_64 == 32'd3) ? 1'b1 : 1'b0);

assign j1_13_fu_280_p2 = (j1_fu_64 + 32'd1);

assign j1_14_fu_298_p3 = ((icmp_ln30_fu_286_p2[0:0] == 1'b1) ? 32'd0 : j1_fu_64);

assign j1_15_fu_314_p3 = ((icmp_ln26_fu_274_p2[0:0] == 1'b1) ? j1_13_fu_280_p2 : j1_14_fu_298_p3);

assign k1_10_fu_221_p2 = (k1_fu_60 + 7'd1);

assign m1_10_fu_322_p3 = ((icmp_ln26_fu_274_p2[0:0] == 1'b1) ? m1_fu_68 : m1_9_fu_306_p3);

assign m1_9_fu_306_p3 = ((icmp_ln30_fu_286_p2[0:0] == 1'b1) ? add_ln33_fu_292_p2 : m1_fu_68);
...
assign w_M_imag24_address0 = zext_ln20_fu_251_p1;

assign w_M_real30_address0 = zext_ln20_fu_251_p1;
...
endmodule //fwd_fft_fft_stage18_Pipeline_SKIP_X
