...
module fwd_fft_fft_stage921_Pipeline_SKIP_X (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [6:0] k1_4_fu_211_p2;
reg   [7:0] m1_fu_48;
reg   [7:0] ap_sig_allocacmp_m1_load;
wire   [7:0] m1_2_fu_236_p2;
...
assign icmp_ln1057_fu_205_p2 = ((ap_sig_allocacmp_k1_3 == trunc_ln2) ? 1'b1 : 1'b0);

assign k1_4_fu_211_p2 = (ap_sig_allocacmp_k1_3 + 7'd1);

assign m1_2_fu_236_p2 = (ap_sig_allocacmp_m1_load + 8'd2);
...
endmodule //fwd_fft_fft_stage921_Pipeline_SKIP_X
