...
module fwd_fft_dataflow_in_loop_VITIS_LOOP_241_6_in_fft_M_real
#(parameter
    DataWidth    = 16,
    AddressRange = 32,
    AddressWidth = 6,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        fwd_fft_dataflow_in_loop_VITIS_LOOP_241_6_in_fft_M_real_memcore fwd_fft_dataflow_in_loop_VITIS_LOOP_241_6_in_fft_M_real_memcore_U (
            .clk      ( clk ),
            .reset    ( reset ),
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
