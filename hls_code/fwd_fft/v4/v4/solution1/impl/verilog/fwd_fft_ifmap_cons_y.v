...
wire   [63:0] zext_ln311_fu_203_p1;
reg   [7:0] y_fu_56;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_y_load;
wire   [7:0] add_ln308_fu_209_p2;
reg   [7:0] x_fu_60;
...
wire   [7:0] add_ln305_fu_153_p2;
wire   [7:0] select_ln1057_fu_165_p3;
wire   [5:0] trunc_ln311_fu_185_p1;
wire   [11:0] tmp_11_cast_fu_189_p3;
wire   [11:0] select_ln1057_2_cast_fu_181_p1;
wire   [11:0] add_ln311_fu_197_p2;
wire   [15:0] bitcast_ln174_1_fu_234_p1;
wire   [15:0] bitcast_ln174_fu_230_p1;
...
assign add_ln305_fu_153_p2 = (ap_sig_allocacmp_x_load + 8'd1);

assign add_ln308_fu_209_p2 = (select_ln1057_fu_165_p3 + 8'd1);

assign add_ln311_fu_197_p2 = (tmp_11_cast_fu_189_p3 + select_ln1057_2_cast_fu_181_p1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((c_row_op_trans_st_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_done_reg == 1'b1) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((c_row_op_trans_st_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_done_reg == 1'b1) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((c_row_op_trans_st_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_done_reg == 1'b1) & (ap_start_int == 1'b1)));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (c_row_op_trans_st_full_n == 1'b0);
end
...
assign bitcast_ln174_1_fu_234_p1 = ifmap_CF_M_imag_q0;

assign bitcast_ln174_fu_230_p1 = ifmap_CF_M_real_q0;

assign bound_fu_111_p0 = cast_fu_107_p1;

assign bound_fu_111_p1 = cast_fu_107_p1;

assign c_row_op_trans_st_din = {{bitcast_ln174_1_fu_234_p1}, {bitcast_ln174_fu_230_p1}};
...
assign ifmap_CF_M_imag_address0 = zext_ln311_fu_203_p1;

assign ifmap_CF_M_real_address0 = zext_ln311_fu_203_p1;

assign select_ln1057_2_cast_fu_181_p1 = select_ln1057_2_fu_173_p3;

assign select_ln1057_2_fu_173_p3 = ((icmp_ln1057_4_fu_159_p2[0:0] == 1'b1) ? add_ln305_fu_153_p2 : ap_sig_allocacmp_x_load);

assign select_ln1057_fu_165_p3 = ((icmp_ln1057_4_fu_159_p2[0:0] == 1'b1) ? 8'd0 : ap_sig_allocacmp_y_load);

assign tmp_11_cast_fu_189_p3 = {{trunc_ln311_fu_185_p1}, {6'd0}};

assign trunc_ln311_fu_185_p1 = select_ln1057_fu_165_p3[5:0];

assign zext_ln311_fu_203_p1 = add_ln311_fu_197_p2;
