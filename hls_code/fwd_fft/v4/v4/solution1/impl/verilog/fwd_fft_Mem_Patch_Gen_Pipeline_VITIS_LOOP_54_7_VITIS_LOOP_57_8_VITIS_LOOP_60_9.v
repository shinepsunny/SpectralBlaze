...
module fwd_fft_Mem_Patch_Gen_Pipeline_VITIS_LOOP_54_7_VITIS_LOOP_57_8_VITIS_LOOP_60_9 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [23:0] bound4;
input  [15:0] bound;
input  [7:0] p_cast2_cast;
input  [0:0] cmp_i_not_mid119;
input  [7:0] p_cast5;
input  [0:0] icmp_ln1057_9;
...
wire   [15:0] p_cast2_cast_cast_fu_213_p1;
reg   [15:0] p_cast2_cast_cast_reg_795;
reg   [0:0] icmp_ln1057_reg_800;
reg   [0:0] icmp_ln1057_reg_800_pp0_iter2_reg;
wire   [0:0] icmp_ln1057_7_fu_278_p2;
reg   [0:0] icmp_ln1057_7_reg_804;
reg   [0:0] icmp_ln1057_7_reg_804_pp0_iter2_reg;
reg   [0:0] icmp_ln1057_7_reg_804_pp0_iter3_reg;
reg   [7:0] y_4_reg_818;
wire   [0:0] rev20_fu_341_p2;
reg   [0:0] rev20_reg_823;
wire   [0:0] select_ln13_3_fu_362_p3;
reg   [0:0] select_ln13_3_reg_828;
wire   [7:0] add_ln57_fu_368_p2;
reg   [7:0] add_ln57_reg_834;
wire   [15:0] add_i_i_mid1_fu_391_p2;
reg   [15:0] add_i_i_mid1_reg_839;
wire   [0:0] or_ln64_fu_490_p2;
reg   [0:0] or_ln64_reg_849;
reg   [0:0] or_ln64_reg_849_pp0_iter5_reg;
...
reg   [7:0] y_fu_116;
wire   [7:0] select_ln1057_4_fu_396_p3;
reg   [15:0] indvar_flatten_fu_120;
wire   [15:0] select_ln1057_5_fu_301_p3;
reg   [7:0] pnx_fu_124;
...
wire   [0:0] icmp_ln1057_8_fu_357_p2;
...
wire   [5:0] select_ln1057_2_fu_448_p3;
...
wire   [0:0] xor_ln64_fu_484_p2;
wire   [0:0] select_ln1057_3_fu_473_p3;
wire   [10:0] tmp_21_cast_fu_455_p3;
...
wire   [0:0] icmp_ln68_fu_562_p2;
wire   [31:0] add_ln69_fu_568_p2;
...
wire   [15:0] select_ln64_fu_677_p3;
wire   [15:0] select_ln64_1_fu_684_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        p_cast2_cast_cast_reg_795[7 : 0] <= p_cast2_cast_cast_fu_213_p1[7 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln1057_7_reg_804_pp0_iter2_reg == 1'd0))) begin
...
assign add_i_i_fu_331_p2 = (mul_i_i + y_cast_fu_327_p1);

assign add_i_i_mid1_fu_391_p2 = (mul_i_i + y_cast_mid1_fu_387_p1);
...
assign add_ln54_fu_500_p2 = (tmp_21_cast_fu_455_p3 + trunc_ln54_2_fu_496_p1);

assign add_ln57_fu_368_p2 = (select_ln13_fu_350_p3 + 8'd1);

assign add_ln69_fu_568_p2 = (rd_i_1_fu_108 + 32'd1);
...
assign c_ifmap_patch_st_din = {{select_ln64_fu_677_p3}, {select_ln64_1_fu_684_p3}};

assign grp_fu_700_p0 = grp_fu_700_p00;

assign grp_fu_700_p00 = select_ln13_1_fu_283_p3;

assign grp_fu_700_p1 = p_cast2_cast_cast_reg_795;

assign grp_fu_700_p2 = grp_fu_700_p20;

assign grp_fu_700_p20 = select_ln1057_fu_379_p3;

assign icmp_ln1057_7_fu_278_p2 = ((indvar_flatten_fu_120 == bound) ? 1'b1 : 1'b0);

assign icmp_ln1057_8_fu_357_p2 = ((lhs_fu_104 == p_cast5) ? 1'b1 : 1'b0);
...
assign icmp_ln64_fu_480_p2 = ((grp_fu_700_p3 < p_cast) ? 1'b1 : 1'b0);

assign icmp_ln68_fu_562_p2 = ((rd_j_2_fu_556_p2 == 32'd8) ? 1'b1 : 1'b0);
...
assign or_ln1057_fu_374_p2 = (select_ln13_3_fu_362_p3 | icmp_ln1057_7_reg_804_pp0_iter2_reg);

assign or_ln130_fu_520_p2 = (shl_ln2_fu_512_p3 | 36'd15);

assign or_ln64_fu_490_p2 = (xor_ln64_fu_484_p2 | select_ln1057_3_fu_473_p3);

assign p_cast2_cast_cast_fu_213_p1 = p_cast2_cast;

assign pnx_5_fu_272_p2 = (pnx_fu_124 + 8'd1);

assign rd_i_2_fu_574_p3 = ((icmp_ln68_fu_562_p2[0:0] == 1'b1) ? add_ln69_fu_568_p2 : rd_i_1_fu_108);

assign rd_i_fu_590_p3 = ((or_ln64_fu_490_p2[0:0] == 1'b1) ? rd_i_1_fu_108 : rd_i_2_fu_574_p3);

assign rd_j_2_fu_556_p2 = (rd_j_1_fu_112 + 32'd1);

assign rd_j_3_fu_582_p3 = ((icmp_ln68_fu_562_p2[0:0] == 1'b1) ? 32'd0 : rd_j_2_fu_556_p2);

assign rd_j_fu_598_p3 = ((or_ln64_fu_490_p2[0:0] == 1'b1) ? rd_j_1_fu_112 : rd_j_3_fu_582_p3);

assign rev20_fu_341_p2 = (ult_fu_336_p2 ^ 1'd1);

assign rev22_fu_467_p2 = (ult21_fu_463_p2 ^ 1'd1);

assign select_ln1057_2_fu_448_p3 = ((select_ln13_3_reg_828[0:0] == 1'b1) ? trunc_ln54_fu_435_p1 : select_ln13_4_fu_441_p3);

assign select_ln1057_3_fu_473_p3 = ((select_ln13_3_reg_828[0:0] == 1'b1) ? rev22_fu_467_p2 : select_ln13_2_fu_430_p3);

assign select_ln1057_4_fu_396_p3 = ((select_ln13_3_fu_362_p3[0:0] == 1'b1) ? add_ln57_fu_368_p2 : select_ln13_fu_350_p3);

assign select_ln1057_5_fu_301_p3 = ((icmp_ln1057_7_fu_278_p2[0:0] == 1'b1) ? 16'd1 : add_ln1057_fu_295_p2);
...
assign select_ln13_1_fu_283_p3 = ((icmp_ln1057_7_fu_278_p2[0:0] == 1'b1) ? pnx_5_fu_272_p2 : pnx_fu_124);

assign select_ln13_2_fu_430_p3 = ((icmp_ln1057_7_reg_804_pp0_iter3_reg[0:0] == 1'b1) ? cmp_i_not_mid119 : rev20_reg_823);

assign select_ln13_3_fu_362_p3 = ((icmp_ln1057_7_reg_804_pp0_iter2_reg[0:0] == 1'b1) ? icmp_ln1057_9 : icmp_ln1057_8_fu_357_p2);

assign select_ln13_4_fu_441_p3 = ((icmp_ln1057_7_reg_804_pp0_iter3_reg[0:0] == 1'b1) ? 6'd0 : trunc_ln54_1_fu_438_p1);

assign select_ln13_fu_350_p3 = ((icmp_ln1057_7_reg_804_pp0_iter2_reg[0:0] == 1'b1) ? 8'd0 : y_fu_116);

assign select_ln64_1_fu_684_p3 = ((or_ln64_reg_849_pp0_iter5_reg[0:0] == 1'b1) ? 16'd0 : trunc_ln130_fu_660_p1);

assign select_ln64_fu_677_p3 = ((or_ln64_reg_849_pp0_iter5_reg[0:0] == 1'b1) ? 16'd0 : trunc_ln130_1_fu_673_p1);
...
assign tmp_21_cast_fu_455_p3 = {{select_ln1057_2_fu_448_p3}, {5'd0}};
...
assign trunc_ln54_fu_435_p1 = add_ln57_reg_834[5:0];
...
assign xor_ln64_fu_484_p2 = (icmp_ln64_fu_480_p2 ^ 1'd1);

assign y_cast_fu_327_p1 = y_fu_116;

assign y_cast_mid1_fu_387_p1 = add_ln57_fu_368_p2;
...
always @ (posedge ap_clk) begin
    p_cast2_cast_cast_reg_795[15:8] <= 8'b00000000;
...
endmodule //fwd_fft_Mem_Patch_Gen_Pipeline_VITIS_LOOP_54_7_VITIS_LOOP_57_8_VITIS_LOOP_60_9
