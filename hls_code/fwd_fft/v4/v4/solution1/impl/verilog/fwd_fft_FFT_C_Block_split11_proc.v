...
module fwd_fft_FFT_C_Block_split11_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [15:0] empty_187_fu_68_p1;
wire   [23:0] rhs_V_3_out_0_fu_60_p1;
wire   [15:0] rhs_V_out_0_fu_64_p1;
wire   [39:0] rhs_V_4_out_0_fu_72_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (layer1_reg_c_full_n == 1'b0) | (ctrl2_reg_c_full_n == 1'b0) | (layer1_reg_empty_n == 1'b0) | (ctrl2_reg_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_0_preg[7 : 0] <= rhs_V_3_out_0_fu_60_p1[7 : 0];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (layer1_reg_c_full_n == 1'b0) | (ctrl2_reg_c_full_n == 1'b0) | (layer1_reg_empty_n == 1'b0) | (ctrl2_reg_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_2_preg[15 : 0] <= rhs_V_4_out_0_fu_72_p1[15 : 0];
        end
    end
end
...
assign empty_187_fu_68_p1 = layer1_reg_dout[15:0];

assign empty_fu_56_p1 = ctrl2_reg_dout[7:0];

assign layer1_reg_c_din = layer1_reg_dout;

assign rhs_V_3_out_0_fu_60_p1 = empty_fu_56_p1;

assign rhs_V_4_out_0_fu_72_p1 = empty_187_fu_68_p1;
...
endmodule //fwd_fft_FFT_C_Block_split11_proc
