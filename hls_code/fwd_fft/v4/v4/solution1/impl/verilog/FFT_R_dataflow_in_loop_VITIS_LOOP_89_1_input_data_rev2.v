...
module FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_input_data_rev2
#(parameter
    DataWidth    = 64,
    AddressRange = 32,
    AddressWidth = 6,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_input_data_rev2_memcore FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_input_data_rev2_memcore_U (
            .clk      ( clk ),
            .reset    ( reset ),
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
