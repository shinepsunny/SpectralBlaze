...
module fwd_fft_fft_stage_11627_Pipeline_SKIP_X (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [15:0] p_r_M_imag_18_reg_472;
...
reg   [6:0] k1_fu_56;
wire   [6:0] k1_12_fu_181_p2;
wire    ap_loop_init;
reg   [31:0] j1_fu_60;
wire   [31:0] j1_12_fu_247_p3;
reg   [31:0] m1_fu_64;
wire   [31:0] m1_8_fu_255_p3;
wire   [15:0] grp_fu_148_p0;
wire   [15:0] grp_fu_153_p0;
wire   [5:0] trunc_ln1057_4_fu_197_p1;
wire   [5:0] trunc_ln1057_fu_193_p1;
wire   [0:0] icmp_ln27_fu_219_p2;
wire   [31:0] add_ln30_fu_225_p2;
wire   [0:0] icmp_ln23_fu_207_p2;
wire   [31:0] j1_10_fu_213_p2;
wire   [31:0] j1_11_fu_231_p3;
wire   [31:0] m1_7_fu_239_p3;
...
fwd_fft_hsub_16ns_16ns_16_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_5_full_dsp_1_U162(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(t1_M_real_fu_328_p1),
    .din1(p_r_reg_466),
...
fwd_fft_hmul_16ns_16ns_16_4_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_4_max_dsp_1_U164(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_148_p0),
    .din1(16'd0),
...
fwd_fft_hmul_16ns_16ns_16_4_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_4_max_dsp_1_U165(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_153_p0),
    .din1(16'd0),
...
assign add_ln19_fu_201_p2 = (trunc_ln1057_4_fu_197_p1 + trunc_ln1057_fu_193_p1);
...
assign j1_10_fu_213_p2 = (j1_fu_60 + 32'd1);

assign j1_11_fu_231_p3 = ((icmp_ln27_fu_219_p2[0:0] == 1'b1) ? 32'd0 : j1_fu_60);

assign j1_12_fu_247_p3 = ((icmp_ln23_fu_207_p2[0:0] == 1'b1) ? j1_10_fu_213_p2 : j1_11_fu_231_p3);

assign k1_12_fu_181_p2 = (k1_fu_56 + 7'd1);

assign m1_7_fu_239_p3 = ((icmp_ln27_fu_219_p2[0:0] == 1'b1) ? add_ln30_fu_225_p2 : m1_fu_64);

assign m1_8_fu_255_p3 = ((icmp_ln23_fu_207_p2[0:0] == 1'b1) ? m1_fu_64 : m1_7_fu_239_p3);

assign t1_M_imag_fu_333_p1 = trunc_ln19_2_reg_461;

assign t1_M_real_fu_328_p1 = trunc_ln19_reg_456;

assign trunc_ln1057_4_fu_197_p1 = j1_fu_60[5:0];
...
endmodule //fwd_fft_fft_stage_11627_Pipeline_SKIP_X
