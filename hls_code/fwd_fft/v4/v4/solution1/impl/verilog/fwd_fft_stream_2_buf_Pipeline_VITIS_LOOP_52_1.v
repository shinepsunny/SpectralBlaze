...
module fwd_fft_stream_2_buf_Pipeline_VITIS_LOOP_52_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln52_fu_88_p2 = (ap_sig_allocacmp_i_1 + 8'd1);
...
assign i_cast_fu_99_p1 = i_1_reg_110;

assign icmp_ln1057_fu_82_p2 = ((ap_sig_allocacmp_i_1 == ctrl1_reg_load_cast) ? 1'b1 : 1'b0);

assign input_buffer_address0 = i_cast_fu_99_p1;

assign input_buffer_d0 = c_ifmap_col_op_st_dout;

endmodule //fwd_fft_stream_2_buf_Pipeline_VITIS_LOOP_52_1
