...
module fwd_fft_dataflow_in_loop_VITIS_LOOP_441_3 (
        ap_clk,
        ap_rst,
...
fwd_fft_dataflow_in_loop_VITIS_LOOP_441_3_ifmap_CF_M_real #(
    .DataWidth( 32 ),
    .AddressRange( 2048 ),
    .AddressWidth( 11 ))
ifmap_CF_M_real_U(
...
fwd_fft_fifo_w8_d2_S_x0 ctrl1_reg_c_channel1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //fwd_fft_dataflow_in_loop_VITIS_LOOP_441_3
