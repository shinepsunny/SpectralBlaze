...
module fwd_fft_dataflow_in_loop_VITIS_LOOP_173_6 (
        ap_clk,
        ap_rst,
        p_read,
...
wire   [7:0] entry_proc16_U0_ap_return_0;
wire   [31:0] entry_proc16_U0_ap_return_1;
wire   [31:0] entry_proc16_U0_ap_return_2;
wire   [15:0] entry_proc16_U0_ap_return_3;
...
wire    ap_channel_done_y_6_c_channel;
wire    y_6_c_channel_full_n;
reg    ap_sync_reg_channel_write_y_6_c_channel;
wire    ap_sync_channel_write_y_6_c_channel;
wire    VITIS_LOOP_177_7_proc_U0_ap_start;
wire    VITIS_LOOP_177_7_proc_U0_ap_done;
wire    VITIS_LOOP_177_7_proc_U0_ap_continue;
wire    VITIS_LOOP_177_7_proc_U0_ap_idle;
wire    VITIS_LOOP_177_7_proc_U0_ap_ready;
wire    VITIS_LOOP_177_7_proc_U0_c_ifmap_col_op_st_read;
wire   [5:0] VITIS_LOOP_177_7_proc_U0_in_fft_M_value1_address0;
wire    VITIS_LOOP_177_7_proc_U0_in_fft_M_value1_ce0;
wire    VITIS_LOOP_177_7_proc_U0_in_fft_M_value1_we0;
wire   [31:0] VITIS_LOOP_177_7_proc_U0_in_fft_M_value1_d0;
wire   [5:0] VITIS_LOOP_177_7_proc_U0_in_fft_M_value_12_address0;
wire    VITIS_LOOP_177_7_proc_U0_in_fft_M_value_12_ce0;
wire    VITIS_LOOP_177_7_proc_U0_in_fft_M_value_12_we0;
wire   [31:0] VITIS_LOOP_177_7_proc_U0_in_fft_M_value_12_d0;
wire   [31:0] VITIS_LOOP_177_7_proc_U0_ctrl1_reg_c_din;
wire    VITIS_LOOP_177_7_proc_U0_ctrl1_reg_c_write;
wire    ap_channel_done_in_fft_M_value_1;
wire    VITIS_LOOP_177_7_proc_U0_in_fft_M_value_12_full_n;
...
wire    VITIS_LOOP_177_7_proc_U0_in_fft_M_value1_full_n;
reg    ap_sync_reg_channel_write_in_fft_M_value;
wire    ap_sync_channel_write_in_fft_M_value;
wire   [5:0] fft_param1_U0_xn_0_address0;
wire    fft_param1_U0_xn_0_ce0;
wire   [31:0] fft_param1_U0_xn_0_d0;
wire    fft_param1_U0_xn_0_we0;
wire   [5:0] fft_param1_U0_xn_0_address1;
wire    fft_param1_U0_xn_0_ce1;
wire   [31:0] fft_param1_U0_xn_0_d1;
wire    fft_param1_U0_xn_0_we1;
wire   [5:0] fft_param1_U0_xn_1_address0;
wire    fft_param1_U0_xn_1_ce0;
wire   [31:0] fft_param1_U0_xn_1_d0;
wire    fft_param1_U0_xn_1_we0;
wire   [5:0] fft_param1_U0_xn_1_address1;
wire    fft_param1_U0_xn_1_ce1;
wire   [31:0] fft_param1_U0_xn_1_d1;
wire    fft_param1_U0_xn_1_we1;
wire   [63:0] fft_param1_U0_out_fft_din;
wire    fft_param1_U0_out_fft_write;
wire    fft_param1_U0_xn_0_read;
wire    fft_param1_U0_xn_1_read;
wire    fft_param1_U0_ap_start;
wire    fft_param1_U0_ap_done;
wire    fft_param1_U0_ap_ready;
wire    fft_param1_U0_ap_idle;
wire    fft_param1_U0_ap_continue;
wire    VITIS_LOOP_185_8_proc_U0_ap_start;
wire    VITIS_LOOP_185_8_proc_U0_ap_done;
wire    VITIS_LOOP_185_8_proc_U0_ap_continue;
wire    VITIS_LOOP_185_8_proc_U0_ap_idle;
wire    VITIS_LOOP_185_8_proc_U0_ap_ready;
wire    VITIS_LOOP_185_8_proc_U0_ctrl1_reg_read;
wire    VITIS_LOOP_185_8_proc_U0_out_fft3_read;
wire   [31:0] VITIS_LOOP_185_8_proc_U0_c_fft_row_op_st_din;
wire    VITIS_LOOP_185_8_proc_U0_c_fft_row_op_st_write;
wire   [31:0] VITIS_LOOP_185_8_proc_U0_Row_Buffer_din;
wire    VITIS_LOOP_185_8_proc_U0_Row_Buffer_write;
wire    in_fft_M_value_i_full_n;
wire    in_fft_M_value_t_empty_n;
wire    in_fft_M_value_1_i_full_n;
wire    in_fft_M_value_1_t_empty_n;
wire   [31:0] y_6_c_channel_dout;
wire    y_6_c_channel_empty_n;
...
reg    ap_sync_reg_VITIS_LOOP_177_7_proc_U0_ap_ready;
wire    ap_sync_VITIS_LOOP_177_7_proc_U0_ap_ready;
wire    ap_ce_reg;
...
#0 ap_sync_reg_channel_write_y_6_c_channel = 1'b0;
...
#0 ap_sync_reg_VITIS_LOOP_177_7_proc_U0_ap_ready = 1'b0;
end

fwd_fft_dataflow_in_loop_VITIS_LOOP_173_6_in_fft_M_value #(
    .DataWidth( 32 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
in_fft_M_value_U(
...
fwd_fft_entry_proc16 entry_proc16_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
fwd_fft_VITIS_LOOP_177_7_proc VITIS_LOOP_177_7_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
fwd_fft_fft_param1_s fft_param1_U0(
...
fwd_fft_VITIS_LOOP_185_8_proc VITIS_LOOP_185_8_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
fwd_fft_fifo_w32_d3_S y_6_c_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_VITIS_LOOP_177_7_proc_U0_ap_ready <= 1'b0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((entry_proc16_U0_ap_done & entry_proc16_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_ctrl2_reg_c_channel <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((VITIS_LOOP_177_7_proc_U0_ap_done & VITIS_LOOP_177_7_proc_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_in_fft_M_value <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_channel_write_y_6_c_channel <= 1'b0;
    end else begin
        if (((entry_proc16_U0_ap_done & entry_proc16_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_y_6_c_channel <= 1'b0;
        end else begin
...
assign Row_Buffer_din = VITIS_LOOP_185_8_proc_U0_Row_Buffer_din;

assign Row_Buffer_write = VITIS_LOOP_185_8_proc_U0_Row_Buffer_write;

assign VITIS_LOOP_177_7_proc_U0_ap_continue = (ap_sync_channel_write_in_fft_M_value_1 & ap_sync_channel_write_in_fft_M_value);

assign VITIS_LOOP_177_7_proc_U0_ap_start = ((ap_sync_reg_VITIS_LOOP_177_7_proc_U0_ap_ready ^ 1'b1) & ap_start);

assign VITIS_LOOP_177_7_proc_U0_in_fft_M_value1_full_n = in_fft_M_value_i_full_n;

assign VITIS_LOOP_177_7_proc_U0_in_fft_M_value_12_full_n = in_fft_M_value_1_i_full_n;

assign VITIS_LOOP_185_8_proc_U0_ap_continue = ap_continue;

assign VITIS_LOOP_185_8_proc_U0_ap_start = (y_6_c_channel_empty_n & pny_c_channel_empty_n & ctrl2_reg_c_channel_empty_n);

assign ap_channel_done_ctrl2_reg_c_channel = ((ap_sync_reg_channel_write_ctrl2_reg_c_channel ^ 1'b1) & entry_proc16_U0_ap_done);

assign ap_channel_done_fft_config1_data_V_c_channel = ((ap_sync_reg_channel_write_fft_config1_data_V_c_channel ^ 1'b1) & entry_proc16_U0_ap_done);

assign ap_channel_done_in_fft_M_value = ((ap_sync_reg_channel_write_in_fft_M_value ^ 1'b1) & VITIS_LOOP_177_7_proc_U0_ap_done);

assign ap_channel_done_in_fft_M_value_1 = ((ap_sync_reg_channel_write_in_fft_M_value_1 ^ 1'b1) & VITIS_LOOP_177_7_proc_U0_ap_done);

assign ap_channel_done_pny_c_channel = ((ap_sync_reg_channel_write_pny_c_channel ^ 1'b1) & entry_proc16_U0_ap_done);

assign ap_channel_done_y_6_c_channel = ((ap_sync_reg_channel_write_y_6_c_channel ^ 1'b1) & entry_proc16_U0_ap_done);

assign ap_done = VITIS_LOOP_185_8_proc_U0_ap_done;

assign ap_idle = (fft_param1_U0_ap_idle & (fft_config1_data_V_c_channel_empty_n ^ 1'b1) & (pny_c_channel_empty_n ^ 1'b1) & (ctrl2_reg_c_channel_empty_n ^ 1'b1) & (y_6_c_channel_empty_n ^ 1'b1) & (in_fft_M_value_1_t_empty_n ^ 1'b1) & (in_fft_M_value_t_empty_n ^ 1'b1) & entry_proc16_U0_ap_idle & VITIS_LOOP_185_8_proc_U0_ap_idle & VITIS_LOOP_177_7_proc_U0_ap_idle);

assign ap_ready = ap_sync_ready;

assign ap_sync_VITIS_LOOP_177_7_proc_U0_ap_ready = (ap_sync_reg_VITIS_LOOP_177_7_proc_U0_ap_ready | VITIS_LOOP_177_7_proc_U0_ap_ready);
...
assign ap_sync_channel_write_in_fft_M_value = ((ap_channel_done_in_fft_M_value & VITIS_LOOP_177_7_proc_U0_in_fft_M_value1_full_n) | ap_sync_reg_channel_write_in_fft_M_value);

assign ap_sync_channel_write_in_fft_M_value_1 = ((ap_channel_done_in_fft_M_value_1 & VITIS_LOOP_177_7_proc_U0_in_fft_M_value_12_full_n) | ap_sync_reg_channel_write_in_fft_M_value_1);
...
assign ap_sync_channel_write_y_6_c_channel = ((y_6_c_channel_full_n & ap_channel_done_y_6_c_channel) | ap_sync_reg_channel_write_y_6_c_channel);

assign ap_sync_entry_proc16_U0_ap_ready = (entry_proc16_U0_ap_ready | ap_sync_reg_entry_proc16_U0_ap_ready);

assign ap_sync_ready = (ap_sync_entry_proc16_U0_ap_ready & ap_sync_VITIS_LOOP_177_7_proc_U0_ap_ready);

assign c_fft_row_op_st_din = VITIS_LOOP_185_8_proc_U0_c_fft_row_op_st_din;

assign c_fft_row_op_st_write = VITIS_LOOP_185_8_proc_U0_c_fft_row_op_st_write;

assign c_ifmap_col_op_st_read = VITIS_LOOP_177_7_proc_U0_c_ifmap_col_op_st_read;

assign entry_proc16_U0_ap_continue = (ap_sync_channel_write_y_6_c_channel & ap_sync_channel_write_pny_c_channel & ap_sync_channel_write_fft_config1_data_V_c_channel & ap_sync_channel_write_ctrl2_reg_c_channel);

assign entry_proc16_U0_ap_start = ((ap_sync_reg_entry_proc16_U0_ap_ready ^ 1'b1) & ap_start);

assign fft_param1_U0_ap_continue = 1'b1;

assign fft_param1_U0_ap_start = (in_fft_M_value_t_empty_n & in_fft_M_value_1_t_empty_n & fft_config1_data_V_c_channel_empty_n);

endmodule //fwd_fft_dataflow_in_loop_VITIS_LOOP_173_6
