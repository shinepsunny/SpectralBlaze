...
module fwd_fft_FFT_R_Block_split12_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start == 1'b0) | (layer1_reg_c29_full_n == 1'b0) | (ctrl2_reg_c24_full_n == 1'b0) | (layer1_reg_empty_n == 1'b0) | (ctrl2_reg_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (layer1_reg_c29_full_n == 1'b0) | (ctrl2_reg_c24_full_n == 1'b0) | (layer1_reg_empty_n == 1'b0) | (ctrl2_reg_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start == 1'b0) | (layer1_reg_c29_full_n == 1'b0) | (ctrl2_reg_c24_full_n == 1'b0) | (layer1_reg_empty_n == 1'b0) | (ctrl2_reg_empty_n == 1'b0) | (ap_done_reg == 1'b1))) begin
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (layer1_reg_c29_full_n == 1'b0) | (ctrl2_reg_c24_full_n == 1'b0) | (layer1_reg_empty_n == 1'b0) | (ctrl2_reg_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign ctrl2_reg_c24_din = ctrl2_reg_dout;

assign empty_180_fu_68_p1 = layer1_reg_dout[15:0];
...
assign rhs_V_2_out_0_fu_72_p1 = empty_180_fu_68_p1;
...
endmodule //fwd_fft_FFT_R_Block_split12_proc
