...
module fwd_fft_compute_fft_write_Pipeline_VITIS_LOOP_228_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] trunc_ln232_fu_102_p1;
reg   [31:0] trunc_ln232_reg_150;
reg   [31:0] trunc_ln232_1_reg_155;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln232_1_reg_155 <= {{out_fft_dout[63:32]}};
...
assign add_ln228_fu_91_p2 = (ap_sig_allocacmp_y + 8'd1);
...
assign grp_fu_71_p0 = trunc_ln232_reg_150;

assign grp_fu_74_p0 = trunc_ln232_1_reg_155;

assign icmp_ln1057_fu_85_p2 = ((ap_sig_allocacmp_y == ctrl1_reg_load_cast5) ? 1'b1 : 1'b0);

assign trunc_ln232_fu_102_p1 = out_fft_dout[31:0];

endmodule //fwd_fft_compute_fft_write_Pipeline_VITIS_LOOP_228_3
