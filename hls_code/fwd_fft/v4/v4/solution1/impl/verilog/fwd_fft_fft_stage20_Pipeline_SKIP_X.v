...
module fwd_fft_fft_stage20_Pipeline_SKIP_X (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
wire   [7:0] w_M_real28_address0;
reg    w_M_real28_ce0;
wire   [15:0] w_M_real28_q0;
wire   [7:0] w_M_imag22_address0;
reg    w_M_imag22_ce0;
wire   [15:0] w_M_imag22_q0;
...
reg   [15:0] p_r_M_imag_10_reg_554;
...
fwd_fft_hadd_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hadd_16ns_16ns_16_2_full_dsp_1_U156(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hadd_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hadd_16ns_16ns_16_2_full_dsp_1_U157(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U159(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U160(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(t1_M_real_fu_389_p1),
    .din1(p_r_reg_548),
...
fwd_fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U162(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U163(
    .clk(ap_clk),
    .reset(ap_rst),
...
assign j1_8_fu_298_p3 = ((icmp_ln30_fu_286_p2[0:0] == 1'b1) ? 32'd0 : j1_fu_64);

assign j1_9_fu_314_p3 = ((icmp_ln26_fu_274_p2[0:0] == 1'b1) ? j1_7_fu_280_p2 : j1_8_fu_298_p3);

assign k1_6_fu_221_p2 = (k1_fu_60 + 7'd1);

assign m1_5_fu_306_p3 = ((icmp_ln30_fu_286_p2[0:0] == 1'b1) ? add_ln33_fu_292_p2 : m1_fu_68);

assign m1_6_fu_322_p3 = ((icmp_ln26_fu_274_p2[0:0] == 1'b1) ? m1_fu_68 : m1_5_fu_306_p3);
...
assign w_M_imag22_address0 = zext_ln20_fu_251_p1;

assign w_M_real28_address0 = zext_ln20_fu_251_p1;
...
endmodule //fwd_fft_fft_stage20_Pipeline_SKIP_X
