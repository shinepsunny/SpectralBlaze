...
module fwd_fft_dataflow_in_loop_VITIS_LOOP_243_6 (
        ap_clk,
        ap_rst,
        p_read,
...
wire   [7:0] entry_proc31_U0_ap_return_0;
wire   [31:0] entry_proc31_U0_ap_return_1;
wire   [31:0] entry_proc31_U0_ap_return_2;
...
wire    VITIS_LOOP_247_7_proc_U0_ap_start;
wire    VITIS_LOOP_247_7_proc_U0_ap_done;
wire    VITIS_LOOP_247_7_proc_U0_ap_continue;
wire    VITIS_LOOP_247_7_proc_U0_ap_idle;
wire    VITIS_LOOP_247_7_proc_U0_ap_ready;
wire    VITIS_LOOP_247_7_proc_U0_c_ifmap_col_op_st_read;
wire   [5:0] VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_address0;
wire    VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_ce0;
wire    VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_we0;
wire   [15:0] VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_d0;
wire   [5:0] VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_address0;
wire    VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_ce0;
wire    VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_we0;
wire   [15:0] VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_d0;
wire   [31:0] VITIS_LOOP_247_7_proc_U0_ap_return;
...
wire    VITIS_LOOP_256_8_proc_U0_ap_start;
wire    VITIS_LOOP_256_8_proc_U0_ap_done;
wire    VITIS_LOOP_256_8_proc_U0_ap_continue;
wire    VITIS_LOOP_256_8_proc_U0_ap_idle;
wire    VITIS_LOOP_256_8_proc_U0_ap_ready;
wire    VITIS_LOOP_256_8_proc_U0_ctrl1_reg_read;
wire   [5:0] VITIS_LOOP_256_8_proc_U0_out_fft_03_address0;
wire    VITIS_LOOP_256_8_proc_U0_out_fft_03_ce0;
wire   [5:0] VITIS_LOOP_256_8_proc_U0_out_fft_14_address0;
wire    VITIS_LOOP_256_8_proc_U0_out_fft_14_ce0;
wire   [31:0] VITIS_LOOP_256_8_proc_U0_c_fft_row_op_st_din;
wire    VITIS_LOOP_256_8_proc_U0_c_fft_row_op_st_write;
wire   [31:0] VITIS_LOOP_256_8_proc_U0_Row_Buffer_din;
wire    VITIS_LOOP_256_8_proc_U0_Row_Buffer_write;
...
reg    ap_sync_reg_VITIS_LOOP_247_7_proc_U0_ap_ready;
wire    ap_sync_VITIS_LOOP_247_7_proc_U0_ap_ready;
wire    ap_ce_reg;
...
#0 ap_sync_reg_VITIS_LOOP_247_7_proc_U0_ap_ready = 1'b0;
end

fwd_fft_dataflow_in_loop_VITIS_LOOP_243_6_in_fft_M_real #(
    .DataWidth( 16 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
in_fft_M_real_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .i_address0(VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_address0),
    .i_ce0(VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_ce0),
    .i_we0(VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_we0),
    .i_d0(VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_d0),
...
in_fft_M_imag_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .i_address0(VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_address0),
    .i_ce0(VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_ce0),
    .i_we0(VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_we0),
    .i_d0(VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_d0),
...
fwd_fft_dataflow_in_loop_VITIS_LOOP_243_6_out_fft_03 #(
    .DataWidth( 16 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
out_fft_03_U(
    ...
    .t_address0(VITIS_LOOP_256_8_proc_U0_out_fft_03_address0),
    .t_ce0(VITIS_LOOP_256_8_proc_U0_out_fft_03_ce0),
    .t_we0(1'b0),
    .t_d0(16'd0),
    ...
    .t_read(VITIS_LOOP_256_8_proc_U0_ap_ready)
);
...
out_fft_14_U(
    ...
    .t_address0(VITIS_LOOP_256_8_proc_U0_out_fft_14_address0),
    .t_ce0(VITIS_LOOP_256_8_proc_U0_out_fft_14_ce0),
    .t_we0(1'b0),
    .t_d0(16'd0),
...
fwd_fft_entry_proc31 entry_proc31_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    ...
    .p_read1(p_read1),
    .y_7(y_7),
    .ap_return_0(entry_proc31_U0_ap_return_0),
    .ap_return_1(entry_proc31_U0_ap_return_1),
    .ap_return_2(entry_proc31_U0_ap_return_2)
);

fwd_fft_VITIS_LOOP_247_7_proc VITIS_LOOP_247_7_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(VITIS_LOOP_247_7_proc_U0_ap_start),
    .ap_done(VITIS_LOOP_247_7_proc_U0_ap_done),
    .ap_continue(VITIS_LOOP_247_7_proc_U0_ap_continue),
    .ap_idle(VITIS_LOOP_247_7_proc_U0_ap_idle),
    .ap_ready(VITIS_LOOP_247_7_proc_U0_ap_ready),
    .c_ifmap_col_op_st_dout(c_ifmap_col_op_st_dout),
    .c_ifmap_col_op_st_empty_n(c_ifmap_col_op_st_empty_n),
    .c_ifmap_col_op_st_read(VITIS_LOOP_247_7_proc_U0_c_ifmap_col_op_st_read),
    .p_read(p_read),
    .in_fft_M_real1_address0(VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_address0),
    .in_fft_M_real1_ce0(VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_ce0),
    .in_fft_M_real1_we0(VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_we0),
    .in_fft_M_real1_d0(VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_d0),
    .in_fft_M_imag2_address0(VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_address0),
    .in_fft_M_imag2_ce0(VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_ce0),
    .in_fft_M_imag2_we0(VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_we0),
    .in_fft_M_imag2_d0(VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_d0),
    .ap_return(VITIS_LOOP_247_7_proc_U0_ap_return)
);
...
fwd_fft_VITIS_LOOP_256_8_proc VITIS_LOOP_256_8_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(VITIS_LOOP_256_8_proc_U0_ap_start),
    .ap_done(VITIS_LOOP_256_8_proc_U0_ap_done),
    .ap_continue(VITIS_LOOP_256_8_proc_U0_ap_continue),
    .ap_idle(VITIS_LOOP_256_8_proc_U0_ap_idle),
    .ap_ready(VITIS_LOOP_256_8_proc_U0_ap_ready),
    .ctrl1_reg_dout(ctrl1_reg_c_dout),
    .ctrl1_reg_empty_n(ctrl1_reg_c_empty_n),
    .ctrl1_reg_read(VITIS_LOOP_256_8_proc_U0_ctrl1_reg_read),
    .out_fft_03_address0(VITIS_LOOP_256_8_proc_U0_out_fft_03_address0),
    .out_fft_03_ce0(VITIS_LOOP_256_8_proc_U0_out_fft_03_ce0),
    .out_fft_03_q0(out_fft_03_t_q0),
    .out_fft_14_address0(VITIS_LOOP_256_8_proc_U0_out_fft_14_address0),
    .out_fft_14_ce0(VITIS_LOOP_256_8_proc_U0_out_fft_14_ce0),
    .out_fft_14_q0(out_fft_14_t_q0),
    .c_fft_row_op_st_din(VITIS_LOOP_256_8_proc_U0_c_fft_row_op_st_din),
    .c_fft_row_op_st_full_n(c_fft_row_op_st_full_n),
    .c_fft_row_op_st_write(VITIS_LOOP_256_8_proc_U0_c_fft_row_op_st_write),
    .p_read(pny_c_channel_dout),
    .p_read1(ctrl2_reg_c_channel_dout),
    .p_read2(y_7_c_channel_dout),
    .Row_Buffer_din(VITIS_LOOP_256_8_proc_U0_Row_Buffer_din),
    .Row_Buffer_full_n(Row_Buffer_full_n),
    .Row_Buffer_write(VITIS_LOOP_256_8_proc_U0_Row_Buffer_write)
);
...
fwd_fft_fifo_w8_d3_S pny_c_channel_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(entry_proc31_U0_ap_return_0),
    ...
    .if_read(VITIS_LOOP_256_8_proc_U0_ap_ready)
);
...
fwd_fft_fifo_w32_d3_S ctrl2_reg_c_channel_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(entry_proc31_U0_ap_return_1),
...
fwd_fft_fifo_w32_d3_S y_7_c_channel_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(entry_proc31_U0_ap_return_2),
...
fwd_fft_fifo_w32_d2_S_x ctrl1_reg_c1_channel_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(VITIS_LOOP_247_7_proc_U0_ap_return),
...
fwd_fft_fifo_w32_d2_S_x ctrl1_reg_c_U(
    ...
    .if_read(VITIS_LOOP_256_8_proc_U0_ctrl1_reg_read)
);

always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_VITIS_LOOP_247_7_proc_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_VITIS_LOOP_247_7_proc_U0_ap_ready <= 1'b0;
        end else begin
            ap_sync_reg_VITIS_LOOP_247_7_proc_U0_ap_ready <= ap_sync_VITIS_LOOP_247_7_proc_U0_ap_ready;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((VITIS_LOOP_247_7_proc_U0_ap_done & VITIS_LOOP_247_7_proc_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_ctrl1_reg_c1_channel <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((entry_proc31_U0_ap_done & entry_proc31_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_ctrl2_reg_c_channel <= 1'b0;
        end else begin
...
assign Row_Buffer_din = VITIS_LOOP_256_8_proc_U0_Row_Buffer_din;

assign Row_Buffer_write = VITIS_LOOP_256_8_proc_U0_Row_Buffer_write;

assign VITIS_LOOP_247_7_proc_U0_ap_continue = (ap_sync_channel_write_in_fft_M_real & ap_sync_channel_write_in_fft_M_imag & ap_sync_channel_write_ctrl1_reg_c1_channel);

assign VITIS_LOOP_247_7_proc_U0_ap_start = ((ap_sync_reg_VITIS_LOOP_247_7_proc_U0_ap_ready ^ 1'b1) & ap_start);

assign VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_full_n = in_fft_M_imag_i_full_n;

assign VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_full_n = in_fft_M_real_i_full_n;

assign VITIS_LOOP_256_8_proc_U0_ap_continue = ap_continue;

assign VITIS_LOOP_256_8_proc_U0_ap_start = (y_7_c_channel_empty_n & pny_c_channel_empty_n & out_fft_14_t_empty_n & out_fft_03_t_empty_n & ctrl2_reg_c_channel_empty_n);

assign ap_channel_done_ctrl1_reg_c1_channel = ((ap_sync_reg_channel_write_ctrl1_reg_c1_channel ^ 1'b1) & VITIS_LOOP_247_7_proc_U0_ap_done);

assign ap_channel_done_ctrl2_reg_c_channel = ((ap_sync_reg_channel_write_ctrl2_reg_c_channel ^ 1'b1) & entry_proc31_U0_ap_done);

assign ap_channel_done_in_fft_M_imag = ((ap_sync_reg_channel_write_in_fft_M_imag ^ 1'b1) & VITIS_LOOP_247_7_proc_U0_ap_done);

assign ap_channel_done_in_fft_M_real = ((ap_sync_reg_channel_write_in_fft_M_real ^ 1'b1) & VITIS_LOOP_247_7_proc_U0_ap_done);
...
assign ap_channel_done_pny_c_channel = ((ap_sync_reg_channel_write_pny_c_channel ^ 1'b1) & entry_proc31_U0_ap_done);

assign ap_channel_done_y_7_c_channel = ((ap_sync_reg_channel_write_y_7_c_channel ^ 1'b1) & entry_proc31_U0_ap_done);

assign ap_done = VITIS_LOOP_256_8_proc_U0_ap_done;

assign ap_idle = (fft22_U0_ap_idle & (ctrl1_reg_c1_channel_empty_n ^ 1'b1) & (y_7_c_channel_empty_n ^ 1'b1) & (ctrl2_reg_c_channel_empty_n ^ 1'b1) & (pny_c_channel_empty_n ^ 1'b1) & (out_fft_14_t_empty_n ^ 1'b1) & (out_fft_03_t_empty_n ^ 1'b1) & (in_fft_M_imag_t_empty_n ^ 1'b1) & (in_fft_M_real_t_empty_n ^ 1'b1) & entry_proc31_U0_ap_idle & VITIS_LOOP_256_8_proc_U0_ap_idle & VITIS_LOOP_247_7_proc_U0_ap_idle);

assign ap_ready = ap_sync_ready;

assign ap_sync_VITIS_LOOP_247_7_proc_U0_ap_ready = (ap_sync_reg_VITIS_LOOP_247_7_proc_U0_ap_ready | VITIS_LOOP_247_7_proc_U0_ap_ready);
...
assign ap_sync_channel_write_in_fft_M_imag = ((ap_channel_done_in_fft_M_imag & VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_full_n) | ap_sync_reg_channel_write_in_fft_M_imag);

assign ap_sync_channel_write_in_fft_M_real = ((ap_channel_done_in_fft_M_real & VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_full_n) | ap_sync_reg_channel_write_in_fft_M_real);
...
assign ap_sync_ready = (ap_sync_entry_proc31_U0_ap_ready & ap_sync_VITIS_LOOP_247_7_proc_U0_ap_ready);

assign c_fft_row_op_st_din = VITIS_LOOP_256_8_proc_U0_c_fft_row_op_st_din;

assign c_fft_row_op_st_write = VITIS_LOOP_256_8_proc_U0_c_fft_row_op_st_write;

assign c_ifmap_col_op_st_read = VITIS_LOOP_247_7_proc_U0_c_ifmap_col_op_st_read;

assign entry_proc31_U0_ap_continue = (ap_sync_channel_write_y_7_c_channel & ap_sync_channel_write_pny_c_channel & ap_sync_channel_write_ctrl2_reg_c_channel);
...
endmodule //fwd_fft_dataflow_in_loop_VITIS_LOOP_243_6
