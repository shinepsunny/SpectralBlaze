...
module fwd_fft_dataflow_in_loop_VITIS_LOOP_398_3_ifmap_CF_M_real
#(parameter
    DataWidth    = 32,
    EnableWidth  = 4,
    AddressRange = 32,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        fwd_fft_dataflow_in_loop_VITIS_LOOP_398_3_ifmap_CF_M_real_memcore fwd_fft_dataflow_in_loop_VITIS_LOOP_398_3_ifmap_CF_M_real_memcore_U (
            .clk      ( clk ),
            .reset    ( reset ),
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
