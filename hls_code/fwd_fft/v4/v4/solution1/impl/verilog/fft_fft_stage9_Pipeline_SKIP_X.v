...
module fft_fft_stage9_Pipeline_SKIP_X (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [15:0] p_r_M_real_5_reg_572;
wire   [15:0] grp_fu_162_p2;
reg   [15:0] p_r_M_imag_6_reg_577;
wire   [15:0] grp_fu_170_p2;
reg   [15:0] p_r_M_real_6_reg_582;
wire   [15:0] grp_fu_174_p2;
reg   [15:0] p_r_M_imag_7_reg_587;
...
wire   [15:0] bitcast_ln176_1_fu_417_p1;
wire   [15:0] bitcast_ln173_1_fu_414_p1;
reg    ap_done_reg;
...
fft_hadd_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hadd_16ns_16ns_16_2_full_dsp_1_U80(
    .clk(ap_clk),
    .reset(ap_rst),
...
fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U83(
    .clk(ap_clk),
    .reset(ap_rst),
...
fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U84(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(t1_M_real_fu_389_p1),
    .din1(p_r_reg_548),
...
fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U85(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(t1_M_imag_fu_394_p1),
    .din1(p_r_M_imag_5_reg_554),
...
fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U86(
    .clk(ap_clk),
    .reset(ap_rst),
...
fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U87(
    .clk(ap_clk),
    .reset(ap_rst),
...
fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U88(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(p_r_M_real_fu_359_p1),
    .din1(w_M_imag_q0),
...
assign OUT_r_d0 = {{bitcast_ln176_1_fu_417_p1}, {bitcast_ln173_1_fu_414_p1}};

assign OUT_r_d1 = {{bitcast_ln176_fu_402_p1}, {bitcast_ln173_fu_399_p1}};

assign add_ln21_fu_257_p2 = (trunc_ln1057_1_fu_237_p1 + trunc_ln1057_fu_233_p1);

assign add_ln22_fu_263_p2 = (add_ln21_fu_257_p2 + 6'd16);

assign add_ln36_fu_292_p2 = (m1_fu_68 + 32'd32);
...
assign bitcast_ln173_1_fu_414_p1 = p_r_M_real_6_reg_582;

assign bitcast_ln173_fu_399_p1 = p_r_M_real_5_reg_572;

assign bitcast_ln176_1_fu_417_p1 = p_r_M_imag_7_reg_587;

assign bitcast_ln176_fu_402_p1 = p_r_M_imag_6_reg_577;

assign icmp_ln1057_fu_216_p2 = ((k1_fu_60 == trunc_ln1) ? 1'b1 : 1'b0);

assign icmp_ln29_fu_274_p2 = ((j1_fu_64 < 32'd15) ? 1'b1 : 1'b0);

assign icmp_ln33_fu_286_p2 = ((j1_fu_64 == 32'd15) ? 1'b1 : 1'b0);

assign j1_1_fu_280_p2 = (j1_fu_64 + 32'd1);

assign j1_2_fu_298_p3 = ((icmp_ln33_fu_286_p2[0:0] == 1'b1) ? 32'd0 : j1_fu_64);

assign j1_3_fu_314_p3 = ((icmp_ln29_fu_274_p2[0:0] == 1'b1) ? j1_1_fu_280_p2 : j1_2_fu_298_p3);

assign k1_2_fu_221_p2 = (k1_fu_60 + 7'd1);

assign m1_1_fu_306_p3 = ((icmp_ln33_fu_286_p2[0:0] == 1'b1) ? add_ln36_fu_292_p2 : m1_fu_68);

assign m1_2_fu_322_p3 = ((icmp_ln29_fu_274_p2[0:0] == 1'b1) ? m1_fu_68 : m1_1_fu_306_p3);
...
assign w_M_imag_address0 = zext_ln20_fu_251_p1;

assign w_M_real_address0 = zext_ln20_fu_251_p1;
...
endmodule //fft_fft_stage9_Pipeline_SKIP_X
