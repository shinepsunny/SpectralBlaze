...
module fwd_fft_fft_stage1022_Pipeline_SKIP_X (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [15:0] p_r_M_imag_37_reg_434;
...
reg   [6:0] k1_fu_42;
wire   [6:0] k1_24_fu_217_p2;
wire    ap_loop_init;
reg   [31:0] j1_fu_46;
wire   [31:0] j1_26_fu_279_p3;
reg   [31:0] m1_fu_50;
wire   [31:0] m1_22_fu_287_p3;
...
assign add_ln19_fu_237_p2 = (trunc_ln1057_10_fu_233_p1 + trunc_ln1057_fu_229_p1);
...
assign j1_26_fu_279_p3 = ((or_ln23_fu_273_p2[0:0] == 1'b1) ? zext_ln23_fu_269_p1 : j1_fu_46);

assign k1_24_fu_217_p2 = (k1_fu_42 + 7'd1);

assign m1_21_fu_261_p3 = ((icmp_ln27_fu_249_p2[0:0] == 1'b1) ? add_ln30_fu_255_p2 : m1_fu_50);

assign m1_22_fu_287_p3 = ((icmp_ln23_fu_243_p2[0:0] == 1'b1) ? m1_fu_50 : m1_21_fu_261_p3);

assign or_ln23_fu_273_p2 = (icmp_ln27_fu_249_p2 | icmp_ln23_fu_243_p2);

assign trunc_ln1057_10_fu_233_p1 = j1_fu_46[5:0];
...
endmodule //fwd_fft_fft_stage1022_Pipeline_SKIP_X
