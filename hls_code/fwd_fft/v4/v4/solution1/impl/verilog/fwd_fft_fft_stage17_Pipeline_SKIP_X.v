...
module fwd_fft_fft_stage17_Pipeline_SKIP_X (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
wire   [7:0] w_M_real31_address0;
reg    w_M_real31_ce0;
wire   [15:0] w_M_real31_q0;
...
reg   [15:0] p_r_M_imag_19_reg_552;
...
wire    ap_loop_init;
reg   [31:0] j1_fu_62;
wire   [31:0] j1_18_fu_312_p3;
reg   [31:0] m1_fu_66;
wire   [31:0] m1_12_fu_320_p3;
...
wire   [31:0] j1_16_fu_278_p2;
wire   [31:0] j1_17_fu_296_p3;
wire   [31:0] m1_11_fu_304_p3;
...
fwd_fft_hadd_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hadd_16ns_16ns_16_2_full_dsp_1_U97(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hadd_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hadd_16ns_16ns_16_2_full_dsp_1_U98(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U100(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U101(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(t1_M_real_fu_387_p1),
    .din1(p_r_reg_546),
...
fwd_fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U103(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U104(
    .clk(ap_clk),
    .reset(ap_rst),
...
assign add_ln21_fu_255_p2 = (trunc_ln1057_6_fu_235_p1 + trunc_ln1057_fu_231_p1);

assign add_ln22_fu_261_p2 = (add_ln21_fu_255_p2 + 6'd2);

assign add_ln33_fu_290_p2 = (m1_fu_66 + 32'd4);
...
assign icmp_ln30_fu_284_p2 = ((j1_fu_62 == 32'd1) ? 1'b1 : 1'b0);

assign j1_16_fu_278_p2 = (j1_fu_62 + 32'd1);

assign j1_17_fu_296_p3 = ((icmp_ln30_fu_284_p2[0:0] == 1'b1) ? 32'd0 : j1_fu_62);

assign j1_18_fu_312_p3 = ((icmp_ln26_fu_272_p2[0:0] == 1'b1) ? j1_16_fu_278_p2 : j1_17_fu_296_p3);

assign k1_12_fu_219_p2 = (k1_fu_58 + 7'd1);

assign m1_11_fu_304_p3 = ((icmp_ln30_fu_284_p2[0:0] == 1'b1) ? add_ln33_fu_290_p2 : m1_fu_66);

assign m1_12_fu_320_p3 = ((icmp_ln26_fu_272_p2[0:0] == 1'b1) ? m1_fu_66 : m1_11_fu_304_p3);
...
assign trunc_ln1057_6_fu_235_p1 = j1_fu_62[5:0];
...
assign w_M_imag25_address0 = zext_ln20_fu_249_p1;

assign w_M_real31_address0 = zext_ln20_fu_249_p1;
...
endmodule //fwd_fft_fft_stage17_Pipeline_SKIP_X
