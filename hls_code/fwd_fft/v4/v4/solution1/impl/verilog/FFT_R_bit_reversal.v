...
reg   [7:0] x_fu_54;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_x_7;
wire   [7:0] add_ln55_fu_119_p2;
wire   [7:0] empty_fu_91_p1;
wire   [2:0] p_partselect_cast_cast_fu_95_p4;
wire   [2:0] sub_ln674_fu_135_p2;
wire   [2:0] sub_ln674_1_fu_141_p2;
reg   [5:0] tmp_fu_125_p4;
wire   [5:0] zext_ln674_fu_147_p1;
wire   [5:0] zext_ln674_1_fu_151_p1;
wire   [5:0] lshr_ln674_fu_155_p2;
wire   [5:0] lshr_ln674_1_fu_161_p2;
...
assign add_ln55_fu_119_p2 = (ap_sig_allocacmp_x_7 + 8'd1);
...
assign icmp_ln1057_fu_113_p2 = ((ap_sig_allocacmp_x_7 == empty_fu_91_p1) ? 1'b1 : 1'b0);

assign lshr_ln674_1_fu_161_p2 = 6'd63 >> zext_ln674_1_fu_151_p1;

assign lshr_ln674_fu_155_p2 = tmp_fu_125_p4 >> zext_ln674_fu_147_p1;

assign p_Result_s_fu_167_p2 = (lshr_ln674_fu_155_p2 & lshr_ln674_1_fu_161_p2);

assign p_partselect_cast_cast_fu_95_p4 = {{p_read[10:8]}};

assign sub_ln674_1_fu_141_p2 = ($signed(3'd6) - $signed(p_partselect_cast_cast_fu_95_p4));

assign sub_ln674_fu_135_p2 = ($signed(3'd6) - $signed(p_partselect_cast_cast_fu_95_p4));

integer ap_tvar_int_0;

always @ (ap_sig_allocacmp_x_7) begin
    for (ap_tvar_int_0 = 6 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 5 - 0) begin
            ...
            tmp_fu_125_p4[ap_tvar_int_0] = ap_sig_allocacmp_x_7[5 - ap_tvar_int_0];
        end
    end
end

assign zext_ln1057_fu_183_p1 = x_7_reg_194;

assign zext_ln573_fu_173_p1 = p_Result_s_fu_167_p2;

assign zext_ln674_1_fu_151_p1 = sub_ln674_1_fu_141_p2;

assign zext_ln674_fu_147_p1 = sub_ln674_fu_135_p2;

endmodule //FFT_R_bit_reversal
