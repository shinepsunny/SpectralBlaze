...
assign add_ln55_fu_119_p2 = (ap_sig_allocacmp_x_13 + 8'd1);
...
assign icmp_ln1057_fu_113_p2 = ((ap_sig_allocacmp_x_13 == empty_fu_91_p1) ? 1'b1 : 1'b0);
...
assign sub_ln674_1_fu_141_p2 = ($signed(3'd6) - $signed(p_cast_cast_cast_fu_95_p4));

assign sub_ln674_fu_135_p2 = ($signed(3'd6) - $signed(p_cast_cast_cast_fu_95_p4));

integer ap_tvar_int_0;

always @ (ap_sig_allocacmp_x_13) begin
    for (ap_tvar_int_0 = 6 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 5 - 0) begin
            ...
            tmp_fu_125_p4[ap_tvar_int_0] = ap_sig_allocacmp_x_13[5 - ap_tvar_int_0];
        end
    end
end

assign zext_ln1057_fu_183_p1 = x_13_reg_194;
...
endmodule //fwd_fft_bit_reversal19
