...
module FFT_R_fft_stage5_Pipeline_SKIP_X (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [15:0] p_r_M_imag_17_reg_552;
...
wire    ap_loop_init;
reg   [31:0] j1_fu_62;
wire   [31:0] j1_15_fu_312_p3;
reg   [31:0] m1_fu_66;
wire   [31:0] m1_10_fu_320_p3;
...
wire   [31:0] j1_13_fu_278_p2;
wire   [31:0] j1_14_fu_296_p3;
wire   [31:0] m1_9_fu_304_p3;
...
assign add_ln21_fu_255_p2 = (trunc_ln1057_5_fu_235_p1 + trunc_ln1057_fu_231_p1);
...
assign j1_13_fu_278_p2 = (j1_fu_62 + 32'd1);

assign j1_14_fu_296_p3 = ((icmp_ln30_fu_284_p2[0:0] == 1'b1) ? 32'd0 : j1_fu_62);

assign j1_15_fu_312_p3 = ((icmp_ln26_fu_272_p2[0:0] == 1'b1) ? j1_13_fu_278_p2 : j1_14_fu_296_p3);

assign k1_10_fu_219_p2 = (k1_fu_58 + 7'd1);

assign m1_10_fu_320_p3 = ((icmp_ln26_fu_272_p2[0:0] == 1'b1) ? m1_fu_66 : m1_9_fu_304_p3);

assign m1_9_fu_304_p3 = ((icmp_ln30_fu_284_p2[0:0] == 1'b1) ? add_ln33_fu_290_p2 : m1_fu_66);
...
assign w_M_imag13_address0 = zext_ln20_fu_249_p1;

assign w_M_real18_address0 = zext_ln20_fu_249_p1;
...
endmodule //FFT_R_fft_stage5_Pipeline_SKIP_X
