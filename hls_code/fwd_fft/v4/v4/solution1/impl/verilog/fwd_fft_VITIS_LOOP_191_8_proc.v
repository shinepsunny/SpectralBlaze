...
module fwd_fft_VITIS_LOOP_191_8_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] or_ln196_reg_257;
wire   [7:0] trunc_ln157_fu_130_p1;
reg   [7:0] trunc_ln157_reg_252;
wire   [0:0] or_ln196_fu_178_p2;
wire   [7:0] add_ln191_fu_197_p2;
reg   [7:0] add_ln191_reg_264;
wire   [31:0] trunc_ln194_fu_203_p1;
reg   [31:0] trunc_ln194_reg_269;
reg   [31:0] trunc_ln194_1_reg_274;
...
always @ (posedge ap_clk) begin
    if ((~((ctrl1_reg_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        x_fu_76 <= 8'd0;
    end else if ((~((c_fft_row_op_st_full_n == 1'b0) | ((or_ln196_reg_257 == 1'd0) & (1'b0 == Row_Buffer_full_n))) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1057_fu_192_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        trunc_ln194_1_reg_274 <= {{out_fft3_dout[63:32]}};
        trunc_ln194_reg_269 <= trunc_ln194_fu_203_p1;
    end
end

always @ (*) begin
    if (((or_ln196_reg_257 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if ((~((c_fft_row_op_st_full_n == 1'b0) | ((or_ln196_reg_257 == 1'd0) & (1'b0 == Row_Buffer_full_n))) & (or_ln196_reg_257 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((c_fft_row_op_st_full_n == 1'b0) | ((or_ln196_reg_257 == 1'd0) & (1'b0 == Row_Buffer_full_n)))) begin
...
always @ (*) begin
    if ((~((c_fft_row_op_st_full_n == 1'b0) | ((or_ln196_reg_257 == 1'd0) & (1'b0 == Row_Buffer_full_n))) & (1'b1 == ap_CS_fsm_state5))) begin
...
assign add_ln191_fu_197_p2 = (x_fu_76 + 8'd1);
...
always @ (*) begin
    ap_block_state5 = ((c_fft_row_op_st_full_n == 1'b0) | ((or_ln196_reg_257 == 1'd0) & (1'b0 == Row_Buffer_full_n)));
end
...
assign grp_fu_124_p0 = trunc_ln194_reg_269;

assign grp_fu_127_p0 = trunc_ln194_1_reg_274;

assign icmp_ln1057_fu_192_p2 = ((x_fu_76 == trunc_ln157_reg_252) ? 1'b1 : 1'b0);

assign icmp_ln196_fu_172_p2 = (($signed(zext_ln1061_fu_168_p1) > $signed(p_read2)) ? 1'b1 : 1'b0);

assign lshr_ln_fu_158_p4 = {{ctrl1_reg_dout[31:24]}};

assign or_ln196_fu_178_p2 = (icmp_ln196_fu_172_p2 | cmp_i_i_fu_152_p2);
...
assign trunc_ln157_fu_130_p1 = ctrl1_reg_dout[7:0];

assign trunc_ln194_fu_203_p1 = out_fft3_dout[31:0];

assign zext_ln1061_fu_168_p1 = lshr_ln_fu_158_p4;

endmodule //fwd_fft_VITIS_LOOP_191_8_proc
