...
wire    dataflow_parent_loop_proc15_U0_c_fft_row_op_st_read;
wire   [31:0] dataflow_parent_loop_proc15_U0_c_fft_col_op_st_din;
wire    dataflow_parent_loop_proc15_U0_c_fft_col_op_st_write;
...
fwd_fft_dataflow_parent_loop_proc15 dataflow_parent_loop_proc15_U0(
...
always @ (*) begin
    if (((loop_dataflow_output_count == 8'd0) & (ap_start == 1'b0) & (dataflow_parent_loop_proc15_U0_ap_idle == 1'b1))) begin
        ap_idle = 1'b1;
    end else begin
        ap_idle = 1'b0;
    end
...
assign c_fft_col_op_st_din = dataflow_parent_loop_proc15_U0_c_fft_col_op_st_din;

assign c_fft_col_op_st_write = dataflow_parent_loop_proc15_U0_c_fft_col_op_st_write;

assign c_fft_row_op_st_read = dataflow_parent_loop_proc15_U0_c_fft_row_op_st_read;
