...
module fwd_fft_dataflow_in_loop_VITIS_LOOP_137_1 (
        ap_clk,
        ap_rst,
...
input  [31:0] p_read;
output  [63:0] c_fft_col_op_st_din;
...
wire   [63:0] stream_2_buf_U0_input_buffer_d0;
...
wire    bit_reversal_U0_ap_start;
wire    bit_reversal_U0_ap_done;
wire    bit_reversal_U0_ap_continue;
wire    bit_reversal_U0_ap_idle;
wire    bit_reversal_U0_ap_ready;
wire   [5:0] bit_reversal_U0_IN_r_address0;
wire    bit_reversal_U0_IN_r_ce0;
wire   [5:0] bit_reversal_U0_OUT_r_address0;
wire    bit_reversal_U0_OUT_r_ce0;
wire    bit_reversal_U0_OUT_r_we0;
wire   [63:0] bit_reversal_U0_OUT_r_d0;
wire   [31:0] bit_reversal_U0_ap_return;
...
wire    bit_reversal_U0_OUT_r_full_n;
...
wire   [63:0] buf_2_stream_U0_c_fft_col_op_st_din;
...
input_data1_U(
    ...
    .t_address0(bit_reversal_U0_IN_r_address0),
    .t_ce0(bit_reversal_U0_IN_r_ce0),
    .t_we0(1'b0),
    .t_d0(64'd0),
    ...
    .t_read(bit_reversal_U0_ap_ready)
);
...
input_data_rev2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .i_address0(bit_reversal_U0_OUT_r_address0),
    .i_ce0(bit_reversal_U0_OUT_r_ce0),
    .i_we0(bit_reversal_U0_OUT_r_we0),
    .i_d0(bit_reversal_U0_OUT_r_d0),
...
fwd_fft_bit_reversal bit_reversal_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(bit_reversal_U0_ap_start),
    .ap_done(bit_reversal_U0_ap_done),
    .ap_continue(bit_reversal_U0_ap_continue),
    .ap_idle(bit_reversal_U0_ap_idle),
    .ap_ready(bit_reversal_U0_ap_ready),
    .IN_r_address0(bit_reversal_U0_IN_r_address0),
    .IN_r_ce0(bit_reversal_U0_IN_r_ce0),
    .IN_r_q0(input_data1_t_q0),
    .OUT_r_address0(bit_reversal_U0_OUT_r_address0),
    .OUT_r_ce0(bit_reversal_U0_OUT_r_ce0),
    .OUT_r_we0(bit_reversal_U0_OUT_r_we0),
    .OUT_r_d0(bit_reversal_U0_OUT_r_d0),
    .p_read(ctrl1_reg_c7_channel_dout),
    .ap_return(bit_reversal_U0_ap_return)
);
...
fwd_fft_fifo_w32_d2_S_x ctrl1_reg_c7_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    ...
    .if_read(bit_reversal_U0_ap_ready)
);
...
fwd_fft_fifo_w32_d2_S_x ctrl1_reg_c6_channel_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(bit_reversal_U0_ap_return),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((bit_reversal_U0_ap_done & bit_reversal_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_ctrl1_reg_c6_channel <= 1'b0;
        end else begin
...
assign ap_channel_done_ctrl1_reg_c6_channel = ((ap_sync_reg_channel_write_ctrl1_reg_c6_channel ^ 1'b1) & bit_reversal_U0_ap_done);

assign ap_channel_done_ctrl1_reg_c7_channel = (stream_2_buf_U0_ap_done & (ap_sync_reg_channel_write_ctrl1_reg_c7_channel ^ 1'b1));
...
assign ap_channel_done_input_data_rev2 = ((ap_sync_reg_channel_write_input_data_rev2 ^ 1'b1) & bit_reversal_U0_ap_done);

assign ap_channel_done_out_data_13 = (fft_stage_0_0_U0_ap_done & (ap_sync_reg_channel_write_out_data_13 ^ 1'b1));

assign ap_channel_done_out_data_24 = (fft_stage_1_0_U0_ap_done & (ap_sync_reg_channel_write_out_data_24 ^ 1'b1));

assign ap_channel_done_out_data_35 = (fft_stage_2_0_U0_ap_done & (ap_sync_reg_channel_write_out_data_35 ^ 1'b1));

assign ap_channel_done_out_data_46 = (fft_stage_3_0_U0_ap_done & (ap_sync_reg_channel_write_out_data_46 ^ 1'b1));

assign ap_channel_done_out_data_57 = (fft_stage_4_0_U0_ap_done & (ap_sync_reg_channel_write_out_data_57 ^ 1'b1));

assign ap_channel_done_out_data_68 = (fft_stage_5_0_U0_ap_done & (ap_sync_reg_channel_write_out_data_68 ^ 1'b1));

assign ap_done = buf_2_stream_U0_ap_done;

assign ap_idle = (stream_2_buf_U0_ap_idle & fft_stage_5_0_U0_ap_idle & fft_stage_4_0_U0_ap_idle & fft_stage_3_0_U0_ap_idle & fft_stage_2_0_U0_ap_idle & fft_stage_1_0_U0_ap_idle & fft_stage_0_0_U0_ap_idle & (ctrl1_reg_c_channel_empty_n ^ 1'b1) & (ctrl1_reg_c1_channel_empty_n ^ 1'b1) & (ctrl1_reg_c2_channel_empty_n ^ 1'b1) & (ctrl1_reg_c3_channel_empty_n ^ 1'b1) & (ctrl1_reg_c4_channel_empty_n ^ 1'b1) & (ctrl1_reg_c5_channel_empty_n ^ 1'b1) & (ctrl1_reg_c6_channel_empty_n ^ 1'b1) & (ctrl1_reg_c7_channel_empty_n ^ 1'b1) & (out_data_68_t_empty_n ^ 1'b1) & (out_data_57_t_empty_n ^ 1'b1) & (out_data_46_t_empty_n ^ 1'b1) & (out_data_35_t_empty_n ^ 1'b1) & (out_data_24_t_empty_n ^ 1'b1) & (out_data_13_t_empty_n ^ 1'b1) & (input_data_rev2_t_empty_n ^ 1'b1) & (input_data1_t_empty_n ^ 1'b1) & buf_2_stream_U0_ap_idle & bit_reversal_U0_ap_idle);
...
assign ap_sync_channel_write_input_data_rev2 = ((bit_reversal_U0_OUT_r_full_n & ap_channel_done_input_data_rev2) | ap_sync_reg_channel_write_input_data_rev2);

assign ap_sync_channel_write_out_data_13 = ((fft_stage_0_0_U0_OUT_r_full_n & ap_channel_done_out_data_13) | ap_sync_reg_channel_write_out_data_13);

assign ap_sync_channel_write_out_data_24 = ((fft_stage_1_0_U0_OUT_r_full_n & ap_channel_done_out_data_24) | ap_sync_reg_channel_write_out_data_24);

assign ap_sync_channel_write_out_data_35 = ((fft_stage_2_0_U0_OUT_r_full_n & ap_channel_done_out_data_35) | ap_sync_reg_channel_write_out_data_35);

assign ap_sync_channel_write_out_data_46 = ((fft_stage_3_0_U0_OUT_r_full_n & ap_channel_done_out_data_46) | ap_sync_reg_channel_write_out_data_46);

assign ap_sync_channel_write_out_data_57 = ((fft_stage_4_0_U0_OUT_r_full_n & ap_channel_done_out_data_57) | ap_sync_reg_channel_write_out_data_57);

assign ap_sync_channel_write_out_data_68 = ((fft_stage_5_0_U0_OUT_r_full_n & ap_channel_done_out_data_68) | ap_sync_reg_channel_write_out_data_68);

assign bit_reversal_U0_OUT_r_full_n = input_data_rev2_i_full_n;

assign bit_reversal_U0_ap_continue = (ap_sync_channel_write_input_data_rev2 & ap_sync_channel_write_ctrl1_reg_c6_channel);

assign bit_reversal_U0_ap_start = (input_data1_t_empty_n & ctrl1_reg_c7_channel_empty_n);

assign buf_2_stream_U0_ap_continue = ap_continue;

assign buf_2_stream_U0_ap_start = (out_data_68_t_empty_n & ctrl1_reg_c_channel_empty_n);
...
assign fft_stage_0_0_U0_OUT_r_full_n = out_data_13_i_full_n;

assign fft_stage_0_0_U0_ap_continue = (ap_sync_channel_write_out_data_13 & ap_sync_channel_write_ctrl1_reg_c5_channel);

assign fft_stage_0_0_U0_ap_start = (input_data_rev2_t_empty_n & ctrl1_reg_c6_channel_empty_n);

assign fft_stage_1_0_U0_OUT_r_full_n = out_data_24_i_full_n;

assign fft_stage_1_0_U0_ap_continue = (ap_sync_channel_write_out_data_24 & ap_sync_channel_write_ctrl1_reg_c4_channel);

assign fft_stage_1_0_U0_ap_start = (out_data_13_t_empty_n & ctrl1_reg_c5_channel_empty_n);

assign fft_stage_2_0_U0_OUT_r_full_n = out_data_35_i_full_n;

assign fft_stage_2_0_U0_ap_continue = (ap_sync_channel_write_out_data_35 & ap_sync_channel_write_ctrl1_reg_c3_channel);

assign fft_stage_2_0_U0_ap_start = (out_data_24_t_empty_n & ctrl1_reg_c4_channel_empty_n);

assign fft_stage_3_0_U0_OUT_r_full_n = out_data_46_i_full_n;

assign fft_stage_3_0_U0_ap_continue = (ap_sync_channel_write_out_data_46 & ap_sync_channel_write_ctrl1_reg_c2_channel);

assign fft_stage_3_0_U0_ap_start = (out_data_35_t_empty_n & ctrl1_reg_c3_channel_empty_n);

assign fft_stage_4_0_U0_OUT_r_full_n = out_data_57_i_full_n;

assign fft_stage_4_0_U0_ap_continue = (ap_sync_channel_write_out_data_57 & ap_sync_channel_write_ctrl1_reg_c1_channel);

assign fft_stage_4_0_U0_ap_start = (out_data_46_t_empty_n & ctrl1_reg_c2_channel_empty_n);

assign fft_stage_5_0_U0_OUT_r_full_n = out_data_68_i_full_n;

assign fft_stage_5_0_U0_ap_continue = (ap_sync_channel_write_out_data_68 & ap_sync_channel_write_ctrl1_reg_c_channel);

assign fft_stage_5_0_U0_ap_start = (out_data_57_t_empty_n & ctrl1_reg_c1_channel_empty_n);

assign stream_2_buf_U0_ap_continue = (ap_sync_channel_write_input_data1 & ap_sync_channel_write_ctrl1_reg_c7_channel);

assign stream_2_buf_U0_ap_start = ap_start;

assign stream_2_buf_U0_input_buffer_full_n = input_data1_i_full_n;

endmodule //fwd_fft_dataflow_in_loop_VITIS_LOOP_137_1
