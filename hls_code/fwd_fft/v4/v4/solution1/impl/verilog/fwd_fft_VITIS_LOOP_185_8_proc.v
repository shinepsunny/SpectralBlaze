...
module fwd_fft_VITIS_LOOP_185_8_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] and_ln190_reg_257;
wire   [7:0] trunc_ln152_fu_130_p1;
reg   [7:0] trunc_ln152_reg_252;
wire   [0:0] and_ln190_fu_178_p2;
wire   [7:0] add_ln185_fu_197_p2;
reg   [7:0] add_ln185_reg_264;
wire   [31:0] trunc_ln188_fu_203_p1;
reg   [31:0] trunc_ln188_reg_269;
reg   [31:0] trunc_ln188_1_reg_274;
...
wire   [31:0] zext_ln1065_fu_168_p1;
...
fwd_fft_sptohp_32ns_16_2_no_dsp_1 #(
    ...
    .din0_WIDTH( 32 ),
    .dout_WIDTH( 16 ))
sptohp_32ns_16_2_no_dsp_1_U116(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_124_p0),
    .ce(1'b1),
...
fwd_fft_sptohp_32ns_16_2_no_dsp_1 #(
    ...
    .din0_WIDTH( 32 ),
    .dout_WIDTH( 16 ))
sptohp_32ns_16_2_no_dsp_1_U117(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_127_p0),
    .ce(1'b1),
...
always @ (posedge ap_clk) begin
    if ((~((ctrl1_reg_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        x_fu_76 <= 8'd0;
    end else if ((~((c_fft_row_op_st_full_n == 1'b0) | ((1'd1 == and_ln190_reg_257) & (1'b0 == Row_Buffer_full_n))) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1057_fu_192_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        trunc_ln188_1_reg_274 <= {{out_fft3_dout[63:32]}};
        trunc_ln188_reg_269 <= trunc_ln188_fu_203_p1;
    end
end

always @ (*) begin
    if (((1'd1 == and_ln190_reg_257) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if ((~((c_fft_row_op_st_full_n == 1'b0) | ((1'd1 == and_ln190_reg_257) & (1'b0 == Row_Buffer_full_n))) & (1'd1 == and_ln190_reg_257) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((c_fft_row_op_st_full_n == 1'b0) | ((1'd1 == and_ln190_reg_257) & (1'b0 == Row_Buffer_full_n)))) begin
...
always @ (*) begin
    if ((~((c_fft_row_op_st_full_n == 1'b0) | ((1'd1 == and_ln190_reg_257) & (1'b0 == Row_Buffer_full_n))) & (1'b1 == ap_CS_fsm_state5))) begin
...
assign add_ln185_fu_197_p2 = (x_fu_76 + 8'd1);

assign and_ln190_fu_178_p2 = (icmp_ln190_fu_172_p2 & cmp_i_i_fu_152_p2);
...
always @ (*) begin
    ap_block_state5 = ((c_fft_row_op_st_full_n == 1'b0) | ((1'd1 == and_ln190_reg_257) & (1'b0 == Row_Buffer_full_n)));
end
...
assign grp_fu_124_p0 = trunc_ln188_reg_269;

assign grp_fu_127_p0 = trunc_ln188_1_reg_274;

assign icmp_ln1057_fu_192_p2 = ((x_fu_76 == trunc_ln152_reg_252) ? 1'b1 : 1'b0);

assign icmp_ln190_fu_172_p2 = (($signed(zext_ln1065_fu_168_p1) < $signed(p_read2)) ? 1'b1 : 1'b0);
...
assign trunc_ln152_fu_130_p1 = ctrl1_reg_dout[7:0];

assign trunc_ln188_fu_203_p1 = out_fft3_dout[31:0];

assign zext_ln1065_fu_168_p1 = lshr_ln_fu_158_p4;

endmodule //fwd_fft_VITIS_LOOP_185_8_proc
