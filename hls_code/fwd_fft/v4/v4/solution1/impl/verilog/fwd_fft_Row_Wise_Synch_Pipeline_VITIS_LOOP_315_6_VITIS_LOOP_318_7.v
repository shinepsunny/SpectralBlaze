...
module fwd_fft_Row_Wise_Synch_Pipeline_VITIS_LOOP_315_6_VITIS_LOOP_318_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] select_ln292_fu_188_p3;
wire   [7:0] add_ln318_fu_212_p2;
reg    ap_done_reg;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (or_ln292_reg_287 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (or_ln292_reg_287 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
assign add_ln318_fu_212_p2 = (x_fu_60 + 8'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter2 == 1'b1) & ((c_row_op_st_full_n == 1'b0) | (c_fft_row_op_st_empty_n == 1'b0) | ((or_ln292_reg_287 == 1'd0) & (1'b0 == Row_Buffer_full_n))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter2 == 1'b1) & ((c_row_op_st_full_n == 1'b0) | (c_fft_row_op_st_empty_n == 1'b0) | ((or_ln292_reg_287 == 1'd0) & (1'b0 == Row_Buffer_full_n))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter2 == 1'b1) & ((c_row_op_st_full_n == 1'b0) | (c_fft_row_op_st_empty_n == 1'b0) | ((or_ln292_reg_287 == 1'd0) & (1'b0 == Row_Buffer_full_n))));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((c_row_op_st_full_n == 1'b0) | (c_fft_row_op_st_empty_n == 1'b0) | ((or_ln292_reg_287 == 1'd0) & (1'b0 == Row_Buffer_full_n)));
end
...
assign or_ln292_fu_196_p2 = (select_ln292_fu_188_p3 | select_ln292_4);

assign p_cast_fu_124_p1 = empty;

assign select_ln1057_fu_201_p3 = ((icmp_ln1057_5_fu_183_p2[0:0] == 1'b1) ? y_fu_167_p2 : y_1_fu_64);

assign select_ln292_fu_188_p3 = ((icmp_ln1057_5_fu_183_p2[0:0] == 1'b1) ? cmp_i_i7_not_mid1_fu_173_p2 : cmp_i_i7_not37_fu_178_p2);

assign x_13_fu_218_p3 = ((icmp_ln1057_5_fu_183_p2[0:0] == 1'b1) ? 8'd1 : add_ln318_fu_212_p2);
...
endmodule //fwd_fft_Row_Wise_Synch_Pipeline_VITIS_LOOP_315_6_VITIS_LOOP_318_7
