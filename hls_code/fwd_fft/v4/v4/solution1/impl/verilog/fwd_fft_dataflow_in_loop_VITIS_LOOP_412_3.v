...
module fwd_fft_dataflow_in_loop_VITIS_LOOP_412_3 (
        ap_clk,
        ap_rst,
        c_row_op_st_dout,
        c_row_op_st_empty_n,
...
wire    ifmap_gen_x_U0_c_row_op_st_read;
...
wire   [7:0] ifmap_gen_x_U0_ap_return;
...
wire    ifmap_cons_y_U0_ap_start;
wire    ifmap_cons_y_U0_ap_done;
wire    ifmap_cons_y_U0_ap_continue;
wire    ifmap_cons_y_U0_ap_idle;
wire    ifmap_cons_y_U0_ap_ready;
wire   [31:0] ifmap_cons_y_U0_c_row_op_trans_st_din;
wire    ifmap_cons_y_U0_c_row_op_trans_st_write;
wire   [11:0] ifmap_cons_y_U0_ifmap_CF_M_real_address0;
wire    ifmap_cons_y_U0_ifmap_CF_M_real_ce0;
wire   [11:0] ifmap_cons_y_U0_ifmap_CF_M_imag_address0;
wire    ifmap_cons_y_U0_ifmap_CF_M_imag_ce0;
...
fwd_fft_dataflow_in_loop_VITIS_LOOP_412_3_ifmap_RF_M_real #(
    .DataWidth( 16 ),
    .AddressRange( 4096 ),
    .AddressWidth( 12 ))
ifmap_RF_M_real_U(
...
fwd_fft_ifmap_cons_y ifmap_cons_y_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
fwd_fft_fifo_w8_d2_S_x ctrl1_reg_c_channel1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_done = ifmap_cons_y_U0_ap_done;

assign ap_idle = (ifmap_gen_x_U0_ap_idle & ifmap_cons_y_U0_ap_idle & (ctrl1_reg_c_channel1_empty_n ^ 1'b1) & (ifmap_RF_M_imag_t_empty_n ^ 1'b1) & (ifmap_RF_M_real_t_empty_n ^ 1'b1));
...
assign c_row_op_st_read = ifmap_gen_x_U0_c_row_op_st_read;

assign c_row_op_trans_st_din = ifmap_cons_y_U0_c_row_op_trans_st_din;

assign c_row_op_trans_st_write = ifmap_cons_y_U0_c_row_op_trans_st_write;

assign ifmap_cons_y_U0_ap_continue = ap_continue;

assign ifmap_cons_y_U0_ap_start = (ifmap_RF_M_real_t_empty_n & ifmap_RF_M_imag_t_empty_n & ctrl1_reg_c_channel1_empty_n);
...
endmodule //fwd_fft_dataflow_in_loop_VITIS_LOOP_412_3
