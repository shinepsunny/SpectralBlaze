...
module fwd_fft_fft_stage1018_Pipeline_SKIP_X (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [7:0] m1_load_reg_313;
reg   [7:0] m1_load_reg_313_pp0_iter1_reg;
reg   [7:0] m1_load_reg_313_pp0_iter2_reg;
...
reg   [15:0] p_r_M_imag_37_reg_376;
...
wire   [6:0] k1_24_fu_173_p2;
reg   [7:0] m1_fu_60;
reg   [7:0] ap_sig_allocacmp_m1_load;
wire   [7:0] m1_22_fu_197_p2;
...
fwd_fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U85(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_144_p0),
    .din1(16'd0),
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        zext_ln21_reg_350[7 : 0] <= zext_ln21_fu_237_p1[7 : 0];
        zext_ln21_reg_350_pp0_iter4_reg[7 : 0] <= zext_ln21_reg_350[7 : 0];
        zext_ln21_reg_350_pp0_iter5_reg[7 : 0] <= zext_ln21_reg_350_pp0_iter4_reg[7 : 0];
        zext_ln21_reg_350_pp0_iter6_reg[7 : 0] <= zext_ln21_reg_350_pp0_iter5_reg[7 : 0];
...
assign icmp_ln1057_fu_167_p2 = ((ap_sig_allocacmp_k1_23 == trunc_ln16) ? 1'b1 : 1'b0);

assign k1_24_fu_173_p2 = (ap_sig_allocacmp_k1_23 + 7'd1);

assign m1_22_fu_197_p2 = (ap_sig_allocacmp_m1_load + 8'd2);
...
assign zext_ln21_fu_237_p1 = m1_load_reg_313_pp0_iter2_reg;
...
always @ (posedge ap_clk) begin
    ...
    zext_ln21_reg_350[63:8] <= 56'b00000000000000000000000000000000000000000000000000000000;
    zext_ln21_reg_350_pp0_iter4_reg[63:8] <= 56'b00000000000000000000000000000000000000000000000000000000;
    zext_ln21_reg_350_pp0_iter5_reg[63:8] <= 56'b00000000000000000000000000000000000000000000000000000000;
    zext_ln21_reg_350_pp0_iter6_reg[63:8] <= 56'b00000000000000000000000000000000000000000000000000000000;
end

endmodule //fwd_fft_fft_stage1018_Pipeline_SKIP_X
