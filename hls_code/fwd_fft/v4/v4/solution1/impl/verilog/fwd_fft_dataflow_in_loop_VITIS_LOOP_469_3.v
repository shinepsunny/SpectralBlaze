...
module fwd_fft_dataflow_in_loop_VITIS_LOOP_469_3 (
        ap_clk,
        ap_rst,
...
input   ap_clk;
input   ap_rst;
input  [63:0] c_fft_col_op_st_dout;
...
wire   [63:0] ifmap_CF_M_value_i_q0;
wire   [63:0] ifmap_CF_M_value_i_q1;
wire   [7:0] ifmap_CF_M_value_t_we0;
wire   [63:0] ifmap_CF_M_value_t_q0;
wire   [63:0] ifmap_CF_M_value_t_q1;
wire   [63:0] ifmap_CF_M_value_1_i_q0;
wire   [63:0] ifmap_CF_M_value_1_i_q1;
wire   [7:0] ifmap_CF_M_value_1_t_we0;
wire   [63:0] ifmap_CF_M_value_1_t_q0;
wire   [63:0] ifmap_CF_M_value_1_t_q1;
...
wire   [10:0] ifmap_gen_y_U0_ifmap_CF_0_address0;
wire    ifmap_gen_y_U0_ifmap_CF_0_ce0;
wire   [7:0] ifmap_gen_y_U0_ifmap_CF_0_we0;
wire   [63:0] ifmap_gen_y_U0_ifmap_CF_0_d0;
wire   [10:0] ifmap_gen_y_U0_ifmap_CF_1_address0;
wire    ifmap_gen_y_U0_ifmap_CF_1_ce0;
wire   [7:0] ifmap_gen_y_U0_ifmap_CF_1_we0;
wire   [63:0] ifmap_gen_y_U0_ifmap_CF_1_d0;
...
wire    ap_channel_done_ifmap_CF_M_value_1;
wire    ifmap_gen_y_U0_ifmap_CF_1_full_n;
reg    ap_sync_reg_channel_write_ifmap_CF_M_value_1;
wire    ap_sync_channel_write_ifmap_CF_M_value_1;
wire    ap_channel_done_ifmap_CF_M_value;
wire    ifmap_gen_y_U0_ifmap_CF_0_full_n;
reg    ap_sync_reg_channel_write_ifmap_CF_M_value;
wire    ap_sync_channel_write_ifmap_CF_M_value;
...
wire   [10:0] ifmap_vec_write_U0_ifmap_CF_0_address0;
wire    ifmap_vec_write_U0_ifmap_CF_0_ce0;
wire   [10:0] ifmap_vec_write_U0_ifmap_CF_0_address1;
wire    ifmap_vec_write_U0_ifmap_CF_0_ce1;
wire   [10:0] ifmap_vec_write_U0_ifmap_CF_1_address0;
wire    ifmap_vec_write_U0_ifmap_CF_1_ce0;
wire   [10:0] ifmap_vec_write_U0_ifmap_CF_1_address1;
wire    ifmap_vec_write_U0_ifmap_CF_1_ce1;
...
wire   [255:0] ifmap_vec_write_U0_m_axi_gmem_WDATA;
wire   [31:0] ifmap_vec_write_U0_m_axi_gmem_WSTRB;
...
wire    ifmap_CF_M_value_i_full_n;
wire    ifmap_CF_M_value_t_empty_n;
wire    ifmap_CF_M_value_1_i_full_n;
wire    ifmap_CF_M_value_1_t_empty_n;
...
#0 ap_sync_reg_channel_write_ifmap_CF_M_value_1 = 1'b0;
#0 ap_sync_reg_channel_write_ifmap_CF_M_value = 1'b0;
#0 ap_sync_reg_entry_proc_U0_ap_ready = 1'b0;
#0 ap_sync_reg_ifmap_gen_y_U0_ap_ready = 1'b0;
end

fwd_fft_dataflow_in_loop_VITIS_LOOP_469_3_ifmap_CF_M_value #(
    .DataWidth( 64 ),
    .AddressRange( 2048 ),
    .AddressWidth( 11 ))
ifmap_CF_M_value_U(
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_channel_write_ifmap_CF_M_value <= 1'b0;
    end else begin
        if (((ifmap_gen_y_U0_ap_done & ifmap_gen_y_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_ifmap_CF_M_value <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_channel_write_ifmap_CF_M_value_1 <= 1'b0;
    end else begin
        if (((ifmap_gen_y_U0_ap_done & ifmap_gen_y_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_ifmap_CF_M_value_1 <= 1'b0;
        end else begin
...
assign ap_channel_done_ifmap_CF_M_value = (ifmap_gen_y_U0_ap_done & (ap_sync_reg_channel_write_ifmap_CF_M_value ^ 1'b1));

assign ap_channel_done_ifmap_CF_M_value_1 = (ifmap_gen_y_U0_ap_done & (ap_sync_reg_channel_write_ifmap_CF_M_value_1 ^ 1'b1));

assign ap_done = ifmap_vec_write_U0_ap_done;

assign ap_idle = (ifmap_vec_write_U0_ap_idle & ifmap_gen_y_U0_ap_idle & (ctrl1_reg_c_channel1_empty_n ^ 1'b1) & (fft_out_c_channel_empty_n ^ 1'b1) & (ifmap_CF_M_value_1_t_empty_n ^ 1'b1) & (ifmap_CF_M_value_t_empty_n ^ 1'b1) & entry_proc_U0_ap_idle);
...
assign ap_sync_channel_write_ifmap_CF_M_value = ((ifmap_gen_y_U0_ifmap_CF_0_full_n & ap_channel_done_ifmap_CF_M_value) | ap_sync_reg_channel_write_ifmap_CF_M_value);

assign ap_sync_channel_write_ifmap_CF_M_value_1 = ((ifmap_gen_y_U0_ifmap_CF_1_full_n & ap_channel_done_ifmap_CF_M_value_1) | ap_sync_reg_channel_write_ifmap_CF_M_value_1);
...
assign ifmap_CF_M_value_1_t_we0 = 1'b0;

assign ifmap_CF_M_value_t_we0 = 1'b0;

assign ifmap_gen_y_U0_ap_continue = (ap_sync_channel_write_ifmap_CF_M_value_1 & ap_sync_channel_write_ifmap_CF_M_value & ap_sync_channel_write_ctrl1_reg_c_channel1);

assign ifmap_gen_y_U0_ap_start = ((ap_sync_reg_ifmap_gen_y_U0_ap_ready ^ 1'b1) & ap_start);

assign ifmap_gen_y_U0_ifmap_CF_0_full_n = ifmap_CF_M_value_i_full_n;

assign ifmap_gen_y_U0_ifmap_CF_1_full_n = ifmap_CF_M_value_1_i_full_n;

assign ifmap_vec_write_U0_ap_continue = ap_continue;

assign ifmap_vec_write_U0_ap_start = (ifmap_CF_M_value_t_empty_n & ifmap_CF_M_value_1_t_empty_n & fft_out_c_channel_empty_n & ctrl1_reg_c_channel1_empty_n);
...
endmodule //fwd_fft_dataflow_in_loop_VITIS_LOOP_469_3
