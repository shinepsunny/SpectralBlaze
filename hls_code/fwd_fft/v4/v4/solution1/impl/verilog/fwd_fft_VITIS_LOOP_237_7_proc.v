...
module fwd_fft_VITIS_LOOP_237_7_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln208_fu_131_p1;
reg   [7:0] x_fu_46;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_x_15;
wire   [7:0] add_ln237_fu_106_p2;
...
assign add_ln237_fu_106_p2 = (ap_sig_allocacmp_x_15 + 8'd1);
...
assign in_fft_M_imag2_address0 = zext_ln208_fu_131_p1;

assign in_fft_M_imag2_d0 = trunc_ln145_3_reg_164;

assign in_fft_M_real1_address0 = zext_ln208_fu_131_p1;

assign in_fft_M_real1_d0 = trunc_ln145_reg_159;

assign trunc_ln145_fu_112_p1 = c_ifmap_col_op_st_dout[15:0];

assign zext_ln208_fu_131_p1 = x_15_reg_151;

endmodule //fwd_fft_VITIS_LOOP_237_7_proc
