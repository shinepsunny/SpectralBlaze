...
module fwd_fft_fft_stage21_Pipeline_SKIP_X (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
fwd_fft_hadd_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hadd_16ns_16ns_16_2_full_dsp_1_U175(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hadd_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hadd_16ns_16ns_16_2_full_dsp_1_U176(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U178(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hsub_16ns_16ns_16_2_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_2_full_dsp_1_U179(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(t1_M_real_fu_387_p1),
    .din1(p_r_reg_546),
...
fwd_fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U181(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hmul_16ns_16ns_16_2_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_2_max_dsp_1_U182(
    .clk(ap_clk),
    .reset(ap_rst),
...
assign j1_5_fu_296_p3 = ((icmp_ln30_fu_284_p2[0:0] == 1'b1) ? 32'd0 : j1_fu_62);

assign j1_6_fu_312_p3 = ((icmp_ln26_fu_272_p2[0:0] == 1'b1) ? j1_4_fu_278_p2 : j1_5_fu_296_p3);

assign k1_4_fu_219_p2 = (k1_fu_58 + 7'd1);

assign m1_3_fu_304_p3 = ((icmp_ln30_fu_284_p2[0:0] == 1'b1) ? add_ln33_fu_290_p2 : m1_fu_66);

assign m1_4_fu_320_p3 = ((icmp_ln26_fu_272_p2[0:0] == 1'b1) ? m1_fu_66 : m1_3_fu_304_p3);
...
endmodule //fwd_fft_fft_stage21_Pipeline_SKIP_X
