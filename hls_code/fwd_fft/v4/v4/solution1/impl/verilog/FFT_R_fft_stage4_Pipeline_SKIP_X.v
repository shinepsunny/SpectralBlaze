...
module FFT_R_fft_stage4_Pipeline_SKIP_X (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign icmp_ln1057_fu_167_p2 = ((ap_sig_allocacmp_k1_11 == div_i_i43_cast) ? 1'b1 : 1'b0);
...
endmodule //FFT_R_fft_stage4_Pipeline_SKIP_X
