...
module FFT_R_dataflow_in_loop_VITIS_LOOP_72_1_out_data_12
#(parameter
    DataWidth    = 32,
    AddressRange = 32,
    AddressWidth = 6,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        FFT_R_dataflow_in_loop_VITIS_LOOP_72_1_out_data_12_memcore FFT_R_dataflow_in_loop_VITIS_LOOP_72_1_out_data_12_memcore_U (
            .clk      ( clk ),
            .reset    ( reset ),
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
