...
entity Mem_patch_Wr_dataflow_parent_loop_proc5 is
port (
...
architecture behav of Mem_patch_Wr_dataflow_parent_loop_proc5 is 
...
attribute shreg_extract : string;
    signal dataflow_parent_loop_proc_U0_c_fft_col_op_st_V_read : STD_LOGIC;
    signal dataflow_parent_loop_proc_U0_fft_out : STD_LOGIC_VECTOR (127 downto 0);
    signal dataflow_parent_loop_proc_U0_fft_out_ap_vld : STD_LOGIC;
    ...
    component Mem_patch_Wr_dataflow_parent_loop_proc IS
    port (
        ctrl2_reg_load_cast : IN STD_LOGIC_VECTOR (7 downto 0);
        c_fft_col_op_st_V_dout : IN STD_LOGIC_VECTOR (31 downto 0);
        c_fft_col_op_st_V_empty_n : IN STD_LOGIC;
...
begin
    dataflow_parent_loop_proc_U0 : component Mem_patch_Wr_dataflow_parent_loop_proc
    port map (
