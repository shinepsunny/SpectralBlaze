...
entity fwd_fft_Col_Wise_Overlap_Gen_Pipeline_VITIS_LOOP_263_1_VITIS_LOOP_269_3_VITIS_LOOP_272_4_VITIS_LOOP_275_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_Col_Wise_Overlap_Gen_Pipeline_VITIS_LOOP_263_1_VITIS_LOOP_269_3_VITIS_LOOP_272_4_VITIS_LOOP_275_5 is 
...
attribute shreg_extract : string;
    ...
    signal or_ln290_reg_720 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_predicate_op112_write_state4 : BOOLEAN;
    signal select_ln261_8_reg_712 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal select_ln261_3_fu_301_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln261_3_reg_690 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln261_1_fu_308_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln261_1_reg_697 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln261_7_fu_314_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln261_7_reg_703 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln261_8_fu_483_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln1057_20_fu_537_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln290_fu_547_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter2_stage0 : STD_LOGIC;
    signal x_fu_100 : STD_LOGIC_VECTOR (7 downto 0);
    signal x_14_fu_553_p2 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal select_ln261_2_fu_289_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal or_ln261_fu_425_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln261_fu_430_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln261_1_fu_441_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln261_4_fu_447_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal pnx_8_fu_471_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal cmp_mid1_fu_477_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln261_2_fu_454_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal pnx_cast_mid1_fu_490_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal cmp_i_i_mid1_fu_494_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln261_5_fu_459_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln261_6_fu_465_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln261_10_fu_506_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln261_3_fu_519_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln261_4_fu_524_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln261_11_fu_529_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal select_ln261_9_fu_499_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln290_fu_542_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1057_15_fu_259_p2 = ap_const_lv1_0))) then
                ...
                or_ln261_1_reg_697 <= or_ln261_1_fu_308_p2;
                select_ln261_3_reg_690 <= select_ln261_3_fu_301_p3;
                select_ln261_7_reg_703 <= select_ln261_7_fu_314_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln1057_15_reg_679 = ap_const_lv1_0))) then
                ...
                select_ln261_8_reg_712 <= select_ln261_8_fu_483_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln1057_20_fu_537_p2 = ap_const_lv1_0) and (icmp_ln1057_15_reg_679 = ap_const_lv1_0))) then
                or_ln290_reg_720 <= or_ln290_fu_547_p2;
            end if;
        end if;
    end process;
    ...
    ap_predicate_op112_write_state4_assign_proc : process(icmp_ln1057_20_reg_716, or_ln290_reg_720)
    begin
                ap_predicate_op112_write_state4 <= ((or_ln290_reg_720 = ap_const_lv1_0) and (icmp_ln1057_20_reg_716 = ap_const_lv1_0));
    end process;


    ap_predicate_op114_read_state4_assign_proc : process(icmp_ln1057_20_reg_716, select_ln261_8_reg_712)
    begin
                ap_predicate_op114_read_state4 <= ((select_ln261_8_reg_712 = ap_const_lv1_0) and (icmp_ln1057_20_reg_716 = ap_const_lv1_1));
    end process;


    ap_predicate_op115_write_state4_assign_proc : process(icmp_ln1057_20_reg_716, select_ln261_8_reg_712)
    begin
                ap_predicate_op115_write_state4 <= ((select_ln261_8_reg_712 = ap_const_lv1_0) and (icmp_ln1057_20_reg_716 = ap_const_lv1_1));
    end process;


    ap_predicate_op117_write_state4_assign_proc : process(icmp_ln1057_20_reg_716, select_ln261_8_reg_712)
    begin
                ap_predicate_op117_write_state4 <= ((select_ln261_8_reg_712 = ap_const_lv1_1) and (icmp_ln1057_20_reg_716 = ap_const_lv1_1));
    end process;
    ...
    icmp_ln1057_20_fu_537_p2 <= "1" when (unsigned(select_ln261_11_fu_529_p3) < unsigned(trunc_ln40)) else "0";
    icmp_ln290_fu_542_p2 <= "1" when (unsigned(select_ln261_11_fu_529_p3) < unsigned(p_cast1)) else "0";
    or_ln1057_1_fu_342_p2 <= (or_ln1057_fu_336_p2 or icmp_ln1057_16_fu_279_p2);
    or_ln1057_fu_336_p2 <= (select_ln261_7_fu_314_p3 or select_ln261_3_fu_301_p3);
    or_ln261_1_fu_308_p2 <= (select_ln261_3_fu_301_p3 or icmp_ln1057_16_fu_279_p2);
    or_ln261_2_fu_454_p2 <= (select_ln261_3_reg_690 or or_ln261_fu_425_p2);
    or_ln261_3_fu_519_p2 <= (select_ln261_7_reg_703 or select_ln261_10_fu_506_p3);
    or_ln261_4_fu_524_p2 <= (or_ln261_3_fu_519_p2 or or_ln261_1_reg_697);
    or_ln261_fu_425_p2 <= (icmp_ln1057_16_reg_683 or cmp_fu_407_p2);
    or_ln290_fu_547_p2 <= (select_ln261_9_fu_499_p3 or icmp_ln290_fu_542_p2);
    pnx_8_fu_471_p2 <= std_logic_vector(unsigned(select_ln261_4_fu_447_p3) + unsigned(ap_const_lv8_1));
    ...
    select_ln1057_8_fu_362_p3 <= 
        ap_const_lv24_1 when (or_ln261_1_fu_308_p2(0) = '1') else 
    ...
    select_ln1057_fu_512_p3 <= 
        pnx_8_fu_471_p2 when (select_ln261_7_reg_703(0) = '1') else 
        select_ln261_4_fu_447_p3;
    select_ln261_10_fu_506_p3 <= 
        icmp_ln1057 when (select_ln261_7_reg_703(0) = '1') else 
        select_ln261_6_fu_465_p3;
    select_ln261_11_fu_529_p3 <= 
        ap_const_lv8_0 when (or_ln261_4_fu_524_p2(0) = '1') else 
        x_fu_100;
    select_ln261_1_fu_441_p3 <= 
        icmp_ln1057 when (icmp_ln1057_16_reg_683(0) = '1') else 
        icmp_ln1057_17_fu_436_p2;
    select_ln261_2_fu_289_p3 <= 
        icmp_ln1057_21 when (icmp_ln1057_16_fu_279_p2(0) = '1') else 
        icmp_ln1057_18_fu_284_p2;
    select_ln261_3_fu_301_p3 <= 
        icmp_ln1057_22 when (icmp_ln1057_16_fu_279_p2(0) = '1') else 
        icmp_ln1057_19_fu_296_p2;
    select_ln261_4_fu_447_p3 <= 
        ap_const_lv8_0 when (or_ln261_1_reg_697(0) = '1') else 
        pnx_fu_108;
    select_ln261_5_fu_459_p3 <= 
        cmp_i_i_mid157 when (select_ln261_3_reg_690(0) = '1') else 
        select_ln261_fu_430_p3;
    select_ln261_6_fu_465_p3 <= 
        icmp_ln1057 when (select_ln261_3_reg_690(0) = '1') else 
        select_ln261_1_fu_441_p3;
    select_ln261_7_fu_314_p3 <= 
        icmp_ln1057_21 when (select_ln261_3_fu_301_p3(0) = '1') else 
        select_ln261_2_fu_289_p3;
    select_ln261_8_fu_483_p3 <= 
        cmp_mid1_fu_477_p2 when (select_ln261_7_reg_703(0) = '1') else 
        or_ln261_2_fu_454_p2;
    select_ln261_9_fu_499_p3 <= 
        cmp_i_i_mid1_fu_494_p2 when (select_ln261_7_reg_703(0) = '1') else 
        select_ln261_5_fu_459_p3;
    select_ln261_fu_430_p3 <= 
        cmp_i_i_mid157 when (icmp_ln1057_16_reg_683(0) = '1') else 
        cmp_i_i_fu_417_p2;
    x_14_fu_553_p2 <= std_logic_vector(unsigned(select_ln261_11_fu_529_p3) + unsigned(ap_const_lv8_1));
end behav;
