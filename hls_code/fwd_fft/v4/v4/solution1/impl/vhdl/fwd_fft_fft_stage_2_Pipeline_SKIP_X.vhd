...
entity fwd_fft_fft_stage_2_Pipeline_SKIP_X is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_fft_stage_2_Pipeline_SKIP_X is 
...
attribute shreg_extract : string;
    ...
    signal p_r_M_imag_10_reg_467 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal k1_6_fu_204_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal j1_fu_58 : STD_LOGIC_VECTOR (31 downto 0);
    signal j1_3_fu_281_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal m1_fu_62 : STD_LOGIC_VECTOR (31 downto 0);
    signal m1_2_fu_289_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_171_p0 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_fu_176_p0 : STD_LOGIC_VECTOR (15 downto 0);
    signal trunc_ln1057_1_fu_220_p1 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal j1_1_fu_247_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal j1_2_fu_265_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal m1_1_fu_273_p3 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    hadd_16ns_16ns_16_5_full_dsp_1_U345 : component fwd_fft_hadd_16ns_16ns_16_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 16,
    ...
    hadd_16ns_16ns_16_5_full_dsp_1_U346 : component fwd_fft_hadd_16ns_16ns_16_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 16,
    ...
    hadd_16ns_16ns_16_5_full_dsp_1_U347 : component fwd_fft_hadd_16ns_16ns_16_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 16,
    ...
    hsub_16ns_16ns_16_5_full_dsp_1_U348 : component fwd_fft_hsub_16ns_16ns_16_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 16,
    ...
    hsub_16ns_16ns_16_5_full_dsp_1_U349 : component fwd_fft_hsub_16ns_16ns_16_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 16,
    ...
    hsub_16ns_16ns_16_5_full_dsp_1_U350 : component fwd_fft_hsub_16ns_16ns_16_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_4_max_dsp_1_U351 : component fwd_fft_hmul_16ns_16ns_16_4_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_4_max_dsp_1_U352 : component fwd_fft_hmul_16ns_16ns_16_4_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 16,
    ...
    add_ln19_fu_224_p2 <= std_logic_vector(unsigned(trunc_ln1057_1_fu_220_p1) + unsigned(trunc_ln1057_fu_216_p1));
    ...
    icmp_ln1057_fu_199_p2 <= "1" when (k1_fu_54 = trunc_ln10) else "0";
    ...
    j1_1_fu_247_p2 <= std_logic_vector(unsigned(j1_fu_58) + unsigned(ap_const_lv32_1));
    j1_2_fu_265_p3 <= 
        ap_const_lv32_0 when (icmp_ln27_fu_253_p2(0) = '1') else 
        j1_fu_58;
    j1_3_fu_281_p3 <= 
        j1_1_fu_247_p2 when (icmp_ln23_fu_241_p2(0) = '1') else 
        j1_2_fu_265_p3;
    k1_6_fu_204_p2 <= std_logic_vector(unsigned(k1_fu_54) + unsigned(ap_const_lv7_1));
    m1_1_fu_273_p3 <= 
    ...
    trunc_ln1057_1_fu_220_p1 <= j1_fu_58(6 - 1 downto 0);
