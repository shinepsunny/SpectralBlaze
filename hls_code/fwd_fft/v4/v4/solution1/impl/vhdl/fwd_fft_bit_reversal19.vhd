...
entity fwd_fft_bit_reversal19 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_bit_reversal19 is 
...
attribute shreg_extract : string;
    ...
    signal x_13_reg_194 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal ap_sig_allocacmp_x_13 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                x_13_reg_194 <= ap_sig_allocacmp_x_13;
            end if;
        end if;
    end process;
    ...
    add_ln55_fu_119_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_x_13) + unsigned(ap_const_lv8_1));
    ...
    ap_sig_allocacmp_x_13_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, x_fu_54, ap_loop_init, ap_start_int)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_x_13 <= ap_const_lv8_0;
        else 
            ap_sig_allocacmp_x_13 <= x_fu_54;
        end if; 
    end process;

    empty_fu_91_p1 <= p_read(8 - 1 downto 0);
    icmp_ln1057_fu_113_p2 <= "1" when (ap_sig_allocacmp_x_13 = empty_fu_91_p1) else "0";
    ...
    sub_ln674_1_fu_141_p2 <= std_logic_vector(signed(ap_const_lv3_6) - signed(p_cast_cast_cast_fu_95_p4));
    sub_ln674_fu_135_p2 <= std_logic_vector(signed(ap_const_lv3_6) - signed(p_cast_cast_cast_fu_95_p4));
    
    tmp_fu_125_p4_proc : process(ap_sig_allocacmp_x_13)
    ...
    begin
        ...
        if (vlo_cpy(3 - 1 downto 0) > vhi_cpy(3 - 1 downto 0)) then
            ...
            for tmp_fu_125_p4_i in 0 to 8-1 loop
                v0_cpy(tmp_fu_125_p4_i) := ap_sig_allocacmp_x_13(8-1-tmp_fu_125_p4_i);
            end loop;
        end if;
    ...
    zext_ln1057_fu_183_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(x_13_reg_194),64));
