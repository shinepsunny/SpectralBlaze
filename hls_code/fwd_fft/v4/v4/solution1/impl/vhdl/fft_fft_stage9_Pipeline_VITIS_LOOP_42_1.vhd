...
entity fft_fft_stage9_Pipeline_VITIS_LOOP_42_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_fft_stage9_Pipeline_VITIS_LOOP_42_1 is 
...
begin
    ...
    add_ln42_fu_142_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_x_1) + unsigned(ap_const_lv7_2));
