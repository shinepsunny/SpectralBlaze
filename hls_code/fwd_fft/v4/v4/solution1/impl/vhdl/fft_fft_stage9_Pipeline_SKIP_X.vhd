...
entity fft_fft_stage9_Pipeline_SKIP_X is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_fft_stage9_Pipeline_SKIP_X is 
...
attribute shreg_extract : string;
    ...
    signal p_r_M_real_5_reg_572 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_fu_162_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal p_r_M_imag_6_reg_577 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_fu_170_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal p_r_M_real_6_reg_582 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_fu_174_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal p_r_M_imag_7_reg_587 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal bitcast_ln176_1_fu_417_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal bitcast_ln173_1_fu_414_p1 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    w_M_real_U : component fft_fft_stage6_Pipeline_SKIP_X_w_M_real16
    generic map (
        DataWidth => 16,
        AddressRange => 192,
        AddressWidth => 8)
    ...
    w_M_imag_U : component fft_fft_stage6_Pipeline_SKIP_X_w_M_imag12
    generic map (
        DataWidth => 16,
        AddressRange => 192,
        AddressWidth => 8)
    ...
    hadd_16ns_16ns_16_2_full_dsp_1_U80 : component fft_hadd_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hadd_16ns_16ns_16_2_full_dsp_1_U81 : component fft_hadd_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hadd_16ns_16ns_16_2_full_dsp_1_U82 : component fft_hadd_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hsub_16ns_16ns_16_2_full_dsp_1_U83 : component fft_hsub_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hsub_16ns_16ns_16_2_full_dsp_1_U84 : component fft_hsub_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hsub_16ns_16ns_16_2_full_dsp_1_U85 : component fft_hsub_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_2_max_dsp_1_U86 : component fft_hmul_16ns_16ns_16_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_2_max_dsp_1_U87 : component fft_hmul_16ns_16ns_16_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_2_max_dsp_1_U88 : component fft_hmul_16ns_16ns_16_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_2_max_dsp_1_U89 : component fft_hmul_16ns_16ns_16_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                ...
                p_r_M_imag_6_reg_577 <= grp_fu_162_p2;
                p_r_M_imag_7_reg_587 <= grp_fu_174_p2;
                p_r_M_real_5_reg_572 <= grp_fu_158_p2;
                p_r_M_real_6_reg_582 <= grp_fu_170_p2;
    ...
    OUT_r_d0 <= (bitcast_ln176_1_fu_417_p1 & bitcast_ln173_1_fu_414_p1);
    ...
    add_ln21_fu_257_p2 <= std_logic_vector(unsigned(trunc_ln1057_1_fu_237_p1) + unsigned(trunc_ln1057_fu_233_p1));
    add_ln22_fu_263_p2 <= std_logic_vector(unsigned(add_ln21_fu_257_p2) + unsigned(ap_const_lv6_10));
    add_ln36_fu_292_p2 <= std_logic_vector(unsigned(m1_fu_68) + unsigned(ap_const_lv32_20));
    ...
    bitcast_ln173_1_fu_414_p1 <= p_r_M_real_6_reg_582;
    bitcast_ln173_fu_399_p1 <= p_r_M_real_5_reg_572;
    bitcast_ln176_1_fu_417_p1 <= p_r_M_imag_7_reg_587;
    bitcast_ln176_fu_402_p1 <= p_r_M_imag_6_reg_577;
    icmp_ln1057_fu_216_p2 <= "1" when (k1_fu_60 = trunc_ln1) else "0";
    icmp_ln29_fu_274_p2 <= "1" when (unsigned(j1_fu_64) < unsigned(ap_const_lv32_F)) else "0";
    icmp_ln33_fu_286_p2 <= "1" when (j1_fu_64 = ap_const_lv32_F) else "0";
    ...
    j1_2_fu_298_p3 <= 
        ...
        j1_fu_64;
    j1_3_fu_314_p3 <= 
        j1_1_fu_280_p2 when (icmp_ln29_fu_274_p2(0) = '1') else 
        j1_2_fu_298_p3;
    ...
    w_M_imag_address0 <= zext_ln20_fu_251_p1(8 - 1 downto 0);
    ...
    w_M_real_address0 <= zext_ln20_fu_251_p1(8 - 1 downto 0);
