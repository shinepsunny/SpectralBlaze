...
entity fwd_fft_compute_fft_write_Pipeline_VITIS_LOOP_228_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_compute_fft_write_Pipeline_VITIS_LOOP_228_3 is 
...
attribute shreg_extract : string;
    ...
    signal trunc_ln232_fu_102_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln232_reg_150 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln232_1_reg_155 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal add_ln228_fu_91_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                trunc_ln232_1_reg_155 <= out_fft_dout(63 downto 32);
                trunc_ln232_reg_150 <= trunc_ln232_fu_102_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln228_fu_91_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_y) + unsigned(ap_const_lv8_1));
    ...
    grp_fu_71_p0 <= trunc_ln232_reg_150;
    ...
    grp_fu_74_p0 <= trunc_ln232_1_reg_155;
    ...
    trunc_ln232_fu_102_p1 <= out_fft_dout(32 - 1 downto 0);
end behav;
