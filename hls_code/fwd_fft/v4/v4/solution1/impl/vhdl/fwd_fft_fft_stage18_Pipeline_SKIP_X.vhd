...
entity fwd_fft_fft_stage18_Pipeline_SKIP_X is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_fft_stage18_Pipeline_SKIP_X is 
...
attribute shreg_extract : string;
    ...
    signal w_M_real30_address0 : STD_LOGIC_VECTOR (7 downto 0);
    signal w_M_real30_ce0 : STD_LOGIC;
    signal w_M_real30_q0 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    w_M_real30_U : component fwd_fft_fft_stage17_Pipeline_SKIP_X_w_M_real31
    generic map (
        DataWidth => 16,
        AddressRange => 192,
        AddressWidth => 8)
    port map (
        clk => ap_clk,
        reset => ap_rst,
        address0 => w_M_real30_address0,
        ce0 => w_M_real30_ce0,
        q0 => w_M_real30_q0);

    w_M_imag24_U : component fwd_fft_fft_stage17_Pipeline_SKIP_X_w_M_imag25
    generic map (
        DataWidth => 16,
        AddressRange => 192,
        AddressWidth => 8)
    ...
    hadd_16ns_16ns_16_2_full_dsp_1_U118 : component fwd_fft_hadd_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hadd_16ns_16ns_16_2_full_dsp_1_U119 : component fwd_fft_hadd_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hsub_16ns_16ns_16_2_full_dsp_1_U121 : component fwd_fft_hsub_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hsub_16ns_16ns_16_2_full_dsp_1_U122 : component fwd_fft_hsub_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_2_max_dsp_1_U124 : component fwd_fft_hmul_16ns_16ns_16_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_2_max_dsp_1_U125 : component fwd_fft_hmul_16ns_16ns_16_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    add_ln21_fu_257_p2 <= std_logic_vector(unsigned(trunc_ln1057_5_fu_237_p1) + unsigned(trunc_ln1057_fu_233_p1));
    ...
    j1_14_fu_298_p3 <= 
        ...
        j1_fu_64;
    j1_15_fu_314_p3 <= 
        j1_13_fu_280_p2 when (icmp_ln26_fu_274_p2(0) = '1') else 
        j1_14_fu_298_p3;
    ...
    w_M_imag24_address0 <= zext_ln20_fu_251_p1(8 - 1 downto 0);
    ...
    w_M_real30_address0 <= zext_ln20_fu_251_p1(8 - 1 downto 0);

    w_M_real30_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            w_M_real30_ce0 <= ap_const_logic_1;
        else 
            w_M_real30_ce0 <= ap_const_logic_0;
        end if; 
    end process;
