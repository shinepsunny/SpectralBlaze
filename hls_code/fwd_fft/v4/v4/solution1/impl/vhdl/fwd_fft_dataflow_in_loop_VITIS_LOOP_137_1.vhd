...
entity fwd_fft_dataflow_in_loop_VITIS_LOOP_137_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_dataflow_in_loop_VITIS_LOOP_137_1 is 
...
attribute shreg_extract : string;
    ...
    signal stream_2_buf_U0_c_row_op_trans_st_read : STD_LOGIC;
    ...
    signal stream_2_buf_U0_input_buffer_d0 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal bit_reversal_U0_ap_start : STD_LOGIC;
    signal bit_reversal_U0_ap_done : STD_LOGIC;
    signal bit_reversal_U0_ap_continue : STD_LOGIC;
    signal bit_reversal_U0_ap_idle : STD_LOGIC;
    signal bit_reversal_U0_ap_ready : STD_LOGIC;
    signal bit_reversal_U0_IN_r_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal bit_reversal_U0_IN_r_ce0 : STD_LOGIC;
    signal bit_reversal_U0_OUT_r_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal bit_reversal_U0_OUT_r_ce0 : STD_LOGIC;
    signal bit_reversal_U0_OUT_r_we0 : STD_LOGIC;
    signal bit_reversal_U0_OUT_r_d0 : STD_LOGIC_VECTOR (63 downto 0);
    signal bit_reversal_U0_ap_return : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal bit_reversal_U0_OUT_r_full_n : STD_LOGIC;
    ...
    signal fft_stage_0_0_U0_OUT_r_d0 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal fft_stage_0_0_U0_OUT_r_d1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal fft_stage_1_0_U0_OUT_r_d0 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal fft_stage_1_0_U0_OUT_r_d1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal fft_stage_2_0_U0_OUT_r_d0 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal fft_stage_2_0_U0_OUT_r_d1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal fft_stage_3_0_U0_OUT_r_d0 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal fft_stage_3_0_U0_OUT_r_d1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal fft_stage_4_0_U0_OUT_r_d0 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal fft_stage_4_0_U0_OUT_r_d1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal fft_stage_5_0_U0_OUT_r_d0 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal fft_stage_5_0_U0_OUT_r_d1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal buf_2_stream_U0_c_fft_col_op_st_din : STD_LOGIC_VECTOR (63 downto 0);
    signal buf_2_stream_U0_c_fft_col_op_st_write : STD_LOGIC;
    ...
    component fwd_fft_bit_reversal IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component fwd_fft_fifo_w8_d2_S_x0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    bit_reversal_U0 : component fwd_fft_bit_reversal
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage_0_0_U0 : component fwd_fft_fft_stage_0_0
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage_1_0_U0 : component fwd_fft_fft_stage_1_0
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage_2_0_U0 : component fwd_fft_fft_stage_2_0
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage_3_0_U0 : component fwd_fft_fft_stage_3_0
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage_4_0_U0 : component fwd_fft_fft_stage_4_0
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage_5_0_U0 : component fwd_fft_fft_stage_5_0
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    ctrl1_reg_c7_channel_U : component fwd_fft_fifo_w32_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    ctrl1_reg_c6_channel_U : component fwd_fft_fifo_w32_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ctrl1_reg_c5_channel_U : component fwd_fft_fifo_w32_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ctrl1_reg_c4_channel_U : component fwd_fft_fifo_w32_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ctrl1_reg_c3_channel_U : component fwd_fft_fifo_w16_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ctrl1_reg_c2_channel_U : component fwd_fft_fifo_w16_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ctrl1_reg_c1_channel_U : component fwd_fft_fifo_w16_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ctrl1_reg_c_channel_U : component fwd_fft_fifo_w8_d2_S_x0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((bit_reversal_U0_ap_done and bit_reversal_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_ctrl1_reg_c6_channel <= ap_const_logic_0;
                else 
    ...
    ap_channel_done_ctrl1_reg_c6_channel <= ((ap_sync_reg_channel_write_ctrl1_reg_c6_channel xor ap_const_logic_1) and bit_reversal_U0_ap_done);
    ap_channel_done_ctrl1_reg_c7_channel <= (stream_2_buf_U0_ap_done and (ap_sync_reg_channel_write_ctrl1_reg_c7_channel xor ap_const_logic_1));
    ...
    ap_channel_done_input_data_rev2 <= ((ap_sync_reg_channel_write_input_data_rev2 xor ap_const_logic_1) and bit_reversal_U0_ap_done);
    ap_channel_done_out_data_13 <= (fft_stage_0_0_U0_ap_done and (ap_sync_reg_channel_write_out_data_13 xor ap_const_logic_1));
    ap_channel_done_out_data_24 <= (fft_stage_1_0_U0_ap_done and (ap_sync_reg_channel_write_out_data_24 xor ap_const_logic_1));
    ap_channel_done_out_data_35 <= (fft_stage_2_0_U0_ap_done and (ap_sync_reg_channel_write_out_data_35 xor ap_const_logic_1));
    ap_channel_done_out_data_46 <= (fft_stage_3_0_U0_ap_done and (ap_sync_reg_channel_write_out_data_46 xor ap_const_logic_1));
    ap_channel_done_out_data_57 <= (fft_stage_4_0_U0_ap_done and (ap_sync_reg_channel_write_out_data_57 xor ap_const_logic_1));
    ap_channel_done_out_data_68 <= (fft_stage_5_0_U0_ap_done and (ap_sync_reg_channel_write_out_data_68 xor ap_const_logic_1));
    ap_done <= buf_2_stream_U0_ap_done;
    ap_idle <= (stream_2_buf_U0_ap_idle and fft_stage_5_0_U0_ap_idle and fft_stage_4_0_U0_ap_idle and fft_stage_3_0_U0_ap_idle and fft_stage_2_0_U0_ap_idle and fft_stage_1_0_U0_ap_idle and fft_stage_0_0_U0_ap_idle and (ctrl1_reg_c_channel_empty_n xor ap_const_logic_1) and (ctrl1_reg_c1_channel_empty_n xor ap_const_logic_1) and (ctrl1_reg_c2_channel_empty_n xor ap_const_logic_1) and (ctrl1_reg_c3_channel_empty_n xor ap_const_logic_1) and (ctrl1_reg_c4_channel_empty_n xor ap_const_logic_1) and (ctrl1_reg_c5_channel_empty_n xor ap_const_logic_1) and (ctrl1_reg_c6_channel_empty_n xor ap_const_logic_1) and (ctrl1_reg_c7_channel_empty_n xor ap_const_logic_1) and (out_data_68_t_empty_n xor ap_const_logic_1) and (out_data_57_t_empty_n xor ap_const_logic_1) and (out_data_46_t_empty_n xor ap_const_logic_1) and (out_data_35_t_empty_n xor ap_const_logic_1) and (out_data_24_t_empty_n xor ap_const_logic_1) and (out_data_13_t_empty_n xor ap_const_logic_1) and (input_data_rev2_t_empty_n xor ap_const_logic_1) and (input_data1_t_empty_n xor ap_const_logic_1) and buf_2_stream_U0_ap_idle and bit_reversal_U0_ap_idle);
    ap_ready <= stream_2_buf_U0_ap_ready;
    ...
    ap_sync_channel_write_input_data_rev2 <= ((bit_reversal_U0_OUT_r_full_n and ap_channel_done_input_data_rev2) or ap_sync_reg_channel_write_input_data_rev2);
    ap_sync_channel_write_out_data_13 <= ((fft_stage_0_0_U0_OUT_r_full_n and ap_channel_done_out_data_13) or ap_sync_reg_channel_write_out_data_13);
    ap_sync_channel_write_out_data_24 <= ((fft_stage_1_0_U0_OUT_r_full_n and ap_channel_done_out_data_24) or ap_sync_reg_channel_write_out_data_24);
    ap_sync_channel_write_out_data_35 <= ((fft_stage_2_0_U0_OUT_r_full_n and ap_channel_done_out_data_35) or ap_sync_reg_channel_write_out_data_35);
    ap_sync_channel_write_out_data_46 <= ((fft_stage_3_0_U0_OUT_r_full_n and ap_channel_done_out_data_46) or ap_sync_reg_channel_write_out_data_46);
    ap_sync_channel_write_out_data_57 <= ((fft_stage_4_0_U0_OUT_r_full_n and ap_channel_done_out_data_57) or ap_sync_reg_channel_write_out_data_57);
    ap_sync_channel_write_out_data_68 <= ((fft_stage_5_0_U0_OUT_r_full_n and ap_channel_done_out_data_68) or ap_sync_reg_channel_write_out_data_68);
    bit_reversal_U0_OUT_r_full_n <= input_data_rev2_i_full_n;
    bit_reversal_U0_ap_continue <= (ap_sync_channel_write_input_data_rev2 and ap_sync_channel_write_ctrl1_reg_c6_channel);
    bit_reversal_U0_ap_start <= (input_data1_t_empty_n and ctrl1_reg_c7_channel_empty_n);
    buf_2_stream_U0_ap_continue <= ap_continue;
    buf_2_stream_U0_ap_start <= (out_data_68_t_empty_n and ctrl1_reg_c_channel_empty_n);
    c_fft_col_op_st_din <= buf_2_stream_U0_c_fft_col_op_st_din;
    c_fft_col_op_st_write <= buf_2_stream_U0_c_fft_col_op_st_write;
    c_row_op_trans_st_read <= stream_2_buf_U0_c_row_op_trans_st_read;
    fft_stage_0_0_U0_OUT_r_full_n <= out_data_13_i_full_n;
    fft_stage_0_0_U0_ap_continue <= (ap_sync_channel_write_out_data_13 and ap_sync_channel_write_ctrl1_reg_c5_channel);
    fft_stage_0_0_U0_ap_start <= (input_data_rev2_t_empty_n and ctrl1_reg_c6_channel_empty_n);
    fft_stage_1_0_U0_OUT_r_full_n <= out_data_24_i_full_n;
    fft_stage_1_0_U0_ap_continue <= (ap_sync_channel_write_out_data_24 and ap_sync_channel_write_ctrl1_reg_c4_channel);
    fft_stage_1_0_U0_ap_start <= (out_data_13_t_empty_n and ctrl1_reg_c5_channel_empty_n);
    fft_stage_2_0_U0_OUT_r_full_n <= out_data_35_i_full_n;
    fft_stage_2_0_U0_ap_continue <= (ap_sync_channel_write_out_data_35 and ap_sync_channel_write_ctrl1_reg_c3_channel);
    fft_stage_2_0_U0_ap_start <= (out_data_24_t_empty_n and ctrl1_reg_c4_channel_empty_n);
    fft_stage_3_0_U0_OUT_r_full_n <= out_data_46_i_full_n;
    fft_stage_3_0_U0_ap_continue <= (ap_sync_channel_write_out_data_46 and ap_sync_channel_write_ctrl1_reg_c2_channel);
    fft_stage_3_0_U0_ap_start <= (out_data_35_t_empty_n and ctrl1_reg_c3_channel_empty_n);
    fft_stage_4_0_U0_OUT_r_full_n <= out_data_57_i_full_n;
    fft_stage_4_0_U0_ap_continue <= (ap_sync_channel_write_out_data_57 and ap_sync_channel_write_ctrl1_reg_c1_channel);
    fft_stage_4_0_U0_ap_start <= (out_data_46_t_empty_n and ctrl1_reg_c2_channel_empty_n);
    fft_stage_5_0_U0_OUT_r_full_n <= out_data_68_i_full_n;
    fft_stage_5_0_U0_ap_continue <= (ap_sync_channel_write_out_data_68 and ap_sync_channel_write_ctrl1_reg_c_channel);
    fft_stage_5_0_U0_ap_start <= (out_data_57_t_empty_n and ctrl1_reg_c1_channel_empty_n);
    stream_2_buf_U0_ap_continue <= (ap_sync_channel_write_input_data1 and ap_sync_channel_write_ctrl1_reg_c7_channel);
