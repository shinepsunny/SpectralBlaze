...
architecture behav of fwd_fft is 
    ...
    "fwd_fft_fwd_fft,hls_ip_2021_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu7cg-fbvb900-1-i,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.536000,HLS_SYN_LAT=27551,HLS_SYN_TPT=27526,HLS_SYN_MEM=105,HLS_SYN_DSP=0,HLS_SYN_FF=9561,HLS_SYN_LUT=15067,HLS_VERSION=2021_1}";
    ...
    signal entry_proc13_U0_ap_return : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal Mem_Patch_Gen_U0_ctrl1_reg_c15_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Mem_Patch_Gen_U0_ctrl1_reg_c15_write : STD_LOGIC;
    signal Mem_Patch_Gen_U0_ctrl2_reg_c18_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Mem_Patch_Gen_U0_ctrl2_reg_c18_write : STD_LOGIC;
    signal Mem_Patch_Gen_U0_layer1_reg_c21_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Mem_Patch_Gen_U0_layer1_reg_c21_write : STD_LOGIC;
    ...
    signal Col_Wise_Overlap_Gen_U0_ctrl1_reg_c14_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Col_Wise_Overlap_Gen_U0_ctrl1_reg_c14_write : STD_LOGIC;
    signal Col_Wise_Overlap_Gen_U0_ctrl2_reg_c17_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Col_Wise_Overlap_Gen_U0_ctrl2_reg_c17_write : STD_LOGIC;
    signal Col_Wise_Overlap_Gen_U0_layer1_reg_c20_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Col_Wise_Overlap_Gen_U0_layer1_reg_c20_write : STD_LOGIC;
    signal Row_Wise_FFT_U0_ap_start : STD_LOGIC;
    signal Row_Wise_FFT_U0_ap_done : STD_LOGIC;
    signal Row_Wise_FFT_U0_ap_continue : STD_LOGIC;
    signal Row_Wise_FFT_U0_ap_idle : STD_LOGIC;
    signal Row_Wise_FFT_U0_ap_ready : STD_LOGIC;
    signal Row_Wise_FFT_U0_start_out : STD_LOGIC;
    signal Row_Wise_FFT_U0_start_write : STD_LOGIC;
    signal Row_Wise_FFT_U0_c_ifmap_col_op_st_read : STD_LOGIC;
    signal Row_Wise_FFT_U0_c_fft_row_op_st_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Row_Wise_FFT_U0_c_fft_row_op_st_write : STD_LOGIC;
    signal Row_Wise_FFT_U0_ctrl1_reg_read : STD_LOGIC;
    signal Row_Wise_FFT_U0_ctrl2_reg_read : STD_LOGIC;
    signal Row_Wise_FFT_U0_layer1_reg_read : STD_LOGIC;
    signal Row_Wise_FFT_U0_ctrl1_reg_c13_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Row_Wise_FFT_U0_ctrl1_reg_c13_write : STD_LOGIC;
    signal Row_Wise_FFT_U0_ctrl2_reg_c16_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Row_Wise_FFT_U0_ctrl2_reg_c16_write : STD_LOGIC;
    signal Row_Wise_FFT_U0_layer1_reg_c19_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Row_Wise_FFT_U0_layer1_reg_c19_write : STD_LOGIC;
    signal Col_Wise_FFT_U0_ap_start : STD_LOGIC;
    signal Col_Wise_FFT_U0_ap_done : STD_LOGIC;
    signal Col_Wise_FFT_U0_ap_continue : STD_LOGIC;
    signal Col_Wise_FFT_U0_ap_idle : STD_LOGIC;
    signal Col_Wise_FFT_U0_ap_ready : STD_LOGIC;
    signal Col_Wise_FFT_U0_c_fft_row_op_st_read : STD_LOGIC;
    signal Col_Wise_FFT_U0_c_fft_col_op_st_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Col_Wise_FFT_U0_c_fft_col_op_st_write : STD_LOGIC;
    signal Col_Wise_FFT_U0_ctrl1_reg_read : STD_LOGIC;
    signal Col_Wise_FFT_U0_ctrl2_reg_read : STD_LOGIC;
    signal Col_Wise_FFT_U0_layer1_reg_read : STD_LOGIC;
    signal Col_Wise_FFT_U0_ctrl1_reg_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Col_Wise_FFT_U0_ctrl1_reg_c_write : STD_LOGIC;
    signal Col_Wise_FFT_U0_ctrl2_reg_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Col_Wise_FFT_U0_ctrl2_reg_c_write : STD_LOGIC;
    signal Col_Wise_FFT_U0_layer1_reg_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Col_Wise_FFT_U0_layer1_reg_c_write : STD_LOGIC;
    ...
    signal ctrl1_reg_c15_full_n : STD_LOGIC;
    signal ctrl1_reg_c15_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal ctrl1_reg_c15_empty_n : STD_LOGIC;
    signal ctrl2_reg_c18_full_n : STD_LOGIC;
    signal ctrl2_reg_c18_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal ctrl2_reg_c18_empty_n : STD_LOGIC;
    signal layer1_reg_c21_full_n : STD_LOGIC;
    signal layer1_reg_c21_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal layer1_reg_c21_empty_n : STD_LOGIC;
    ...
    signal ctrl1_reg_c14_full_n : STD_LOGIC;
    signal ctrl1_reg_c14_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal ctrl1_reg_c14_empty_n : STD_LOGIC;
    signal ctrl2_reg_c17_full_n : STD_LOGIC;
    signal ctrl2_reg_c17_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal ctrl2_reg_c17_empty_n : STD_LOGIC;
    signal layer1_reg_c20_full_n : STD_LOGIC;
    signal layer1_reg_c20_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal layer1_reg_c20_empty_n : STD_LOGIC;
    ...
    signal ctrl1_reg_c13_full_n : STD_LOGIC;
    signal ctrl1_reg_c13_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal ctrl1_reg_c13_empty_n : STD_LOGIC;
    signal ctrl2_reg_c16_full_n : STD_LOGIC;
    signal ctrl2_reg_c16_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal ctrl2_reg_c16_empty_n : STD_LOGIC;
    signal layer1_reg_c19_full_n : STD_LOGIC;
    signal layer1_reg_c19_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal layer1_reg_c19_empty_n : STD_LOGIC;
    ...
    signal start_for_Row_Wise_FFT_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Row_Wise_FFT_U0_full_n : STD_LOGIC;
    signal start_for_Row_Wise_FFT_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Row_Wise_FFT_U0_empty_n : STD_LOGIC;
    signal start_for_Col_Wise_FFT_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Col_Wise_FFT_U0_full_n : STD_LOGIC;
    signal start_for_Col_Wise_FFT_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Col_Wise_FFT_U0_empty_n : STD_LOGIC;
    signal ap_ce_reg : STD_LOGIC;

    component fwd_fft_entry_proc13 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component fwd_fft_Row_Wise_FFT IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component fwd_fft_Col_Wise_FFT IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component fwd_fft_fifo_w64_d5_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component fwd_fft_start_for_Row_Wise_FFT_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component fwd_fft_start_for_Col_Wise_FFT_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    entry_proc13_U0 : component fwd_fft_entry_proc13
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    port map (
        ...
        layer1_reg => layer1_reg,
        layer2_reg => layer2_reg,
        ctrl1_reg_c15_din => Mem_Patch_Gen_U0_ctrl1_reg_c15_din,
        ctrl1_reg_c15_full_n => ctrl1_reg_c15_full_n,
        ctrl1_reg_c15_write => Mem_Patch_Gen_U0_ctrl1_reg_c15_write,
        ctrl2_reg_c18_din => Mem_Patch_Gen_U0_ctrl2_reg_c18_din,
        ctrl2_reg_c18_full_n => ctrl2_reg_c18_full_n,
        ctrl2_reg_c18_write => Mem_Patch_Gen_U0_ctrl2_reg_c18_write,
        layer1_reg_c21_din => Mem_Patch_Gen_U0_layer1_reg_c21_din,
        layer1_reg_c21_full_n => layer1_reg_c21_full_n,
        layer1_reg_c21_write => Mem_Patch_Gen_U0_layer1_reg_c21_write);
    ...
    port map (
        ...
        start_full_n => start_for_Row_Wise_FFT_U0_full_n,
        ...
        ctrl1_reg_dout => ctrl1_reg_c15_dout,
        ctrl1_reg_empty_n => ctrl1_reg_c15_empty_n,
        ctrl1_reg_read => Col_Wise_Overlap_Gen_U0_ctrl1_reg_read,
        ctrl2_reg_dout => ctrl2_reg_c18_dout,
        ctrl2_reg_empty_n => ctrl2_reg_c18_empty_n,
        ctrl2_reg_read => Col_Wise_Overlap_Gen_U0_ctrl2_reg_read,
        layer1_reg_dout => layer1_reg_c21_dout,
        layer1_reg_empty_n => layer1_reg_c21_empty_n,
        layer1_reg_read => Col_Wise_Overlap_Gen_U0_layer1_reg_read,
        ctrl1_reg_c14_din => Col_Wise_Overlap_Gen_U0_ctrl1_reg_c14_din,
        ctrl1_reg_c14_full_n => ctrl1_reg_c14_full_n,
        ctrl1_reg_c14_write => Col_Wise_Overlap_Gen_U0_ctrl1_reg_c14_write,
        ctrl2_reg_c17_din => Col_Wise_Overlap_Gen_U0_ctrl2_reg_c17_din,
        ctrl2_reg_c17_full_n => ctrl2_reg_c17_full_n,
        ctrl2_reg_c17_write => Col_Wise_Overlap_Gen_U0_ctrl2_reg_c17_write,
        layer1_reg_c20_din => Col_Wise_Overlap_Gen_U0_layer1_reg_c20_din,
        layer1_reg_c20_full_n => layer1_reg_c20_full_n,
        layer1_reg_c20_write => Col_Wise_Overlap_Gen_U0_layer1_reg_c20_write);

    Row_Wise_FFT_U0 : component fwd_fft_Row_Wise_FFT
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => Row_Wise_FFT_U0_ap_start,
        start_full_n => start_for_Col_Wise_FFT_U0_full_n,
        ap_done => Row_Wise_FFT_U0_ap_done,
        ap_continue => Row_Wise_FFT_U0_ap_continue,
        ap_idle => Row_Wise_FFT_U0_ap_idle,
        ap_ready => Row_Wise_FFT_U0_ap_ready,
        start_out => Row_Wise_FFT_U0_start_out,
        start_write => Row_Wise_FFT_U0_start_write,
        c_ifmap_col_op_st_dout => c_ifmap_col_op_st_dout,
        c_ifmap_col_op_st_empty_n => c_ifmap_col_op_st_empty_n,
        c_ifmap_col_op_st_read => Row_Wise_FFT_U0_c_ifmap_col_op_st_read,
        c_fft_row_op_st_din => Row_Wise_FFT_U0_c_fft_row_op_st_din,
        c_fft_row_op_st_full_n => c_fft_row_op_st_full_n,
        c_fft_row_op_st_write => Row_Wise_FFT_U0_c_fft_row_op_st_write,
        ctrl1_reg_dout => ctrl1_reg_c14_dout,
        ctrl1_reg_empty_n => ctrl1_reg_c14_empty_n,
        ctrl1_reg_read => Row_Wise_FFT_U0_ctrl1_reg_read,
        ctrl2_reg_dout => ctrl2_reg_c17_dout,
        ctrl2_reg_empty_n => ctrl2_reg_c17_empty_n,
        ctrl2_reg_read => Row_Wise_FFT_U0_ctrl2_reg_read,
        layer1_reg_dout => layer1_reg_c20_dout,
        layer1_reg_empty_n => layer1_reg_c20_empty_n,
        layer1_reg_read => Row_Wise_FFT_U0_layer1_reg_read,
        ctrl1_reg_c13_din => Row_Wise_FFT_U0_ctrl1_reg_c13_din,
        ctrl1_reg_c13_full_n => ctrl1_reg_c13_full_n,
        ctrl1_reg_c13_write => Row_Wise_FFT_U0_ctrl1_reg_c13_write,
        ctrl2_reg_c16_din => Row_Wise_FFT_U0_ctrl2_reg_c16_din,
        ctrl2_reg_c16_full_n => ctrl2_reg_c16_full_n,
        ctrl2_reg_c16_write => Row_Wise_FFT_U0_ctrl2_reg_c16_write,
        layer1_reg_c19_din => Row_Wise_FFT_U0_layer1_reg_c19_din,
        layer1_reg_c19_full_n => layer1_reg_c19_full_n,
        layer1_reg_c19_write => Row_Wise_FFT_U0_layer1_reg_c19_write);

    Col_Wise_FFT_U0 : component fwd_fft_Col_Wise_FFT
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => Col_Wise_FFT_U0_ap_start,
        ap_done => Col_Wise_FFT_U0_ap_done,
        ap_continue => Col_Wise_FFT_U0_ap_continue,
        ap_idle => Col_Wise_FFT_U0_ap_idle,
        ap_ready => Col_Wise_FFT_U0_ap_ready,
        c_fft_row_op_st_dout => c_fft_row_op_st_dout,
        c_fft_row_op_st_empty_n => c_fft_row_op_st_empty_n,
        c_fft_row_op_st_read => Col_Wise_FFT_U0_c_fft_row_op_st_read,
        c_fft_col_op_st_din => Col_Wise_FFT_U0_c_fft_col_op_st_din,
        c_fft_col_op_st_full_n => c_fft_col_op_st_full_n,
        c_fft_col_op_st_write => Col_Wise_FFT_U0_c_fft_col_op_st_write,
        ctrl1_reg_dout => ctrl1_reg_c13_dout,
        ctrl1_reg_empty_n => ctrl1_reg_c13_empty_n,
        ctrl1_reg_read => Col_Wise_FFT_U0_ctrl1_reg_read,
        ctrl2_reg_dout => ctrl2_reg_c16_dout,
        ctrl2_reg_empty_n => ctrl2_reg_c16_empty_n,
        ctrl2_reg_read => Col_Wise_FFT_U0_ctrl2_reg_read,
        layer1_reg_dout => layer1_reg_c19_dout,
        layer1_reg_empty_n => layer1_reg_c19_empty_n,
        layer1_reg_read => Col_Wise_FFT_U0_layer1_reg_read,
        ctrl1_reg_c_din => Col_Wise_FFT_U0_ctrl1_reg_c_din,
        ctrl1_reg_c_full_n => ctrl1_reg_c_full_n,
        ctrl1_reg_c_write => Col_Wise_FFT_U0_ctrl1_reg_c_write,
        ctrl2_reg_c_din => Col_Wise_FFT_U0_ctrl2_reg_c_din,
        ctrl2_reg_c_full_n => ctrl2_reg_c_full_n,
        ctrl2_reg_c_write => Col_Wise_FFT_U0_ctrl2_reg_c_write,
        layer1_reg_c_din => Col_Wise_FFT_U0_layer1_reg_c_din,
        layer1_reg_c_full_n => layer1_reg_c_full_n,
        layer1_reg_c_write => Col_Wise_FFT_U0_layer1_reg_c_write);
    ...
    out_c_channel_U : component fwd_fft_fifo_w64_d5_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    ctrl1_reg_c15_U : component fwd_fft_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Mem_Patch_Gen_U0_ctrl1_reg_c15_din,
        if_full_n => ctrl1_reg_c15_full_n,
        if_write => Mem_Patch_Gen_U0_ctrl1_reg_c15_write,
        if_dout => ctrl1_reg_c15_dout,
        if_empty_n => ctrl1_reg_c15_empty_n,
        if_read => Col_Wise_Overlap_Gen_U0_ctrl1_reg_read);

    ctrl2_reg_c18_U : component fwd_fft_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Mem_Patch_Gen_U0_ctrl2_reg_c18_din,
        if_full_n => ctrl2_reg_c18_full_n,
        if_write => Mem_Patch_Gen_U0_ctrl2_reg_c18_write,
        if_dout => ctrl2_reg_c18_dout,
        if_empty_n => ctrl2_reg_c18_empty_n,
        if_read => Col_Wise_Overlap_Gen_U0_ctrl2_reg_read);

    layer1_reg_c21_U : component fwd_fft_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Mem_Patch_Gen_U0_layer1_reg_c21_din,
        if_full_n => layer1_reg_c21_full_n,
        if_write => Mem_Patch_Gen_U0_layer1_reg_c21_write,
        if_dout => layer1_reg_c21_dout,
        if_empty_n => layer1_reg_c21_empty_n,
        if_read => Col_Wise_Overlap_Gen_U0_layer1_reg_read);

    c_ifmap_col_op_st_U : component fwd_fft_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_read => Row_Wise_FFT_U0_c_ifmap_col_op_st_read);

    ctrl1_reg_c14_U : component fwd_fft_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Col_Wise_Overlap_Gen_U0_ctrl1_reg_c14_din,
        if_full_n => ctrl1_reg_c14_full_n,
        if_write => Col_Wise_Overlap_Gen_U0_ctrl1_reg_c14_write,
        if_dout => ctrl1_reg_c14_dout,
        if_empty_n => ctrl1_reg_c14_empty_n,
        if_read => Row_Wise_FFT_U0_ctrl1_reg_read);

    ctrl2_reg_c17_U : component fwd_fft_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Col_Wise_Overlap_Gen_U0_ctrl2_reg_c17_din,
        if_full_n => ctrl2_reg_c17_full_n,
        if_write => Col_Wise_Overlap_Gen_U0_ctrl2_reg_c17_write,
        if_dout => ctrl2_reg_c17_dout,
        if_empty_n => ctrl2_reg_c17_empty_n,
        if_read => Row_Wise_FFT_U0_ctrl2_reg_read);

    layer1_reg_c20_U : component fwd_fft_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Col_Wise_Overlap_Gen_U0_layer1_reg_c20_din,
        if_full_n => layer1_reg_c20_full_n,
        if_write => Col_Wise_Overlap_Gen_U0_layer1_reg_c20_write,
        if_dout => layer1_reg_c20_dout,
        if_empty_n => layer1_reg_c20_empty_n,
        if_read => Row_Wise_FFT_U0_layer1_reg_read);

    c_fft_row_op_st_U : component fwd_fft_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Row_Wise_FFT_U0_c_fft_row_op_st_din,
        if_full_n => c_fft_row_op_st_full_n,
        if_write => Row_Wise_FFT_U0_c_fft_row_op_st_write,
        if_dout => c_fft_row_op_st_dout,
        if_empty_n => c_fft_row_op_st_empty_n,
        if_read => Col_Wise_FFT_U0_c_fft_row_op_st_read);

    ctrl1_reg_c13_U : component fwd_fft_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Row_Wise_FFT_U0_ctrl1_reg_c13_din,
        if_full_n => ctrl1_reg_c13_full_n,
        if_write => Row_Wise_FFT_U0_ctrl1_reg_c13_write,
        if_dout => ctrl1_reg_c13_dout,
        if_empty_n => ctrl1_reg_c13_empty_n,
        if_read => Col_Wise_FFT_U0_ctrl1_reg_read);

    ctrl2_reg_c16_U : component fwd_fft_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Row_Wise_FFT_U0_ctrl2_reg_c16_din,
        if_full_n => ctrl2_reg_c16_full_n,
        if_write => Row_Wise_FFT_U0_ctrl2_reg_c16_write,
        if_dout => ctrl2_reg_c16_dout,
        if_empty_n => ctrl2_reg_c16_empty_n,
        if_read => Col_Wise_FFT_U0_ctrl2_reg_read);

    layer1_reg_c19_U : component fwd_fft_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Row_Wise_FFT_U0_layer1_reg_c19_din,
        if_full_n => layer1_reg_c19_full_n,
        if_write => Row_Wise_FFT_U0_layer1_reg_c19_write,
        if_dout => layer1_reg_c19_dout,
        if_empty_n => layer1_reg_c19_empty_n,
        if_read => Col_Wise_FFT_U0_layer1_reg_read);

    c_fft_col_op_st_U : component fwd_fft_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Col_Wise_FFT_U0_c_fft_col_op_st_din,
        if_full_n => c_fft_col_op_st_full_n,
        if_write => Col_Wise_FFT_U0_c_fft_col_op_st_write,
        if_dout => c_fft_col_op_st_dout,
        if_empty_n => c_fft_col_op_st_empty_n,
        if_read => Mem_patch_Wr_U0_c_fft_col_op_st_read);

    ctrl1_reg_c_U : component fwd_fft_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Col_Wise_FFT_U0_ctrl1_reg_c_din,
        if_full_n => ctrl1_reg_c_full_n,
        if_write => Col_Wise_FFT_U0_ctrl1_reg_c_write,
        if_dout => ctrl1_reg_c_dout,
        if_empty_n => ctrl1_reg_c_empty_n,
        if_read => Mem_patch_Wr_U0_ctrl1_reg_read);

    ctrl2_reg_c_U : component fwd_fft_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Col_Wise_FFT_U0_ctrl2_reg_c_din,
        if_full_n => ctrl2_reg_c_full_n,
        if_write => Col_Wise_FFT_U0_ctrl2_reg_c_write,
        if_dout => ctrl2_reg_c_dout,
        if_empty_n => ctrl2_reg_c_empty_n,
        if_read => Mem_patch_Wr_U0_ctrl2_reg_read);

    layer1_reg_c_U : component fwd_fft_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Col_Wise_FFT_U0_layer1_reg_c_din,
        if_full_n => layer1_reg_c_full_n,
        if_write => Col_Wise_FFT_U0_layer1_reg_c_write,
    ...
    start_for_Row_Wise_FFT_U0_U : component fwd_fft_start_for_Row_Wise_FFT_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => start_for_Row_Wise_FFT_U0_din,
        if_full_n => start_for_Row_Wise_FFT_U0_full_n,
        if_write => Col_Wise_Overlap_Gen_U0_start_write,
        if_dout => start_for_Row_Wise_FFT_U0_dout,
        if_empty_n => start_for_Row_Wise_FFT_U0_empty_n,
        if_read => Row_Wise_FFT_U0_ap_ready);

    start_for_Col_Wise_FFT_U0_U : component fwd_fft_start_for_Col_Wise_FFT_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => start_for_Col_Wise_FFT_U0_din,
        if_full_n => start_for_Col_Wise_FFT_U0_full_n,
        if_write => Row_Wise_FFT_U0_start_write,
        if_dout => start_for_Col_Wise_FFT_U0_dout,
        if_empty_n => start_for_Col_Wise_FFT_U0_empty_n,
        if_read => Col_Wise_FFT_U0_ap_ready);
    ...
    Col_Wise_FFT_U0_ap_continue <= ap_const_logic_1;
    Col_Wise_FFT_U0_ap_start <= start_for_Col_Wise_FFT_U0_empty_n;
    ...
    Row_Wise_FFT_U0_ap_continue <= ap_const_logic_1;
    Row_Wise_FFT_U0_ap_start <= start_for_Row_Wise_FFT_U0_empty_n;
    ap_done <= Mem_patch_Wr_U0_ap_done;
    ap_idle <= ((out_c_channel_empty_n xor ap_const_logic_1) and entry_proc13_U0_ap_idle and Row_Wise_FFT_U0_ap_idle and Mem_patch_Wr_U0_ap_idle and Mem_Patch_Gen_U0_ap_idle and Col_Wise_Overlap_Gen_U0_ap_idle and Col_Wise_FFT_U0_ap_idle);
    ...
    ap_sync_ready <= (ap_sync_entry_proc13_U0_ap_ready and ap_sync_Mem_Patch_Gen_U0_ap_ready);
    entry_proc13_U0_ap_continue <= out_c_channel_full_n;
    entry_proc13_U0_ap_start <= ((ap_sync_reg_entry_proc13_U0_ap_ready xor ap_const_logic_1) and ap_start);
    start_for_Col_Wise_FFT_U0_din <= (0=>ap_const_logic_1, others=>'-');
    start_for_Col_Wise_Overlap_Gen_U0_din <= (0=>ap_const_logic_1, others=>'-');
    start_for_Row_Wise_FFT_U0_din <= (0=>ap_const_logic_1, others=>'-');
end behav;
