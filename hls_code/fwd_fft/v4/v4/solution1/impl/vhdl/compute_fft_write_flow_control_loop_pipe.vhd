...
entity compute_fft_write_flow_control_loop_pipe is
port (
    ap_clk             : in  std_logic;
    ap_rst             : in  std_logic;
...
end entity compute_fft_write_flow_control_loop_pipe;

architecture behav of compute_fft_write_flow_control_loop_pipe is
begin 
