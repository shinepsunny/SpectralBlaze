...
entity fwd_fft_fft_stage_0_018_Pipeline_VITIS_LOOP_41_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_fft_stage_0_018_Pipeline_VITIS_LOOP_41_1 is 
...
begin
    ...
    add_ln41_fu_142_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_x_12) + unsigned(ap_const_lv7_2));
    ...
    icmp_ln1057_fu_116_p2 <= "1" when (unsigned(zext_ln1057_11_fu_112_p1) < unsigned(ctrl1_reg_load_cast1)) else "0";
