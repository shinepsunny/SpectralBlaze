...
entity fwd_fft_fft_stage1022_Pipeline_SKIP_X is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_fft_stage1022_Pipeline_SKIP_X is 
...
attribute shreg_extract : string;
    ...
    signal p_r_M_imag_37_reg_434 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal k1_24_fu_217_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal j1_fu_46 : STD_LOGIC_VECTOR (31 downto 0);
    signal j1_26_fu_279_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal m1_fu_50 : STD_LOGIC_VECTOR (31 downto 0);
    signal m1_22_fu_287_p3 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal m1_21_fu_261_p3 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    hadd_16ns_16ns_16_5_full_dsp_1_U110 : component fwd_fft_hadd_16ns_16ns_16_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 16,
    ...
    hadd_16ns_16ns_16_5_full_dsp_1_U111 : component fwd_fft_hadd_16ns_16ns_16_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 16,
    ...
    hadd_16ns_16ns_16_5_full_dsp_1_U112 : component fwd_fft_hadd_16ns_16ns_16_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 16,
    ...
    port map (
        ...
        din1 => p_r_M_imag_37_reg_434,
        ce => ap_const_logic_1,
        dout => grp_fu_168_p2);

    hsub_16ns_16ns_16_5_full_dsp_1_U113 : component fwd_fft_hsub_16ns_16ns_16_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 16,
    ...
    hsub_16ns_16ns_16_5_full_dsp_1_U114 : component fwd_fft_hsub_16ns_16ns_16_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 16,
    ...
    hsub_16ns_16ns_16_5_full_dsp_1_U115 : component fwd_fft_hsub_16ns_16ns_16_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_4_max_dsp_1_U116 : component fwd_fft_hmul_16ns_16ns_16_4_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_4_max_dsp_1_U117 : component fwd_fft_hmul_16ns_16ns_16_4_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 16,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                ...
                p_r_M_imag_37_reg_434 <= grp_fu_160_p2;
    ...
    add_ln19_fu_237_p2 <= std_logic_vector(unsigned(trunc_ln1057_10_fu_233_p1) + unsigned(trunc_ln1057_fu_229_p1));
    ...
    j1_26_fu_279_p3 <= 
        ...
        j1_fu_46;
    k1_24_fu_217_p2 <= std_logic_vector(unsigned(k1_fu_42) + unsigned(ap_const_lv7_1));
    m1_21_fu_261_p3 <= 
    ...
    trunc_ln1057_10_fu_233_p1 <= j1_fu_46(6 - 1 downto 0);
