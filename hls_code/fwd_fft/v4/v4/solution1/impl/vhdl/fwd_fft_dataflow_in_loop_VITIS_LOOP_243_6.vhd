...
entity fwd_fft_dataflow_in_loop_VITIS_LOOP_243_6 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_dataflow_in_loop_VITIS_LOOP_243_6 is 
...
attribute shreg_extract : string;
    ...
    signal entry_proc31_U0_ap_return_0 : STD_LOGIC_VECTOR (7 downto 0);
    signal entry_proc31_U0_ap_return_1 : STD_LOGIC_VECTOR (31 downto 0);
    signal entry_proc31_U0_ap_return_2 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal VITIS_LOOP_247_7_proc_U0_ap_start : STD_LOGIC;
    signal VITIS_LOOP_247_7_proc_U0_ap_done : STD_LOGIC;
    signal VITIS_LOOP_247_7_proc_U0_ap_continue : STD_LOGIC;
    signal VITIS_LOOP_247_7_proc_U0_ap_idle : STD_LOGIC;
    signal VITIS_LOOP_247_7_proc_U0_ap_ready : STD_LOGIC;
    signal VITIS_LOOP_247_7_proc_U0_c_ifmap_col_op_st_read : STD_LOGIC;
    signal VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_ce0 : STD_LOGIC;
    signal VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_we0 : STD_LOGIC;
    signal VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_d0 : STD_LOGIC_VECTOR (15 downto 0);
    signal VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_ce0 : STD_LOGIC;
    signal VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_we0 : STD_LOGIC;
    signal VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_d0 : STD_LOGIC_VECTOR (15 downto 0);
    signal VITIS_LOOP_247_7_proc_U0_ap_return : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_full_n : STD_LOGIC;
    ...
    signal VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_full_n : STD_LOGIC;
    ...
    signal VITIS_LOOP_256_8_proc_U0_ap_start : STD_LOGIC;
    signal VITIS_LOOP_256_8_proc_U0_ap_done : STD_LOGIC;
    signal VITIS_LOOP_256_8_proc_U0_ap_continue : STD_LOGIC;
    signal VITIS_LOOP_256_8_proc_U0_ap_idle : STD_LOGIC;
    signal VITIS_LOOP_256_8_proc_U0_ap_ready : STD_LOGIC;
    signal VITIS_LOOP_256_8_proc_U0_ctrl1_reg_read : STD_LOGIC;
    signal VITIS_LOOP_256_8_proc_U0_out_fft_03_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal VITIS_LOOP_256_8_proc_U0_out_fft_03_ce0 : STD_LOGIC;
    signal VITIS_LOOP_256_8_proc_U0_out_fft_14_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal VITIS_LOOP_256_8_proc_U0_out_fft_14_ce0 : STD_LOGIC;
    signal VITIS_LOOP_256_8_proc_U0_c_fft_row_op_st_din : STD_LOGIC_VECTOR (31 downto 0);
    signal VITIS_LOOP_256_8_proc_U0_c_fft_row_op_st_write : STD_LOGIC;
    signal VITIS_LOOP_256_8_proc_U0_Row_Buffer_din : STD_LOGIC_VECTOR (31 downto 0);
    signal VITIS_LOOP_256_8_proc_U0_Row_Buffer_write : STD_LOGIC;
    ...
    signal ap_sync_reg_VITIS_LOOP_247_7_proc_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_VITIS_LOOP_247_7_proc_U0_ap_ready : STD_LOGIC;
    signal ap_ce_reg : STD_LOGIC;

    component fwd_fft_entry_proc31 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component fwd_fft_VITIS_LOOP_247_7_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component fwd_fft_VITIS_LOOP_256_8_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component fwd_fft_dataflow_in_loop_VITIS_LOOP_243_6_in_fft_M_real IS
    generic (
        DataWidth : INTEGER;
    ...
    component fwd_fft_dataflow_in_loop_VITIS_LOOP_243_6_out_fft_03 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    in_fft_M_real_U : component fwd_fft_dataflow_in_loop_VITIS_LOOP_243_6_in_fft_M_real
    generic map (
        DataWidth => 16,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    in_fft_M_imag_U : component fwd_fft_dataflow_in_loop_VITIS_LOOP_243_6_in_fft_M_real
    generic map (
        DataWidth => 16,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_fft_03_U : component fwd_fft_dataflow_in_loop_VITIS_LOOP_243_6_out_fft_03
    generic map (
        DataWidth => 16,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_fft_14_U : component fwd_fft_dataflow_in_loop_VITIS_LOOP_243_6_out_fft_03
    generic map (
        DataWidth => 16,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    entry_proc31_U0 : component fwd_fft_entry_proc31
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    VITIS_LOOP_247_7_proc_U0 : component fwd_fft_VITIS_LOOP_247_7_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    VITIS_LOOP_256_8_proc_U0 : component fwd_fft_VITIS_LOOP_256_8_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    ap_sync_reg_VITIS_LOOP_247_7_proc_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_VITIS_LOOP_247_7_proc_U0_ap_ready <= ap_const_logic_0;
            else
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((VITIS_LOOP_247_7_proc_U0_ap_done and VITIS_LOOP_247_7_proc_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_ctrl1_reg_c1_channel <= ap_const_logic_0;
                else 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((entry_proc31_U0_ap_done and entry_proc31_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_ctrl2_reg_c_channel <= ap_const_logic_0;
                else 
    ...
    Row_Buffer_din <= VITIS_LOOP_256_8_proc_U0_Row_Buffer_din;
    Row_Buffer_write <= VITIS_LOOP_256_8_proc_U0_Row_Buffer_write;
    VITIS_LOOP_247_7_proc_U0_ap_continue <= (ap_sync_channel_write_in_fft_M_real and ap_sync_channel_write_in_fft_M_imag and ap_sync_channel_write_ctrl1_reg_c1_channel);
    VITIS_LOOP_247_7_proc_U0_ap_start <= ((ap_sync_reg_VITIS_LOOP_247_7_proc_U0_ap_ready xor ap_const_logic_1) and ap_start);
    VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_full_n <= in_fft_M_imag_i_full_n;
    VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_full_n <= in_fft_M_real_i_full_n;
    VITIS_LOOP_256_8_proc_U0_ap_continue <= ap_continue;
    VITIS_LOOP_256_8_proc_U0_ap_start <= (y_7_c_channel_empty_n and pny_c_channel_empty_n and out_fft_14_t_empty_n and out_fft_03_t_empty_n and ctrl2_reg_c_channel_empty_n);
    ap_channel_done_ctrl1_reg_c1_channel <= ((ap_sync_reg_channel_write_ctrl1_reg_c1_channel xor ap_const_logic_1) and VITIS_LOOP_247_7_proc_U0_ap_done);
    ap_channel_done_ctrl2_reg_c_channel <= ((ap_sync_reg_channel_write_ctrl2_reg_c_channel xor ap_const_logic_1) and entry_proc31_U0_ap_done);
    ap_channel_done_in_fft_M_imag <= ((ap_sync_reg_channel_write_in_fft_M_imag xor ap_const_logic_1) and VITIS_LOOP_247_7_proc_U0_ap_done);
    ap_channel_done_in_fft_M_real <= ((ap_sync_reg_channel_write_in_fft_M_real xor ap_const_logic_1) and VITIS_LOOP_247_7_proc_U0_ap_done);
    ...
    ap_channel_done_pny_c_channel <= ((ap_sync_reg_channel_write_pny_c_channel xor ap_const_logic_1) and entry_proc31_U0_ap_done);
    ap_channel_done_y_7_c_channel <= ((ap_sync_reg_channel_write_y_7_c_channel xor ap_const_logic_1) and entry_proc31_U0_ap_done);
    ap_done <= VITIS_LOOP_256_8_proc_U0_ap_done;
    ap_idle <= (fft22_U0_ap_idle and (ctrl1_reg_c1_channel_empty_n xor ap_const_logic_1) and (y_7_c_channel_empty_n xor ap_const_logic_1) and (ctrl2_reg_c_channel_empty_n xor ap_const_logic_1) and (pny_c_channel_empty_n xor ap_const_logic_1) and (out_fft_14_t_empty_n xor ap_const_logic_1) and (out_fft_03_t_empty_n xor ap_const_logic_1) and (in_fft_M_imag_t_empty_n xor ap_const_logic_1) and (in_fft_M_real_t_empty_n xor ap_const_logic_1) and entry_proc31_U0_ap_idle and VITIS_LOOP_256_8_proc_U0_ap_idle and VITIS_LOOP_247_7_proc_U0_ap_idle);
    ap_ready <= ap_sync_ready;
    ap_sync_VITIS_LOOP_247_7_proc_U0_ap_ready <= (ap_sync_reg_VITIS_LOOP_247_7_proc_U0_ap_ready or VITIS_LOOP_247_7_proc_U0_ap_ready);
    ...
    ap_sync_channel_write_in_fft_M_imag <= ((ap_channel_done_in_fft_M_imag and VITIS_LOOP_247_7_proc_U0_in_fft_M_imag2_full_n) or ap_sync_reg_channel_write_in_fft_M_imag);
    ap_sync_channel_write_in_fft_M_real <= ((ap_channel_done_in_fft_M_real and VITIS_LOOP_247_7_proc_U0_in_fft_M_real1_full_n) or ap_sync_reg_channel_write_in_fft_M_real);
    ...
    ap_sync_ready <= (ap_sync_entry_proc31_U0_ap_ready and ap_sync_VITIS_LOOP_247_7_proc_U0_ap_ready);
    c_fft_row_op_st_din <= VITIS_LOOP_256_8_proc_U0_c_fft_row_op_st_din;
    c_fft_row_op_st_write <= VITIS_LOOP_256_8_proc_U0_c_fft_row_op_st_write;
    c_ifmap_col_op_st_read <= VITIS_LOOP_247_7_proc_U0_c_ifmap_col_op_st_read;
    entry_proc31_U0_ap_continue <= (ap_sync_channel_write_y_7_c_channel and ap_sync_channel_write_pny_c_channel and ap_sync_channel_write_ctrl2_reg_c_channel);
