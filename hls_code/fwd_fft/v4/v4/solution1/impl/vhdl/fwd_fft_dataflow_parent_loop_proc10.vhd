...
attribute shreg_extract : string;
    signal dataflow_parent_loop_proc7_U0_c_fft_row_op_st_read : STD_LOGIC;
    signal dataflow_parent_loop_proc7_U0_c_fft_col_op_st_din : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_parent_loop_proc7_U0_c_fft_col_op_st_write : STD_LOGIC;
    ...
    component fwd_fft_dataflow_parent_loop_proc7 IS
    port (
        ctrl2_reg_load_cast : IN STD_LOGIC_VECTOR (7 downto 0);
        c_fft_row_op_st_dout : IN STD_LOGIC_VECTOR (31 downto 0);
        c_fft_row_op_st_empty_n : IN STD_LOGIC;
...
begin
    dataflow_parent_loop_proc7_U0 : component fwd_fft_dataflow_parent_loop_proc7
    port map (
    ...
    begin
        if (((loop_dataflow_output_count = ap_const_lv16_0) and (ap_start = ap_const_logic_0) and (dataflow_parent_loop_proc7_U0_ap_idle = ap_const_logic_1))) then 
    ...
    dataflow_parent_loop_proc7_U0_ap_continue_assign_proc : process(ap_continue, loop_dataflow_output_count, bound_minus_1)
    begin
        if ((not((loop_dataflow_output_count = bound_minus_1)) or (ap_continue = ap_const_logic_1))) then 
            ...
            dataflow_parent_loop_proc7_U0_ap_continue <= ap_const_logic_0;
        end if; 
    end process;
