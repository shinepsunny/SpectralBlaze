...
entity FFT_R_fft_stage6_Pipeline_SKIP_X is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of FFT_R_fft_stage6_Pipeline_SKIP_X is 
...
begin
    w_M_real17_U : component FFT_R_fft_stage5_Pipeline_SKIP_X_w_M_real18
    generic map (
        DataWidth => 16,
        AddressRange => 192,
        AddressWidth => 8)
    ...
    w_M_imag12_U : component FFT_R_fft_stage5_Pipeline_SKIP_X_w_M_imag13
    generic map (
        DataWidth => 16,
        AddressRange => 192,
        AddressWidth => 8)
    ...
    hadd_16ns_16ns_16_2_full_dsp_1_U45 : component FFT_R_hadd_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hadd_16ns_16ns_16_2_full_dsp_1_U46 : component FFT_R_hadd_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hadd_16ns_16ns_16_2_full_dsp_1_U47 : component FFT_R_hadd_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hsub_16ns_16ns_16_2_full_dsp_1_U48 : component FFT_R_hsub_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hsub_16ns_16ns_16_2_full_dsp_1_U49 : component FFT_R_hsub_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hsub_16ns_16ns_16_2_full_dsp_1_U50 : component FFT_R_hsub_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_2_max_dsp_1_U51 : component FFT_R_hmul_16ns_16ns_16_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_2_max_dsp_1_U52 : component FFT_R_hmul_16ns_16ns_16_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_2_max_dsp_1_U53 : component FFT_R_hmul_16ns_16ns_16_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_2_max_dsp_1_U54 : component FFT_R_hmul_16ns_16ns_16_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    add_ln21_fu_257_p2 <= std_logic_vector(unsigned(trunc_ln1057_4_fu_237_p1) + unsigned(trunc_ln1057_fu_233_p1));
    ...
    j1_11_fu_298_p3 <= 
        ...
        j1_fu_64;
    j1_12_fu_314_p3 <= 
        j1_10_fu_280_p2 when (icmp_ln26_fu_274_p2(0) = '1') else 
        j1_11_fu_298_p3;
    ...
    w_M_imag12_address0 <= zext_ln20_fu_251_p1(8 - 1 downto 0);
    ...
    w_M_real17_address0 <= zext_ln20_fu_251_p1(8 - 1 downto 0);
