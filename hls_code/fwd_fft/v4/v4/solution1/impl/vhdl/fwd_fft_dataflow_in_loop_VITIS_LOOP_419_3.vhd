...
entity fwd_fft_dataflow_in_loop_VITIS_LOOP_419_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    ctrl1_reg : IN STD_LOGIC_VECTOR (7 downto 0);
...
architecture behav of fwd_fft_dataflow_in_loop_VITIS_LOOP_419_3 is 
...
attribute shreg_extract : string;
    ...
    component fwd_fft_dataflow_in_loop_VITIS_LOOP_419_3_ifmap_RF_M_real IS
    generic (
        DataWidth : INTEGER;
...
begin
    ifmap_RF_M_real_U : component fwd_fft_dataflow_in_loop_VITIS_LOOP_419_3_ifmap_RF_M_real
    generic map (
        DataWidth => 16,
        AddressRange => 4096,
        AddressWidth => 12)
    ...
    ifmap_RF_M_imag_U : component fwd_fft_dataflow_in_loop_VITIS_LOOP_419_3_ifmap_RF_M_real
    generic map (
        DataWidth => 16,
        AddressRange => 4096,
        AddressWidth => 12)
    ...
    ap_done <= ifmap_cons_y_U0_ap_done;
    ap_idle <= (ifmap_gen_x_U0_ap_idle and ifmap_cons_y_U0_ap_idle and (ifmap_RF_M_imag_t_empty_n xor ap_const_logic_1) and (ifmap_RF_M_real_t_empty_n xor ap_const_logic_1));
    ap_ready <= ifmap_gen_x_U0_ap_ready;
    ...
    ifmap_cons_y_U0_ap_start <= (ifmap_RF_M_real_t_empty_n and ifmap_RF_M_imag_t_empty_n);
    ifmap_gen_x_U0_ap_continue <= (ap_sync_channel_write_ifmap_RF_M_real and ap_sync_channel_write_ifmap_RF_M_imag);
