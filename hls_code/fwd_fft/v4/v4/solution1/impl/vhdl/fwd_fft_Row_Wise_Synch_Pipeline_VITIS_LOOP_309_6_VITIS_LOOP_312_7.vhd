...
entity fwd_fft_Row_Wise_Synch_Pipeline_VITIS_LOOP_309_6_VITIS_LOOP_312_7 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    select_ln286_4 : IN STD_LOGIC_VECTOR (0 downto 0) );
end;


architecture behav of fwd_fft_Row_Wise_Synch_Pipeline_VITIS_LOOP_309_6_VITIS_LOOP_312_7 is 
...
attribute shreg_extract : string;
    ...
    signal or_ln286_reg_287 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal or_ln286_fu_196_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal select_ln286_fu_188_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln312_fu_212_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1057_fu_150_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                or_ln286_reg_287 <= or_ln286_fu_196_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    Row_Buffer_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, Row_Buffer_full_n, or_ln286_reg_287, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (or_ln286_reg_287 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    Row_Buffer_write_assign_proc : process(ap_enable_reg_pp0_iter2, or_ln286_reg_287, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (or_ln286_reg_287 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    add_ln312_fu_212_p2 <= std_logic_vector(unsigned(x_fu_60) + unsigned(ap_const_lv8_1));
    ap_CS_fsm_pp0_stage0 <= ap_CS_fsm(0);
        ap_block_pp0_stage0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter2, c_fft_row_op_st_empty_n, c_row_op_st_full_n, Row_Buffer_full_n, or_ln286_reg_287)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and ((c_row_op_st_full_n = ap_const_logic_0) or (c_fft_row_op_st_empty_n = ap_const_logic_0) or ((or_ln286_reg_287 = ap_const_lv1_0) and (ap_const_logic_0 = Row_Buffer_full_n))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter2, c_fft_row_op_st_empty_n, c_row_op_st_full_n, Row_Buffer_full_n, or_ln286_reg_287)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and ((c_row_op_st_full_n = ap_const_logic_0) or (c_fft_row_op_st_empty_n = ap_const_logic_0) or ((or_ln286_reg_287 = ap_const_lv1_0) and (ap_const_logic_0 = Row_Buffer_full_n))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter2, c_fft_row_op_st_empty_n, c_row_op_st_full_n, Row_Buffer_full_n, or_ln286_reg_287)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and ((c_row_op_st_full_n = ap_const_logic_0) or (c_fft_row_op_st_empty_n = ap_const_logic_0) or ((or_ln286_reg_287 = ap_const_lv1_0) and (ap_const_logic_0 = Row_Buffer_full_n))));
    end process;

        ap_block_state1_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));
        ap_block_state2_pp0_stage0_iter1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state3_pp0_stage0_iter2_assign_proc : process(c_fft_row_op_st_empty_n, c_row_op_st_full_n, Row_Buffer_full_n, or_ln286_reg_287)
    begin
                ap_block_state3_pp0_stage0_iter2 <= ((c_row_op_st_full_n = ap_const_logic_0) or (c_fft_row_op_st_empty_n = ap_const_logic_0) or ((or_ln286_reg_287 = ap_const_lv1_0) and (ap_const_logic_0 = Row_Buffer_full_n)));
    end process;
    ...
    or_ln286_fu_196_p2 <= (select_ln286_fu_188_p3 or select_ln286_4);
