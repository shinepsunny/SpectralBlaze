...
entity fwd_fft_fft_stage_113_Pipeline_VITIS_LOOP_36_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_fft_stage_113_Pipeline_VITIS_LOOP_36_1 is 
...
begin
    ...
    add_ln36_fu_142_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_x_11) + unsigned(ap_const_lv7_2));
    ...
    icmp_ln1057_fu_116_p2 <= "1" when (unsigned(zext_ln1057_10_fu_112_p1) < unsigned(ctrl1_reg_load_cast1)) else "0";
