...
entity fwd_fft_fft_syn_param1_32_32_64_1_1_s is
    generic (
...
architecture arch of fwd_fft_fft_syn_param1_32_32_64_1_1_s is
    --------------------- Component ---------------------
    component fwd_fft_fft_syn_param1_32_32_64_1_1_s_core_ip is
        port (
            aclk                        : in  std_logic;
            aclken                      : in  std_logic;
...
begin
    --------------------- Instantiation -----------------
    inst : component fwd_fft_fft_syn_param1_32_32_64_1_1_s_core_ip
    port map (
        aclk                        => ap_clk,
        aclken                      => ap_ce,
        aresetn                     => aresetn,
