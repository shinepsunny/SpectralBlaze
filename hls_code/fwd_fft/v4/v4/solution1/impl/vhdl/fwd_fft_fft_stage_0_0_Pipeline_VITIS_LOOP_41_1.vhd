...
entity fwd_fft_fft_stage_0_0_Pipeline_VITIS_LOOP_41_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_fft_stage_0_0_Pipeline_VITIS_LOOP_41_1 is 
...
begin
    ...
    add_ln41_fu_142_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_x_11) + unsigned(ap_const_lv7_2));
