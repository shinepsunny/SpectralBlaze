...
entity fwd_fft_fft_stage_2_019_Pipeline_VITIS_LOOP_41_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_fft_stage_2_019_Pipeline_VITIS_LOOP_41_1 is 
...
attribute shreg_extract : string;
    ...
    signal zext_ln1057_7_fu_112_p1 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    add_ln41_fu_142_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_x_8) + unsigned(ap_const_lv7_2));
    ...
    ap_sig_allocacmp_x_8_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, x_fu_42, ap_loop_init)
    begin
    ...
    icmp_ln1057_fu_116_p2 <= "1" when (unsigned(zext_ln1057_7_fu_112_p1) < unsigned(ctrl1_reg_load_cast1)) else "0";
    or_ln46_fu_131_p2 <= (trunc_ln1057_fu_127_p1 or ap_const_lv6_1);
    trunc_ln1057_fu_127_p1 <= ap_sig_allocacmp_x_8(6 - 1 downto 0);
    zext_ln1057_7_fu_112_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_x_8),8));
    zext_ln1057_fu_122_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_x_8),64));
