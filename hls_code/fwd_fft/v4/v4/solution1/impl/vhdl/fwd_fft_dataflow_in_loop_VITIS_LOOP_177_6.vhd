...
entity fwd_fft_dataflow_in_loop_VITIS_LOOP_177_6 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_dataflow_in_loop_VITIS_LOOP_177_6 is 
...
attribute shreg_extract : string;
    ...
    signal VITIS_LOOP_181_7_proc_U0_ap_start : STD_LOGIC;
    signal VITIS_LOOP_181_7_proc_U0_ap_done : STD_LOGIC;
    signal VITIS_LOOP_181_7_proc_U0_ap_continue : STD_LOGIC;
    signal VITIS_LOOP_181_7_proc_U0_ap_idle : STD_LOGIC;
    signal VITIS_LOOP_181_7_proc_U0_ap_ready : STD_LOGIC;
    signal VITIS_LOOP_181_7_proc_U0_c_ifmap_col_op_st_read : STD_LOGIC;
    signal VITIS_LOOP_181_7_proc_U0_in_fft_M_value1_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal VITIS_LOOP_181_7_proc_U0_in_fft_M_value1_ce0 : STD_LOGIC;
    signal VITIS_LOOP_181_7_proc_U0_in_fft_M_value1_we0 : STD_LOGIC;
    signal VITIS_LOOP_181_7_proc_U0_in_fft_M_value1_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal VITIS_LOOP_181_7_proc_U0_in_fft_M_value_22_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal VITIS_LOOP_181_7_proc_U0_in_fft_M_value_22_ce0 : STD_LOGIC;
    signal VITIS_LOOP_181_7_proc_U0_in_fft_M_value_22_we0 : STD_LOGIC;
    signal VITIS_LOOP_181_7_proc_U0_in_fft_M_value_22_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal VITIS_LOOP_181_7_proc_U0_ctrl1_reg_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal VITIS_LOOP_181_7_proc_U0_ctrl1_reg_c_write : STD_LOGIC;
    signal ap_channel_done_in_fft_M_value_1 : STD_LOGIC;
    signal VITIS_LOOP_181_7_proc_U0_in_fft_M_value_22_full_n : STD_LOGIC;
    ...
    signal VITIS_LOOP_181_7_proc_U0_in_fft_M_value1_full_n : STD_LOGIC;
    ...
    signal VITIS_LOOP_190_8_proc_U0_ap_start : STD_LOGIC;
    signal VITIS_LOOP_190_8_proc_U0_ap_done : STD_LOGIC;
    signal VITIS_LOOP_190_8_proc_U0_ap_continue : STD_LOGIC;
    signal VITIS_LOOP_190_8_proc_U0_ap_idle : STD_LOGIC;
    signal VITIS_LOOP_190_8_proc_U0_ap_ready : STD_LOGIC;
    signal VITIS_LOOP_190_8_proc_U0_ctrl1_reg_read : STD_LOGIC;
    signal VITIS_LOOP_190_8_proc_U0_out_fft3_read : STD_LOGIC;
    signal VITIS_LOOP_190_8_proc_U0_c_fft_row_op_st_din : STD_LOGIC_VECTOR (31 downto 0);
    signal VITIS_LOOP_190_8_proc_U0_c_fft_row_op_st_write : STD_LOGIC;
    signal VITIS_LOOP_190_8_proc_U0_Row_Buffer_din : STD_LOGIC_VECTOR (31 downto 0);
    signal VITIS_LOOP_190_8_proc_U0_Row_Buffer_write : STD_LOGIC;
    ...
    signal ap_sync_reg_VITIS_LOOP_181_7_proc_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_VITIS_LOOP_181_7_proc_U0_ap_ready : STD_LOGIC;
    ...
    component fwd_fft_VITIS_LOOP_181_7_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component fwd_fft_VITIS_LOOP_190_8_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component fwd_fft_dataflow_in_loop_VITIS_LOOP_177_6_in_fft_M_value IS
    generic (
        DataWidth : INTEGER;
...
begin
    in_fft_M_value_U : component fwd_fft_dataflow_in_loop_VITIS_LOOP_177_6_in_fft_M_value
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    in_fft_M_value_1_U : component fwd_fft_dataflow_in_loop_VITIS_LOOP_177_6_in_fft_M_value
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    VITIS_LOOP_181_7_proc_U0 : component fwd_fft_VITIS_LOOP_181_7_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    VITIS_LOOP_190_8_proc_U0 : component fwd_fft_VITIS_LOOP_190_8_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    ap_sync_reg_VITIS_LOOP_181_7_proc_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_VITIS_LOOP_181_7_proc_U0_ap_ready <= ap_const_logic_0;
            else
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((VITIS_LOOP_181_7_proc_U0_ap_done and VITIS_LOOP_181_7_proc_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_in_fft_M_value <= ap_const_logic_0;
                else 
    ...
    Row_Buffer_din <= VITIS_LOOP_190_8_proc_U0_Row_Buffer_din;
    Row_Buffer_write <= VITIS_LOOP_190_8_proc_U0_Row_Buffer_write;
    VITIS_LOOP_181_7_proc_U0_ap_continue <= (ap_sync_channel_write_in_fft_M_value_1 and ap_sync_channel_write_in_fft_M_value);
    VITIS_LOOP_181_7_proc_U0_ap_start <= ((ap_sync_reg_VITIS_LOOP_181_7_proc_U0_ap_ready xor ap_const_logic_1) and ap_start);
    VITIS_LOOP_181_7_proc_U0_in_fft_M_value1_full_n <= in_fft_M_value_i_full_n;
    VITIS_LOOP_181_7_proc_U0_in_fft_M_value_22_full_n <= in_fft_M_value_1_i_full_n;
    VITIS_LOOP_190_8_proc_U0_ap_continue <= ap_continue;
    VITIS_LOOP_190_8_proc_U0_ap_start <= (y_7_c_channel_empty_n and pny_c_channel_empty_n and ctrl2_reg_c_channel_empty_n);
    ...
    ap_channel_done_in_fft_M_value <= ((ap_sync_reg_channel_write_in_fft_M_value xor ap_const_logic_1) and VITIS_LOOP_181_7_proc_U0_ap_done);
    ap_channel_done_in_fft_M_value_1 <= ((ap_sync_reg_channel_write_in_fft_M_value_1 xor ap_const_logic_1) and VITIS_LOOP_181_7_proc_U0_ap_done);
    ...
    ap_done <= VITIS_LOOP_190_8_proc_U0_ap_done;
    ap_idle <= (fft_param1_15_U0_ap_idle and (fft_config1_data_V_c_channel_empty_n xor ap_const_logic_1) and (pny_c_channel_empty_n xor ap_const_logic_1) and (ctrl2_reg_c_channel_empty_n xor ap_const_logic_1) and (y_7_c_channel_empty_n xor ap_const_logic_1) and (in_fft_M_value_1_t_empty_n xor ap_const_logic_1) and (in_fft_M_value_t_empty_n xor ap_const_logic_1) and entry_proc21_U0_ap_idle and VITIS_LOOP_190_8_proc_U0_ap_idle and VITIS_LOOP_181_7_proc_U0_ap_idle);
    ap_ready <= ap_sync_ready;
    ap_sync_VITIS_LOOP_181_7_proc_U0_ap_ready <= (ap_sync_reg_VITIS_LOOP_181_7_proc_U0_ap_ready or VITIS_LOOP_181_7_proc_U0_ap_ready);
    ...
    ap_sync_channel_write_in_fft_M_value <= ((ap_channel_done_in_fft_M_value and VITIS_LOOP_181_7_proc_U0_in_fft_M_value1_full_n) or ap_sync_reg_channel_write_in_fft_M_value);
    ap_sync_channel_write_in_fft_M_value_1 <= ((ap_channel_done_in_fft_M_value_1 and VITIS_LOOP_181_7_proc_U0_in_fft_M_value_22_full_n) or ap_sync_reg_channel_write_in_fft_M_value_1);
    ...
    ap_sync_ready <= (ap_sync_entry_proc21_U0_ap_ready and ap_sync_VITIS_LOOP_181_7_proc_U0_ap_ready);
    c_fft_row_op_st_din <= VITIS_LOOP_190_8_proc_U0_c_fft_row_op_st_din;
    c_fft_row_op_st_write <= VITIS_LOOP_190_8_proc_U0_c_fft_row_op_st_write;
    c_ifmap_col_op_st_read <= VITIS_LOOP_181_7_proc_U0_c_ifmap_col_op_st_read;
