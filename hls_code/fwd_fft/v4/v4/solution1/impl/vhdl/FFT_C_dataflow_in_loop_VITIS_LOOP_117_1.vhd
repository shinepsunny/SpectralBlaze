...
entity FFT_C_dataflow_in_loop_VITIS_LOOP_117_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of FFT_C_dataflow_in_loop_VITIS_LOOP_117_1 is 
...
attribute shreg_extract : string;
    ...
    component FFT_C_stream_2_buf IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component FFT_C_fft_stage_0_0 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component FFT_C_fft_stage_1_0 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component FFT_C_fft_stage_2_0 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component FFT_C_fft_stage_3_0 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component FFT_C_fft_stage_4_0 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component FFT_C_fft_stage_5_0 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component FFT_C_buf_2_stream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component FFT_C_dataflow_in_loop_VITIS_LOOP_117_1_input_data1 IS
    generic (
        DataWidth : INTEGER;
    ...
    component FFT_C_dataflow_in_loop_VITIS_LOOP_117_1_out_data_12 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component FFT_C_dataflow_in_loop_VITIS_LOOP_117_1_out_data_67 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component FFT_C_fifo_w32_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component FFT_C_fifo_w16_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component FFT_C_fifo_w8_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    input_data1_U : component FFT_C_dataflow_in_loop_VITIS_LOOP_117_1_input_data1
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_12_U : component FFT_C_dataflow_in_loop_VITIS_LOOP_117_1_out_data_12
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_23_U : component FFT_C_dataflow_in_loop_VITIS_LOOP_117_1_out_data_12
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_34_U : component FFT_C_dataflow_in_loop_VITIS_LOOP_117_1_out_data_12
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_45_U : component FFT_C_dataflow_in_loop_VITIS_LOOP_117_1_out_data_12
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_56_U : component FFT_C_dataflow_in_loop_VITIS_LOOP_117_1_out_data_12
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_67_U : component FFT_C_dataflow_in_loop_VITIS_LOOP_117_1_out_data_67
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    stream_2_buf_U0 : component FFT_C_stream_2_buf
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage_0_0_U0 : component FFT_C_fft_stage_0_0
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage_1_0_U0 : component FFT_C_fft_stage_1_0
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage_2_0_U0 : component FFT_C_fft_stage_2_0
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage_3_0_U0 : component FFT_C_fft_stage_3_0
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage_4_0_U0 : component FFT_C_fft_stage_4_0
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage_5_0_U0 : component FFT_C_fft_stage_5_0
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    buf_2_stream_U0 : component FFT_C_buf_2_stream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    ctrl1_reg_c6_channel_U : component FFT_C_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    ctrl1_reg_c5_channel_U : component FFT_C_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ctrl1_reg_c4_channel_U : component FFT_C_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ctrl1_reg_c3_channel_U : component FFT_C_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ctrl1_reg_c2_channel_U : component FFT_C_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ctrl1_reg_c1_channel_U : component FFT_C_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ctrl1_reg_c_channel_U : component FFT_C_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
