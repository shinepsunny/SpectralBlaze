...
entity FFT_R_fft_stage_2_0_Pipeline_VITIS_LOOP_40_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of FFT_R_fft_stage_2_0_Pipeline_VITIS_LOOP_40_1 is 
...
begin
    ...
    icmp_ln1057_fu_116_p2 <= "1" when (unsigned(zext_ln1057_4_fu_112_p1) < unsigned(zext_ln40)) else "0";
