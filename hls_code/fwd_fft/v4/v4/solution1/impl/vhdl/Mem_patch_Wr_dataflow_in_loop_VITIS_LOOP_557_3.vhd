...
entity Mem_patch_Wr_dataflow_in_loop_VITIS_LOOP_557_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Mem_patch_Wr_dataflow_in_loop_VITIS_LOOP_557_3 is 
...
attribute shreg_extract : string;
    signal ifmap_CF_M_real_i_q0 : STD_LOGIC_VECTOR (1023 downto 0);
    signal ifmap_CF_M_real_t_we0 : STD_LOGIC_VECTOR (127 downto 0);
    signal ifmap_CF_M_real_t_q0 : STD_LOGIC_VECTOR (1023 downto 0);
    signal ifmap_CF_M_imag_i_q0 : STD_LOGIC_VECTOR (1023 downto 0);
    signal ifmap_CF_M_imag_t_we0 : STD_LOGIC_VECTOR (127 downto 0);
    signal ifmap_CF_M_imag_t_q0 : STD_LOGIC_VECTOR (1023 downto 0);
    signal VITIS_LOOP_561_4_proc_U0_ap_start : STD_LOGIC;
    signal VITIS_LOOP_561_4_proc_U0_ap_done : STD_LOGIC;
    signal VITIS_LOOP_561_4_proc_U0_ap_continue : STD_LOGIC;
    signal VITIS_LOOP_561_4_proc_U0_ap_idle : STD_LOGIC;
    signal VITIS_LOOP_561_4_proc_U0_ap_ready : STD_LOGIC;
    signal VITIS_LOOP_561_4_proc_U0_ifmap_CF_M_real1_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal VITIS_LOOP_561_4_proc_U0_ifmap_CF_M_real1_ce0 : STD_LOGIC;
    signal VITIS_LOOP_561_4_proc_U0_ifmap_CF_M_real1_we0 : STD_LOGIC_VECTOR (127 downto 0);
    signal VITIS_LOOP_561_4_proc_U0_ifmap_CF_M_real1_d0 : STD_LOGIC_VECTOR (1023 downto 0);
    signal VITIS_LOOP_561_4_proc_U0_ifmap_CF_M_imag2_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal VITIS_LOOP_561_4_proc_U0_ifmap_CF_M_imag2_ce0 : STD_LOGIC;
    signal VITIS_LOOP_561_4_proc_U0_ifmap_CF_M_imag2_we0 : STD_LOGIC_VECTOR (127 downto 0);
    signal VITIS_LOOP_561_4_proc_U0_ifmap_CF_M_imag2_d0 : STD_LOGIC_VECTOR (1023 downto 0);
    signal VITIS_LOOP_561_4_proc_U0_c_fft_col_op_st_V_read : STD_LOGIC;
    signal VITIS_LOOP_561_4_proc_U0_ap_return : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal VITIS_LOOP_561_4_proc_U0_ifmap_CF_M_imag2_full_n : STD_LOGIC;
    ...
    signal VITIS_LOOP_561_4_proc_U0_ifmap_CF_M_real1_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_ifmap_CF_M_real : STD_LOGIC := '0';
    signal ap_sync_channel_write_ifmap_CF_M_real : STD_LOGIC;
    signal VITIS_LOOP_570_6_proc_U0_ap_start : STD_LOGIC;
    signal VITIS_LOOP_570_6_proc_U0_ap_done : STD_LOGIC;
    signal VITIS_LOOP_570_6_proc_U0_ap_continue : STD_LOGIC;
    signal VITIS_LOOP_570_6_proc_U0_ap_idle : STD_LOGIC;
    signal VITIS_LOOP_570_6_proc_U0_ap_ready : STD_LOGIC;
    signal VITIS_LOOP_570_6_proc_U0_ifmap_CF_M_real1_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal VITIS_LOOP_570_6_proc_U0_ifmap_CF_M_real1_ce0 : STD_LOGIC;
    signal VITIS_LOOP_570_6_proc_U0_ifmap_CF_M_imag2_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal VITIS_LOOP_570_6_proc_U0_ifmap_CF_M_imag2_ce0 : STD_LOGIC;
    signal VITIS_LOOP_570_6_proc_U0_fft_out : STD_LOGIC_VECTOR (127 downto 0);
    signal VITIS_LOOP_570_6_proc_U0_fft_out_ap_vld : STD_LOGIC;
    ...
    component Mem_patch_Wr_VITIS_LOOP_561_4_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Mem_patch_Wr_VITIS_LOOP_570_6_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Mem_patch_Wr_dataflow_in_loop_VITIS_LOOP_557_3_ifmap_CF_M_real IS
    generic (
        DataWidth : INTEGER;
...
begin
    ifmap_CF_M_real_U : component Mem_patch_Wr_dataflow_in_loop_VITIS_LOOP_557_3_ifmap_CF_M_real
    generic map (
        DataWidth => 1024,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    ifmap_CF_M_imag_U : component Mem_patch_Wr_dataflow_in_loop_VITIS_LOOP_557_3_ifmap_CF_M_real
    generic map (
        DataWidth => 1024,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    VITIS_LOOP_561_4_proc_U0 : component Mem_patch_Wr_VITIS_LOOP_561_4_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    VITIS_LOOP_570_6_proc_U0 : component Mem_patch_Wr_VITIS_LOOP_570_6_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    ctrl1_reg_c_channel_U : component Mem_patch_Wr_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((VITIS_LOOP_561_4_proc_U0_ap_done and VITIS_LOOP_561_4_proc_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_ctrl1_reg_c_channel <= ap_const_logic_0;
                else 
    ...
    VITIS_LOOP_561_4_proc_U0_ap_continue <= (ap_sync_channel_write_ifmap_CF_M_real and ap_sync_channel_write_ifmap_CF_M_imag and ap_sync_channel_write_ctrl1_reg_c_channel);
    VITIS_LOOP_561_4_proc_U0_ap_start <= ap_start;
    VITIS_LOOP_561_4_proc_U0_ifmap_CF_M_imag2_full_n <= ifmap_CF_M_imag_i_full_n;
    VITIS_LOOP_561_4_proc_U0_ifmap_CF_M_real1_full_n <= ifmap_CF_M_real_i_full_n;
    VITIS_LOOP_570_6_proc_U0_ap_continue <= ap_continue;
    VITIS_LOOP_570_6_proc_U0_ap_start <= (ifmap_CF_M_real_t_empty_n and ifmap_CF_M_imag_t_empty_n and ctrl1_reg_c_channel_empty_n);
    ap_channel_done_ctrl1_reg_c_channel <= ((ap_sync_reg_channel_write_ctrl1_reg_c_channel xor ap_const_logic_1) and VITIS_LOOP_561_4_proc_U0_ap_done);
    ap_channel_done_ifmap_CF_M_imag <= ((ap_sync_reg_channel_write_ifmap_CF_M_imag xor ap_const_logic_1) and VITIS_LOOP_561_4_proc_U0_ap_done);
    ap_channel_done_ifmap_CF_M_real <= ((ap_sync_reg_channel_write_ifmap_CF_M_real xor ap_const_logic_1) and VITIS_LOOP_561_4_proc_U0_ap_done);
    ap_done <= VITIS_LOOP_570_6_proc_U0_ap_done;
    ap_idle <= ((ctrl1_reg_c_channel_empty_n xor ap_const_logic_1) and (ifmap_CF_M_imag_t_empty_n xor ap_const_logic_1) and (ifmap_CF_M_real_t_empty_n xor ap_const_logic_1) and VITIS_LOOP_570_6_proc_U0_ap_idle and VITIS_LOOP_561_4_proc_U0_ap_idle);
    ap_ready <= VITIS_LOOP_561_4_proc_U0_ap_ready;
    ...
    ap_sync_channel_write_ifmap_CF_M_imag <= ((ap_channel_done_ifmap_CF_M_imag and VITIS_LOOP_561_4_proc_U0_ifmap_CF_M_imag2_full_n) or ap_sync_reg_channel_write_ifmap_CF_M_imag);
    ap_sync_channel_write_ifmap_CF_M_real <= ((ap_channel_done_ifmap_CF_M_real and VITIS_LOOP_561_4_proc_U0_ifmap_CF_M_real1_full_n) or ap_sync_reg_channel_write_ifmap_CF_M_real);
    c_fft_col_op_st_V_read <= VITIS_LOOP_561_4_proc_U0_c_fft_col_op_st_V_read;
    fft_out <= VITIS_LOOP_570_6_proc_U0_fft_out;
    fft_out_ap_vld <= VITIS_LOOP_570_6_proc_U0_fft_out_ap_vld;
