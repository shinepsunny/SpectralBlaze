...
entity fwd_fft_VITIS_LOOP_257_8_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_VITIS_LOOP_257_8_proc is 
...
attribute shreg_extract : string;
    ...
    signal or_ln262_reg_251 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_fu_138_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_reg_246 : STD_LOGIC_VECTOR (7 downto 0);
    signal or_ln262_fu_186_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln257_fu_211_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln257_reg_258 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal icmp_ln262_fu_180_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif ((not(((c_fft_row_op_st_full_n = ap_const_logic_0) or ((or_ln262_reg_251 = ap_const_lv1_0) and (ap_const_logic_0 = Row_Buffer_full_n)))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                x_fu_70 <= add_ln257_reg_258;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                add_ln257_reg_258 <= add_ln257_fu_211_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                ...
                or_ln262_reg_251 <= or_ln262_fu_186_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, ctrl1_reg_empty_n, c_fft_row_op_st_full_n, Row_Buffer_full_n, ap_CS_fsm_state3, or_ln262_reg_251, ap_CS_fsm_state2, icmp_ln1057_fu_206_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if ((not(((c_fft_row_op_st_full_n = ap_const_logic_0) or ((or_ln262_reg_251 = ap_const_lv1_0) and (ap_const_logic_0 = Row_Buffer_full_n)))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state3;
                end if;
    ...
    Row_Buffer_blk_n_assign_proc : process(Row_Buffer_full_n, ap_CS_fsm_state3, or_ln262_reg_251)
    begin
        if (((or_ln262_reg_251 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    Row_Buffer_write_assign_proc : process(c_fft_row_op_st_full_n, Row_Buffer_full_n, ap_CS_fsm_state3, or_ln262_reg_251)
    begin
        if ((not(((c_fft_row_op_st_full_n = ap_const_logic_0) or ((or_ln262_reg_251 = ap_const_lv1_0) and (ap_const_logic_0 = Row_Buffer_full_n)))) and (or_ln262_reg_251 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    add_ln257_fu_211_p2 <= std_logic_vector(unsigned(x_fu_70) + unsigned(ap_const_lv8_1));
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(c_fft_row_op_st_full_n, Row_Buffer_full_n, or_ln262_reg_251)
    begin
        if (((c_fft_row_op_st_full_n = ap_const_logic_0) or ((or_ln262_reg_251 = ap_const_lv1_0) and (ap_const_logic_0 = Row_Buffer_full_n)))) then 
    ...
    ap_block_state3_assign_proc : process(c_fft_row_op_st_full_n, Row_Buffer_full_n, or_ln262_reg_251)
    begin
                ap_block_state3 <= ((c_fft_row_op_st_full_n = ap_const_logic_0) or ((or_ln262_reg_251 = ap_const_lv1_0) and (ap_const_logic_0 = Row_Buffer_full_n)));
    end process;
    ...
    c_fft_row_op_st_write_assign_proc : process(c_fft_row_op_st_full_n, Row_Buffer_full_n, ap_CS_fsm_state3, or_ln262_reg_251)
    begin
        if ((not(((c_fft_row_op_st_full_n = ap_const_logic_0) or ((or_ln262_reg_251 = ap_const_lv1_0) and (ap_const_logic_0 = Row_Buffer_full_n)))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    icmp_ln262_fu_180_p2 <= "1" when (signed(zext_ln1061_fu_176_p1) > signed(p_read2)) else "0";
    lshr_ln_fu_166_p4 <= ctrl1_reg_dout(31 downto 24);
    or_ln262_fu_186_p2 <= (icmp_ln262_fu_180_p2 or cmp_i_i_fu_160_p2);
