...
entity fwd_fft_dataflow_in_loop_VITIS_LOOP_469_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    c_fft_col_op_st_dout : IN STD_LOGIC_VECTOR (63 downto 0);
...
architecture behav of fwd_fft_dataflow_in_loop_VITIS_LOOP_469_3 is 
...
attribute shreg_extract : string;
    signal ifmap_CF_M_value_i_q0 : STD_LOGIC_VECTOR (63 downto 0);
    signal ifmap_CF_M_value_i_q1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ifmap_CF_M_value_t_we0 : STD_LOGIC_VECTOR (7 downto 0);
    signal ifmap_CF_M_value_t_q0 : STD_LOGIC_VECTOR (63 downto 0);
    signal ifmap_CF_M_value_t_q1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ifmap_CF_M_value_1_i_q0 : STD_LOGIC_VECTOR (63 downto 0);
    signal ifmap_CF_M_value_1_i_q1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ifmap_CF_M_value_1_t_we0 : STD_LOGIC_VECTOR (7 downto 0);
    signal ifmap_CF_M_value_1_t_q0 : STD_LOGIC_VECTOR (63 downto 0);
    signal ifmap_CF_M_value_1_t_q1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal ifmap_gen_y_U0_ifmap_CF_0_address0 : STD_LOGIC_VECTOR (10 downto 0);
    signal ifmap_gen_y_U0_ifmap_CF_0_ce0 : STD_LOGIC;
    signal ifmap_gen_y_U0_ifmap_CF_0_we0 : STD_LOGIC_VECTOR (7 downto 0);
    signal ifmap_gen_y_U0_ifmap_CF_0_d0 : STD_LOGIC_VECTOR (63 downto 0);
    signal ifmap_gen_y_U0_ifmap_CF_1_address0 : STD_LOGIC_VECTOR (10 downto 0);
    signal ifmap_gen_y_U0_ifmap_CF_1_ce0 : STD_LOGIC;
    signal ifmap_gen_y_U0_ifmap_CF_1_we0 : STD_LOGIC_VECTOR (7 downto 0);
    signal ifmap_gen_y_U0_ifmap_CF_1_d0 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal ap_channel_done_ifmap_CF_M_value_1 : STD_LOGIC;
    signal ifmap_gen_y_U0_ifmap_CF_1_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_ifmap_CF_M_value_1 : STD_LOGIC := '0';
    signal ap_sync_channel_write_ifmap_CF_M_value_1 : STD_LOGIC;
    signal ap_channel_done_ifmap_CF_M_value : STD_LOGIC;
    signal ifmap_gen_y_U0_ifmap_CF_0_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_ifmap_CF_M_value : STD_LOGIC := '0';
    signal ap_sync_channel_write_ifmap_CF_M_value : STD_LOGIC;
    ...
    signal ifmap_vec_write_U0_ifmap_CF_0_address0 : STD_LOGIC_VECTOR (10 downto 0);
    signal ifmap_vec_write_U0_ifmap_CF_0_ce0 : STD_LOGIC;
    signal ifmap_vec_write_U0_ifmap_CF_0_address1 : STD_LOGIC_VECTOR (10 downto 0);
    signal ifmap_vec_write_U0_ifmap_CF_0_ce1 : STD_LOGIC;
    signal ifmap_vec_write_U0_ifmap_CF_1_address0 : STD_LOGIC_VECTOR (10 downto 0);
    signal ifmap_vec_write_U0_ifmap_CF_1_ce0 : STD_LOGIC;
    signal ifmap_vec_write_U0_ifmap_CF_1_address1 : STD_LOGIC_VECTOR (10 downto 0);
    signal ifmap_vec_write_U0_ifmap_CF_1_ce1 : STD_LOGIC;
    ...
    signal ifmap_vec_write_U0_m_axi_gmem_WDATA : STD_LOGIC_VECTOR (255 downto 0);
    signal ifmap_vec_write_U0_m_axi_gmem_WSTRB : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal ifmap_CF_M_value_i_full_n : STD_LOGIC;
    signal ifmap_CF_M_value_t_empty_n : STD_LOGIC;
    signal ifmap_CF_M_value_1_i_full_n : STD_LOGIC;
    signal ifmap_CF_M_value_1_t_empty_n : STD_LOGIC;
    ...
    port (
        ...
        ifmap_CF_0_we0 : OUT STD_LOGIC_VECTOR (7 downto 0);
        ifmap_CF_0_d0 : OUT STD_LOGIC_VECTOR (63 downto 0);
        ifmap_CF_1_address0 : OUT STD_LOGIC_VECTOR (10 downto 0);
        ifmap_CF_1_ce0 : OUT STD_LOGIC;
        ifmap_CF_1_we0 : OUT STD_LOGIC_VECTOR (7 downto 0);
        ifmap_CF_1_d0 : OUT STD_LOGIC_VECTOR (63 downto 0);
        p_read : IN STD_LOGIC_VECTOR (7 downto 0);
    ...
    component fwd_fft_dataflow_in_loop_VITIS_LOOP_469_3_ifmap_CF_M_value IS
    generic (
        DataWidth : INTEGER;
    ...
    port (
        ...
        i_ce0 : IN STD_LOGIC;
        i_we0 : IN STD_LOGIC_VECTOR (7 downto 0);
        ...
        t_ce0 : IN STD_LOGIC;
        t_we0 : IN STD_LOGIC_VECTOR (7 downto 0);
    ...
    component fwd_fft_fifo_w8_d2_S_x1 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ifmap_CF_M_value_U : component fwd_fft_dataflow_in_loop_VITIS_LOOP_469_3_ifmap_CF_M_value
    generic map (
        DataWidth => 64,
        AddressRange => 2048,
        AddressWidth => 11)
    port map (
        clk => ap_clk,
        reset => ap_rst,
        i_address0 => ifmap_gen_y_U0_ifmap_CF_0_address0,
        i_ce0 => ifmap_gen_y_U0_ifmap_CF_0_ce0,
        i_we0 => ifmap_gen_y_U0_ifmap_CF_0_we0,
        i_d0 => ifmap_gen_y_U0_ifmap_CF_0_d0,
        i_q0 => ifmap_CF_M_value_i_q0,
        i_address1 => ap_const_lv11_0,
        i_ce1 => ap_const_logic_0,
        i_q1 => ifmap_CF_M_value_i_q1,
        t_address0 => ifmap_vec_write_U0_ifmap_CF_0_address0,
        t_ce0 => ifmap_vec_write_U0_ifmap_CF_0_ce0,
        t_we0 => ifmap_CF_M_value_t_we0,
        t_d0 => ap_const_lv64_0,
        t_q0 => ifmap_CF_M_value_t_q0,
        t_address1 => ifmap_vec_write_U0_ifmap_CF_0_address1,
        t_ce1 => ifmap_vec_write_U0_ifmap_CF_0_ce1,
        t_q1 => ifmap_CF_M_value_t_q1,
        i_ce => ap_const_logic_1,
        t_ce => ap_const_logic_1,
        i_full_n => ifmap_CF_M_value_i_full_n,
        i_write => ap_channel_done_ifmap_CF_M_value,
        t_empty_n => ifmap_CF_M_value_t_empty_n,
        t_read => ifmap_vec_write_U0_ap_ready);

    ifmap_CF_M_value_1_U : component fwd_fft_dataflow_in_loop_VITIS_LOOP_469_3_ifmap_CF_M_value
    generic map (
        DataWidth => 64,
        AddressRange => 2048,
        AddressWidth => 11)
    port map (
        clk => ap_clk,
        reset => ap_rst,
        i_address0 => ifmap_gen_y_U0_ifmap_CF_1_address0,
        i_ce0 => ifmap_gen_y_U0_ifmap_CF_1_ce0,
        i_we0 => ifmap_gen_y_U0_ifmap_CF_1_we0,
        i_d0 => ifmap_gen_y_U0_ifmap_CF_1_d0,
        i_q0 => ifmap_CF_M_value_1_i_q0,
        i_address1 => ap_const_lv11_0,
        i_ce1 => ap_const_logic_0,
        i_q1 => ifmap_CF_M_value_1_i_q1,
        t_address0 => ifmap_vec_write_U0_ifmap_CF_1_address0,
        t_ce0 => ifmap_vec_write_U0_ifmap_CF_1_ce0,
        t_we0 => ifmap_CF_M_value_1_t_we0,
        t_d0 => ap_const_lv64_0,
        t_q0 => ifmap_CF_M_value_1_t_q0,
        t_address1 => ifmap_vec_write_U0_ifmap_CF_1_address1,
        t_ce1 => ifmap_vec_write_U0_ifmap_CF_1_ce1,
        t_q1 => ifmap_CF_M_value_1_t_q1,
        i_ce => ap_const_logic_1,
        t_ce => ap_const_logic_1,
        i_full_n => ifmap_CF_M_value_1_i_full_n,
        i_write => ap_channel_done_ifmap_CF_M_value_1,
        t_empty_n => ifmap_CF_M_value_1_t_empty_n,
        t_read => ifmap_vec_write_U0_ap_ready);
    ...
    port map (
        ...
        ifmap_CF_0_address0 => ifmap_gen_y_U0_ifmap_CF_0_address0,
        ifmap_CF_0_ce0 => ifmap_gen_y_U0_ifmap_CF_0_ce0,
        ifmap_CF_0_we0 => ifmap_gen_y_U0_ifmap_CF_0_we0,
        ifmap_CF_0_d0 => ifmap_gen_y_U0_ifmap_CF_0_d0,
        ifmap_CF_1_address0 => ifmap_gen_y_U0_ifmap_CF_1_address0,
        ifmap_CF_1_ce0 => ifmap_gen_y_U0_ifmap_CF_1_ce0,
        ifmap_CF_1_we0 => ifmap_gen_y_U0_ifmap_CF_1_we0,
        ifmap_CF_1_d0 => ifmap_gen_y_U0_ifmap_CF_1_d0,
        p_read => p_read,
    ...
    port map (
        ...
        ifmap_CF_0_address0 => ifmap_vec_write_U0_ifmap_CF_0_address0,
        ifmap_CF_0_ce0 => ifmap_vec_write_U0_ifmap_CF_0_ce0,
        ifmap_CF_0_q0 => ifmap_CF_M_value_t_q0,
        ifmap_CF_0_address1 => ifmap_vec_write_U0_ifmap_CF_0_address1,
        ifmap_CF_0_ce1 => ifmap_vec_write_U0_ifmap_CF_0_ce1,
        ifmap_CF_0_q1 => ifmap_CF_M_value_t_q1,
        ifmap_CF_1_address0 => ifmap_vec_write_U0_ifmap_CF_1_address0,
        ifmap_CF_1_ce0 => ifmap_vec_write_U0_ifmap_CF_1_ce0,
        ifmap_CF_1_q0 => ifmap_CF_M_value_1_t_q0,
        ifmap_CF_1_address1 => ifmap_vec_write_U0_ifmap_CF_1_address1,
        ifmap_CF_1_ce1 => ifmap_vec_write_U0_ifmap_CF_1_ce1,
        ifmap_CF_1_q1 => ifmap_CF_M_value_1_t_q1,
    ...
    ctrl1_reg_c_channel1_U : component fwd_fft_fifo_w8_d2_S_x1
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_channel_write_ifmap_CF_M_value_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_channel_write_ifmap_CF_M_value <= ap_const_logic_0;
            else
                if (((ifmap_gen_y_U0_ap_done and ifmap_gen_y_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_ifmap_CF_M_value <= ap_const_logic_0;
                else 
                    ap_sync_reg_channel_write_ifmap_CF_M_value <= ap_sync_channel_write_ifmap_CF_M_value;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_reg_channel_write_ifmap_CF_M_value_1_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_channel_write_ifmap_CF_M_value_1 <= ap_const_logic_0;
            else
                if (((ifmap_gen_y_U0_ap_done and ifmap_gen_y_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_ifmap_CF_M_value_1 <= ap_const_logic_0;
                else 
                    ap_sync_reg_channel_write_ifmap_CF_M_value_1 <= ap_sync_channel_write_ifmap_CF_M_value_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_channel_done_ifmap_CF_M_value <= (ifmap_gen_y_U0_ap_done and (ap_sync_reg_channel_write_ifmap_CF_M_value xor ap_const_logic_1));
    ap_channel_done_ifmap_CF_M_value_1 <= (ifmap_gen_y_U0_ap_done and (ap_sync_reg_channel_write_ifmap_CF_M_value_1 xor ap_const_logic_1));
    ap_done <= ifmap_vec_write_U0_ap_done;
    ap_idle <= (ifmap_vec_write_U0_ap_idle and ifmap_gen_y_U0_ap_idle and (ctrl1_reg_c_channel1_empty_n xor ap_const_logic_1) and (fft_out_c_channel_empty_n xor ap_const_logic_1) and (ifmap_CF_M_value_1_t_empty_n xor ap_const_logic_1) and (ifmap_CF_M_value_t_empty_n xor ap_const_logic_1) and entry_proc_U0_ap_idle);
    ...
    ap_sync_channel_write_ifmap_CF_M_value <= ((ifmap_gen_y_U0_ifmap_CF_0_full_n and ap_channel_done_ifmap_CF_M_value) or ap_sync_reg_channel_write_ifmap_CF_M_value);
    ap_sync_channel_write_ifmap_CF_M_value_1 <= ((ifmap_gen_y_U0_ifmap_CF_1_full_n and ap_channel_done_ifmap_CF_M_value_1) or ap_sync_reg_channel_write_ifmap_CF_M_value_1);
    ...
    ifmap_CF_M_value_1_t_we0 <= (0=>ap_const_logic_0, others=>'-');
    ifmap_CF_M_value_t_we0 <= (0=>ap_const_logic_0, others=>'-');
    ifmap_gen_y_U0_ap_continue <= (ap_sync_channel_write_ifmap_CF_M_value_1 and ap_sync_channel_write_ifmap_CF_M_value and ap_sync_channel_write_ctrl1_reg_c_channel1);
    ifmap_gen_y_U0_ap_start <= ((ap_sync_reg_ifmap_gen_y_U0_ap_ready xor ap_const_logic_1) and ap_start);
    ifmap_gen_y_U0_ifmap_CF_0_full_n <= ifmap_CF_M_value_i_full_n;
    ifmap_gen_y_U0_ifmap_CF_1_full_n <= ifmap_CF_M_value_1_i_full_n;
    ifmap_vec_write_U0_ap_continue <= ap_continue;
    ifmap_vec_write_U0_ap_start <= (ifmap_CF_M_value_t_empty_n and ifmap_CF_M_value_1_t_empty_n and fft_out_c_channel_empty_n and ctrl1_reg_c_channel1_empty_n);
