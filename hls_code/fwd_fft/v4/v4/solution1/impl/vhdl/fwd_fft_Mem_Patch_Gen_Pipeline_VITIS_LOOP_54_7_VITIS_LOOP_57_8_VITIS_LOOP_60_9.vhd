...
entity fwd_fft_Mem_Patch_Gen_Pipeline_VITIS_LOOP_54_7_VITIS_LOOP_57_8_VITIS_LOOP_60_9 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_Mem_Patch_Gen_Pipeline_VITIS_LOOP_54_7_VITIS_LOOP_57_8_VITIS_LOOP_60_9 is 
...
attribute shreg_extract : string;
    ...
    signal p_cast2_cast_cast_fu_213_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal p_cast2_cast_cast_reg_795 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal icmp_ln1057_7_fu_278_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln1057_7_reg_804 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln1057_7_reg_804_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln1057_7_reg_804_pp0_iter3_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal y_4_reg_818 : STD_LOGIC_VECTOR (7 downto 0);
    signal rev20_fu_341_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal rev20_reg_823 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln13_3_fu_362_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln13_3_reg_828 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln57_fu_368_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln57_reg_834 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_i_i_mid1_fu_391_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal add_i_i_mid1_reg_839 : STD_LOGIC_VECTOR (15 downto 0);
    signal or_ln64_fu_490_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln64_reg_849 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln64_reg_849_pp0_iter5_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln130_fu_550_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln130_reg_875 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal select_ln1057_4_fu_396_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal indvar_flatten_fu_120 : STD_LOGIC_VECTOR (15 downto 0);
    signal select_ln1057_5_fu_301_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal pnx_fu_124 : STD_LOGIC_VECTOR (7 downto 0);
    signal select_ln13_1_fu_283_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal icmp_ln1057_8_fu_357_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln13_fu_350_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal select_ln13_4_fu_441_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal select_ln1057_2_fu_448_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal ult21_fu_463_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal rev22_fu_467_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln13_2_fu_430_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_fu_700_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal icmp_ln64_fu_480_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln64_fu_484_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln1057_3_fu_473_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_21_cast_fu_455_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal trunc_ln54_2_fu_496_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal add_ln54_fu_500_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal or_ln130_fu_520_p2 : STD_LOGIC_VECTOR (35 downto 0);
    ...
    signal icmp_ln68_fu_562_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln69_fu_568_p2 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal select_ln64_fu_677_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal select_ln64_1_fu_684_p3 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    indvar_flatten_fu_120 <= select_ln1057_5_fu_301_p3;
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    ...
                    y_fu_116 <= select_ln1057_4_fu_396_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln1057_reg_800_pp0_iter2_reg = ap_const_lv1_0))) then
                ...
                add_ln57_reg_834 <= add_ln57_fu_368_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                ...
                icmp_ln1057_7_reg_804_pp0_iter2_reg <= icmp_ln1057_7_reg_804;
                icmp_ln1057_7_reg_804_pp0_iter3_reg <= icmp_ln1057_7_reg_804_pp0_iter2_reg;
                icmp_ln1057_reg_800_pp0_iter2_reg <= icmp_ln1057_reg_800;
                icmp_ln130_reg_875 <= icmp_ln130_fu_550_p2;
                or_ln64_reg_849 <= or_ln64_fu_490_p2;
                or_ln64_reg_849_pp0_iter5_reg <= or_ln64_reg_849;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                icmp_ln1057_reg_800 <= icmp_ln1057_fu_255_p2;
                    p_cast2_cast_cast_reg_795(7 downto 0) <= p_cast2_cast_cast_fu_213_p1(7 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1057_fu_255_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln1057_7_reg_804 <= icmp_ln1057_7_fu_278_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln1057_7_reg_804_pp0_iter2_reg = ap_const_lv1_0))) then
                rev20_reg_823 <= rev20_fu_341_p2;
            end if;
        end if;
    end process;
    p_cast2_cast_cast_reg_795(15 downto 8) <= "00000000";
    ...
    add_i_i_fu_331_p2 <= std_logic_vector(unsigned(mul_i_i) + unsigned(y_cast_fu_327_p1));
    add_i_i_mid1_fu_391_p2 <= std_logic_vector(unsigned(mul_i_i) + unsigned(y_cast_mid1_fu_387_p1));
    ...
    add_ln54_fu_500_p2 <= std_logic_vector(unsigned(tmp_21_cast_fu_455_p3) + unsigned(trunc_ln54_2_fu_496_p1));
    add_ln57_fu_368_p2 <= std_logic_vector(unsigned(select_ln13_fu_350_p3) + unsigned(ap_const_lv8_1));
    add_ln69_fu_568_p2 <= std_logic_vector(unsigned(rd_i_1_fu_108) + unsigned(ap_const_lv32_1));
    ...
    c_ifmap_patch_st_din <= (select_ln64_fu_677_p3 & select_ln64_1_fu_684_p3);
    ...
    grp_fu_700_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln13_1_fu_283_p3),16));
    grp_fu_700_p1 <= p_cast2_cast_cast_reg_795(8 - 1 downto 0);
    ...
    icmp_ln1057_7_fu_278_p2 <= "1" when (indvar_flatten_fu_120 = bound) else "0";
    icmp_ln1057_8_fu_357_p2 <= "1" when (lhs_fu_104 = p_cast5) else "0";
    icmp_ln1057_fu_255_p2 <= "1" when (indvar_flatten23_fu_128 = bound4) else "0";
    icmp_ln130_fu_550_p2 <= "0" when (tmp_fu_540_p4 = ap_const_lv58_0) else "1";
    icmp_ln64_fu_480_p2 <= "1" when (unsigned(grp_fu_700_p3) < unsigned(p_cast)) else "0";
    icmp_ln68_fu_562_p2 <= "1" when (rd_j_2_fu_556_p2 = ap_const_lv32_8) else "0";
    ...
    or_ln1057_fu_374_p2 <= (select_ln13_3_fu_362_p3 or icmp_ln1057_7_reg_804_pp0_iter2_reg);
    or_ln130_fu_520_p2 <= (shl_ln2_fu_512_p3 or ap_const_lv36_F);
    or_ln64_fu_490_p2 <= (xor_ln64_fu_484_p2 or select_ln1057_3_fu_473_p3);
    p_cast2_cast_cast_fu_213_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_cast2_cast),16));
    pnx_5_fu_272_p2 <= std_logic_vector(unsigned(pnx_fu_124) + unsigned(ap_const_lv8_1));
    rd_i_2_fu_574_p3 <= 
        add_ln69_fu_568_p2 when (icmp_ln68_fu_562_p2(0) = '1') else 
        rd_i_1_fu_108;
    rd_i_fu_590_p3 <= 
        rd_i_1_fu_108 when (or_ln64_fu_490_p2(0) = '1') else 
        rd_i_2_fu_574_p3;
    rd_j_2_fu_556_p2 <= std_logic_vector(unsigned(rd_j_1_fu_112) + unsigned(ap_const_lv32_1));
    rd_j_3_fu_582_p3 <= 
        ap_const_lv32_0 when (icmp_ln68_fu_562_p2(0) = '1') else 
        rd_j_2_fu_556_p2;
    rd_j_fu_598_p3 <= 
        rd_j_1_fu_112 when (or_ln64_fu_490_p2(0) = '1') else 
        rd_j_3_fu_582_p3;
    rev20_fu_341_p2 <= (ult_fu_336_p2 xor ap_const_lv1_1);
    rev22_fu_467_p2 <= (ult21_fu_463_p2 xor ap_const_lv1_1);
    select_ln1057_2_fu_448_p3 <= 
        trunc_ln54_fu_435_p1 when (select_ln13_3_reg_828(0) = '1') else 
        select_ln13_4_fu_441_p3;
    select_ln1057_3_fu_473_p3 <= 
        rev22_fu_467_p2 when (select_ln13_3_reg_828(0) = '1') else 
        select_ln13_2_fu_430_p3;
    select_ln1057_4_fu_396_p3 <= 
        add_ln57_fu_368_p2 when (select_ln13_3_fu_362_p3(0) = '1') else 
        select_ln13_fu_350_p3;
    select_ln1057_5_fu_301_p3 <= 
        ap_const_lv16_1 when (icmp_ln1057_7_fu_278_p2(0) = '1') else 
        add_ln1057_fu_295_p2;
    select_ln1057_fu_379_p3 <= 
        ap_const_lv8_0 when (or_ln1057_fu_374_p2(0) = '1') else 
        lhs_fu_104;
    select_ln130_fu_632_p3 <= 
        ap_const_lv128_lc_1 when (icmp_ln130_reg_875(0) = '1') else 
        shl_ln130_fu_626_p2;
    select_ln13_1_fu_283_p3 <= 
        pnx_5_fu_272_p2 when (icmp_ln1057_7_fu_278_p2(0) = '1') else 
        pnx_fu_124;
    select_ln13_2_fu_430_p3 <= 
        cmp_i_not_mid119 when (icmp_ln1057_7_reg_804_pp0_iter3_reg(0) = '1') else 
        rev20_reg_823;
    select_ln13_3_fu_362_p3 <= 
        icmp_ln1057_9 when (icmp_ln1057_7_reg_804_pp0_iter2_reg(0) = '1') else 
        icmp_ln1057_8_fu_357_p2;
    select_ln13_4_fu_441_p3 <= 
        ap_const_lv6_0 when (icmp_ln1057_7_reg_804_pp0_iter3_reg(0) = '1') else 
        trunc_ln54_1_fu_438_p1;
    select_ln13_fu_350_p3 <= 
        ap_const_lv8_0 when (icmp_ln1057_7_reg_804_pp0_iter2_reg(0) = '1') else 
        y_fu_116;
    select_ln64_1_fu_684_p3 <= 
        ap_const_lv16_0 when (or_ln64_reg_849_pp0_iter5_reg(0) = '1') else 
        trunc_ln130_fu_660_p1;
    select_ln64_fu_677_p3 <= 
        ap_const_lv16_0 when (or_ln64_reg_849_pp0_iter5_reg(0) = '1') else 
        trunc_ln130_1_fu_673_p1;
        sext_ln130_1_fu_526_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(or_ln130_fu_520_p2),64));
    ...
    tmp_21_cast_fu_455_p3 <= (select_ln1057_2_fu_448_p3 & ap_const_lv5_0);
    ...
    trunc_ln54_1_fu_438_p1 <= y_4_reg_818(6 - 1 downto 0);
    trunc_ln54_2_fu_496_p1 <= rd_i_1_fu_108(11 - 1 downto 0);
    trunc_ln54_fu_435_p1 <= add_ln57_reg_834(6 - 1 downto 0);
    ...
    xor_ln64_fu_484_p2 <= (icmp_ln64_fu_480_p2 xor ap_const_lv1_1);
    y_cast_fu_327_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(y_fu_116),16));
    y_cast_mid1_fu_387_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln57_fu_368_p2),16));
