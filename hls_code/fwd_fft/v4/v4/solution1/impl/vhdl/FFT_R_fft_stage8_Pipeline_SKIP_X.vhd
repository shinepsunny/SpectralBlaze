...
entity FFT_R_fft_stage8_Pipeline_SKIP_X is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of FFT_R_fft_stage8_Pipeline_SKIP_X is 
...
begin
    w_M_real15_U : component FFT_R_fft_stage5_Pipeline_SKIP_X_w_M_real18
    generic map (
        DataWidth => 16,
        AddressRange => 192,
        AddressWidth => 8)
    ...
    w_M_imag10_U : component FFT_R_fft_stage5_Pipeline_SKIP_X_w_M_imag13
    generic map (
        DataWidth => 16,
        AddressRange => 192,
        AddressWidth => 8)
    ...
    hadd_16ns_16ns_16_2_full_dsp_1_U83 : component FFT_R_hadd_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hadd_16ns_16ns_16_2_full_dsp_1_U84 : component FFT_R_hadd_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hadd_16ns_16ns_16_2_full_dsp_1_U85 : component FFT_R_hadd_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hsub_16ns_16ns_16_2_full_dsp_1_U86 : component FFT_R_hsub_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hsub_16ns_16ns_16_2_full_dsp_1_U87 : component FFT_R_hsub_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hsub_16ns_16ns_16_2_full_dsp_1_U88 : component FFT_R_hsub_16ns_16ns_16_2_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_2_max_dsp_1_U89 : component FFT_R_hmul_16ns_16ns_16_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_2_max_dsp_1_U90 : component FFT_R_hmul_16ns_16ns_16_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_2_max_dsp_1_U91 : component FFT_R_hmul_16ns_16ns_16_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    hmul_16ns_16ns_16_2_max_dsp_1_U92 : component FFT_R_hmul_16ns_16ns_16_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    add_ln21_fu_257_p2 <= std_logic_vector(unsigned(trunc_ln1057_2_fu_237_p1) + unsigned(trunc_ln1057_fu_233_p1));
    ...
    j1_5_fu_298_p3 <= 
        ...
        j1_fu_64;
    j1_6_fu_314_p3 <= 
        j1_4_fu_280_p2 when (icmp_ln26_fu_274_p2(0) = '1') else 
        j1_5_fu_298_p3;
    ...
    w_M_imag10_address0 <= zext_ln20_fu_251_p1(8 - 1 downto 0);
