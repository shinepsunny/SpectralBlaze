...
entity fwd_fft_VITIS_LOOP_190_8_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_VITIS_LOOP_190_8_proc is 
...
attribute shreg_extract : string;
    ...
    signal or_ln195_reg_257 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln156_fu_130_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln156_reg_252 : STD_LOGIC_VECTOR (7 downto 0);
    signal or_ln195_fu_178_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln190_fu_197_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln190_reg_264 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln193_fu_203_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln193_reg_269 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln193_1_reg_274 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal icmp_ln195_fu_172_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif ((not(((c_fft_row_op_st_full_n = ap_const_logic_0) or ((or_ln195_reg_257 = ap_const_lv1_0) and (ap_const_logic_0 = Row_Buffer_full_n)))) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1057_fu_192_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                trunc_ln193_1_reg_274 <= out_fft3_dout(63 downto 32);
                trunc_ln193_reg_269 <= trunc_ln193_fu_203_p1;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, ctrl1_reg_empty_n, out_fft3_empty_n, c_fft_row_op_st_full_n, Row_Buffer_full_n, ap_CS_fsm_state2, icmp_ln1057_fu_192_p2, ap_CS_fsm_state5, or_ln195_reg_257)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state5 => 
                if ((not(((c_fft_row_op_st_full_n = ap_const_logic_0) or ((or_ln195_reg_257 = ap_const_lv1_0) and (ap_const_logic_0 = Row_Buffer_full_n)))) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state5;
                end if;
    ...
    Row_Buffer_blk_n_assign_proc : process(Row_Buffer_full_n, ap_CS_fsm_state5, or_ln195_reg_257)
    begin
        if (((or_ln195_reg_257 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    Row_Buffer_write_assign_proc : process(c_fft_row_op_st_full_n, Row_Buffer_full_n, ap_CS_fsm_state5, or_ln195_reg_257)
    begin
        if ((not(((c_fft_row_op_st_full_n = ap_const_logic_0) or ((or_ln195_reg_257 = ap_const_lv1_0) and (ap_const_logic_0 = Row_Buffer_full_n)))) and (or_ln195_reg_257 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    add_ln190_fu_197_p2 <= std_logic_vector(unsigned(x_fu_76) + unsigned(ap_const_lv8_1));
    ...
    ap_ST_fsm_state5_blk_assign_proc : process(c_fft_row_op_st_full_n, Row_Buffer_full_n, or_ln195_reg_257)
    begin
        if (((c_fft_row_op_st_full_n = ap_const_logic_0) or ((or_ln195_reg_257 = ap_const_lv1_0) and (ap_const_logic_0 = Row_Buffer_full_n)))) then 
    ...
    ap_block_state5_assign_proc : process(c_fft_row_op_st_full_n, Row_Buffer_full_n, or_ln195_reg_257)
    begin
                ap_block_state5 <= ((c_fft_row_op_st_full_n = ap_const_logic_0) or ((or_ln195_reg_257 = ap_const_lv1_0) and (ap_const_logic_0 = Row_Buffer_full_n)));
    end process;
    ...
    c_fft_row_op_st_write_assign_proc : process(c_fft_row_op_st_full_n, Row_Buffer_full_n, ap_CS_fsm_state5, or_ln195_reg_257)
    begin
        if ((not(((c_fft_row_op_st_full_n = ap_const_logic_0) or ((or_ln195_reg_257 = ap_const_lv1_0) and (ap_const_logic_0 = Row_Buffer_full_n)))) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    grp_fu_124_p0 <= trunc_ln193_reg_269;
    grp_fu_127_p0 <= trunc_ln193_1_reg_274;
    icmp_ln1057_fu_192_p2 <= "1" when (x_fu_76 = trunc_ln156_reg_252) else "0";
    icmp_ln195_fu_172_p2 <= "1" when (signed(zext_ln1061_fu_168_p1) > signed(p_read2)) else "0";
    lshr_ln_fu_158_p4 <= ctrl1_reg_dout(31 downto 24);
    or_ln195_fu_178_p2 <= (icmp_ln195_fu_172_p2 or cmp_i_i_fu_152_p2);
    ...
    trunc_ln156_fu_130_p1 <= ctrl1_reg_dout(8 - 1 downto 0);
    trunc_ln193_fu_203_p1 <= out_fft3_dout(32 - 1 downto 0);
