...
entity FFT_R_dataflow_in_loop_VITIS_LOOP_72_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of FFT_R_dataflow_in_loop_VITIS_LOOP_72_1 is 
...
attribute shreg_extract : string;
    ...
    signal fft_stage4_U0_ap_start : STD_LOGIC;
    signal fft_stage4_U0_ap_done : STD_LOGIC;
    signal fft_stage4_U0_ap_continue : STD_LOGIC;
    signal fft_stage4_U0_ap_idle : STD_LOGIC;
    signal fft_stage4_U0_ap_ready : STD_LOGIC;
    signal fft_stage4_U0_IN_r_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal fft_stage4_U0_IN_r_ce0 : STD_LOGIC;
    signal fft_stage4_U0_IN_r_address1 : STD_LOGIC_VECTOR (5 downto 0);
    signal fft_stage4_U0_IN_r_ce1 : STD_LOGIC;
    signal fft_stage4_U0_OUT_r_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal fft_stage4_U0_OUT_r_ce0 : STD_LOGIC;
    signal fft_stage4_U0_OUT_r_we0 : STD_LOGIC;
    signal fft_stage4_U0_OUT_r_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal fft_stage4_U0_OUT_r_address1 : STD_LOGIC_VECTOR (5 downto 0);
    signal fft_stage4_U0_OUT_r_ce1 : STD_LOGIC;
    signal fft_stage4_U0_OUT_r_we1 : STD_LOGIC;
    signal fft_stage4_U0_OUT_r_d1 : STD_LOGIC_VECTOR (31 downto 0);
    signal fft_stage4_U0_ap_return : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal fft_stage4_U0_OUT_r_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_out_data_12 : STD_LOGIC := '0';
    signal ap_sync_channel_write_out_data_12 : STD_LOGIC;
    signal fft_stage5_U0_ap_start : STD_LOGIC;
    signal fft_stage5_U0_ap_done : STD_LOGIC;
    signal fft_stage5_U0_ap_continue : STD_LOGIC;
    signal fft_stage5_U0_ap_idle : STD_LOGIC;
    signal fft_stage5_U0_ap_ready : STD_LOGIC;
    signal fft_stage5_U0_IN_r_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal fft_stage5_U0_IN_r_ce0 : STD_LOGIC;
    signal fft_stage5_U0_IN_r_address1 : STD_LOGIC_VECTOR (5 downto 0);
    signal fft_stage5_U0_IN_r_ce1 : STD_LOGIC;
    signal fft_stage5_U0_OUT_r_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal fft_stage5_U0_OUT_r_ce0 : STD_LOGIC;
    signal fft_stage5_U0_OUT_r_we0 : STD_LOGIC;
    signal fft_stage5_U0_OUT_r_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal fft_stage5_U0_OUT_r_address1 : STD_LOGIC_VECTOR (5 downto 0);
    signal fft_stage5_U0_OUT_r_ce1 : STD_LOGIC;
    signal fft_stage5_U0_OUT_r_we1 : STD_LOGIC;
    signal fft_stage5_U0_OUT_r_d1 : STD_LOGIC_VECTOR (31 downto 0);
    signal fft_stage5_U0_ap_return : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal fft_stage5_U0_OUT_r_full_n : STD_LOGIC;
    ...
    signal fft_stage9_U0_ap_return : STD_LOGIC_VECTOR (7 downto 0);
    ...
    component FFT_R_dataflow_in_loop_VITIS_LOOP_72_1_input_data1 IS
    generic (
        DataWidth : INTEGER;
    ...
    component FFT_R_dataflow_in_loop_VITIS_LOOP_72_1_out_data_12 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component FFT_R_dataflow_in_loop_VITIS_LOOP_72_1_out_data_67 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    input_data1_U : component FFT_R_dataflow_in_loop_VITIS_LOOP_72_1_input_data1
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_12_U : component FFT_R_dataflow_in_loop_VITIS_LOOP_72_1_out_data_12
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_23_U : component FFT_R_dataflow_in_loop_VITIS_LOOP_72_1_out_data_12
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_34_U : component FFT_R_dataflow_in_loop_VITIS_LOOP_72_1_out_data_12
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_45_U : component FFT_R_dataflow_in_loop_VITIS_LOOP_72_1_out_data_12
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_56_U : component FFT_R_dataflow_in_loop_VITIS_LOOP_72_1_out_data_12
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_67_U : component FFT_R_dataflow_in_loop_VITIS_LOOP_72_1_out_data_67
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    fft_stage4_U0 : component FFT_R_fft_stage4
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage5_U0 : component FFT_R_fft_stage5
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage6_U0 : component FFT_R_fft_stage6
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage7_U0 : component FFT_R_fft_stage7
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage8_U0 : component FFT_R_fft_stage8
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fft_stage9_U0 : component FFT_R_fft_stage9
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((fft_stage5_U0_ap_done and fft_stage5_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_ctrl1_reg_c4_channel <= ap_const_logic_0;
                else 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((fft_stage4_U0_ap_done and fft_stage4_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_ctrl1_reg_c5_channel <= ap_const_logic_0;
                else 
    ...
    ap_channel_done_ctrl1_reg_c1_channel <= (fft_stage8_U0_ap_done and (ap_sync_reg_channel_write_ctrl1_reg_c1_channel xor ap_const_logic_1));
    ap_channel_done_ctrl1_reg_c2_channel <= (fft_stage7_U0_ap_done and (ap_sync_reg_channel_write_ctrl1_reg_c2_channel xor ap_const_logic_1));
    ap_channel_done_ctrl1_reg_c3_channel <= (fft_stage6_U0_ap_done and (ap_sync_reg_channel_write_ctrl1_reg_c3_channel xor ap_const_logic_1));
    ap_channel_done_ctrl1_reg_c4_channel <= (fft_stage5_U0_ap_done and (ap_sync_reg_channel_write_ctrl1_reg_c4_channel xor ap_const_logic_1));
    ap_channel_done_ctrl1_reg_c5_channel <= (fft_stage4_U0_ap_done and (ap_sync_reg_channel_write_ctrl1_reg_c5_channel xor ap_const_logic_1));
    ...
    ap_channel_done_out_data_12 <= (fft_stage4_U0_ap_done and (ap_sync_reg_channel_write_out_data_12 xor ap_const_logic_1));
    ap_channel_done_out_data_23 <= (fft_stage5_U0_ap_done and (ap_sync_reg_channel_write_out_data_23 xor ap_const_logic_1));
    ap_channel_done_out_data_34 <= (fft_stage6_U0_ap_done and (ap_sync_reg_channel_write_out_data_34 xor ap_const_logic_1));
    ap_channel_done_out_data_45 <= (fft_stage7_U0_ap_done and (ap_sync_reg_channel_write_out_data_45 xor ap_const_logic_1));
    ap_channel_done_out_data_56 <= (fft_stage8_U0_ap_done and (ap_sync_reg_channel_write_out_data_56 xor ap_const_logic_1));
    ap_channel_done_out_data_67 <= (fft_stage9_U0_ap_done and (ap_sync_reg_channel_write_out_data_67 xor ap_const_logic_1));
    ap_done <= buf_2_stream_U0_ap_done;
    ap_idle <= (stream_2_buf_U0_ap_idle and fft_stage9_U0_ap_idle and fft_stage8_U0_ap_idle and fft_stage7_U0_ap_idle and fft_stage6_U0_ap_idle and fft_stage5_U0_ap_idle and fft_stage4_U0_ap_idle and (ctrl1_reg_c_channel_empty_n xor ap_const_logic_1) and (ctrl1_reg_c1_channel_empty_n xor ap_const_logic_1) and (ctrl1_reg_c2_channel_empty_n xor ap_const_logic_1) and (ctrl1_reg_c3_channel_empty_n xor ap_const_logic_1) and (ctrl1_reg_c4_channel_empty_n xor ap_const_logic_1) and (ctrl1_reg_c5_channel_empty_n xor ap_const_logic_1) and (ctrl1_reg_c6_channel_empty_n xor ap_const_logic_1) and (out_data_67_t_empty_n xor ap_const_logic_1) and (out_data_56_t_empty_n xor ap_const_logic_1) and (out_data_45_t_empty_n xor ap_const_logic_1) and (out_data_34_t_empty_n xor ap_const_logic_1) and (out_data_23_t_empty_n xor ap_const_logic_1) and (out_data_12_t_empty_n xor ap_const_logic_1) and (input_data1_t_empty_n xor ap_const_logic_1) and buf_2_stream_U0_ap_idle);
    ap_ready <= stream_2_buf_U0_ap_ready;
    ...
    ap_sync_channel_write_out_data_12 <= ((fft_stage4_U0_OUT_r_full_n and ap_channel_done_out_data_12) or ap_sync_reg_channel_write_out_data_12);
    ap_sync_channel_write_out_data_23 <= ((fft_stage5_U0_OUT_r_full_n and ap_channel_done_out_data_23) or ap_sync_reg_channel_write_out_data_23);
    ap_sync_channel_write_out_data_34 <= ((fft_stage6_U0_OUT_r_full_n and ap_channel_done_out_data_34) or ap_sync_reg_channel_write_out_data_34);
    ap_sync_channel_write_out_data_45 <= ((fft_stage7_U0_OUT_r_full_n and ap_channel_done_out_data_45) or ap_sync_reg_channel_write_out_data_45);
    ap_sync_channel_write_out_data_56 <= ((fft_stage8_U0_OUT_r_full_n and ap_channel_done_out_data_56) or ap_sync_reg_channel_write_out_data_56);
    ap_sync_channel_write_out_data_67 <= ((fft_stage9_U0_OUT_r_full_n and ap_channel_done_out_data_67) or ap_sync_reg_channel_write_out_data_67);
    buf_2_stream_U0_ap_continue <= ap_continue;
    buf_2_stream_U0_ap_start <= (out_data_67_t_empty_n and ctrl1_reg_c_channel_empty_n);
    fft_stage4_U0_OUT_r_full_n <= out_data_12_i_full_n;
    fft_stage4_U0_ap_continue <= (ap_sync_channel_write_out_data_12 and ap_sync_channel_write_ctrl1_reg_c5_channel);
    fft_stage4_U0_ap_start <= (input_data1_t_empty_n and ctrl1_reg_c6_channel_empty_n);
    fft_stage5_U0_OUT_r_full_n <= out_data_23_i_full_n;
    fft_stage5_U0_ap_continue <= (ap_sync_channel_write_out_data_23 and ap_sync_channel_write_ctrl1_reg_c4_channel);
    fft_stage5_U0_ap_start <= (out_data_12_t_empty_n and ctrl1_reg_c5_channel_empty_n);
    fft_stage6_U0_OUT_r_full_n <= out_data_34_i_full_n;
    fft_stage6_U0_ap_continue <= (ap_sync_channel_write_out_data_34 and ap_sync_channel_write_ctrl1_reg_c3_channel);
    fft_stage6_U0_ap_start <= (out_data_23_t_empty_n and ctrl1_reg_c4_channel_empty_n);
    fft_stage7_U0_OUT_r_full_n <= out_data_45_i_full_n;
    fft_stage7_U0_ap_continue <= (ap_sync_channel_write_out_data_45 and ap_sync_channel_write_ctrl1_reg_c2_channel);
    fft_stage7_U0_ap_start <= (out_data_34_t_empty_n and ctrl1_reg_c3_channel_empty_n);
    fft_stage8_U0_OUT_r_full_n <= out_data_56_i_full_n;
    fft_stage8_U0_ap_continue <= (ap_sync_channel_write_out_data_56 and ap_sync_channel_write_ctrl1_reg_c1_channel);
    fft_stage8_U0_ap_start <= (out_data_45_t_empty_n and ctrl1_reg_c2_channel_empty_n);
    fft_stage9_U0_OUT_r_full_n <= out_data_67_i_full_n;
    fft_stage9_U0_ap_continue <= (ap_sync_channel_write_out_data_67 and ap_sync_channel_write_ctrl1_reg_c_channel);
    fft_stage9_U0_ap_start <= (out_data_56_t_empty_n and ctrl1_reg_c1_channel_empty_n);
    in_stream_V_read <= stream_2_buf_U0_in_stream_V_read;
    out_stream_V_din <= buf_2_stream_U0_out_stream_V_din;
    out_stream_V_write <= buf_2_stream_U0_out_stream_V_write;
