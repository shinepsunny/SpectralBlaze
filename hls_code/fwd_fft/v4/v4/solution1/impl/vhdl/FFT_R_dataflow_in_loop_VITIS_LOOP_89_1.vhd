...
entity FFT_R_dataflow_in_loop_VITIS_LOOP_89_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    in_stream_V_dout : IN STD_LOGIC_VECTOR (63 downto 0);
    in_stream_V_empty_n : IN STD_LOGIC;
    in_stream_V_read : OUT STD_LOGIC;
    ctrl1_reg : IN STD_LOGIC_VECTOR (31 downto 0);
    out_stream_V_din : OUT STD_LOGIC_VECTOR (63 downto 0);
...
architecture behav of FFT_R_dataflow_in_loop_VITIS_LOOP_89_1 is 
...
attribute shreg_extract : string;
    ...
    signal buf_2_stream_U0_out_stream_V_din : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component FFT_R_bit_reversal IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_input_data1 IS
    generic (
        DataWidth : INTEGER;
    ...
    component FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_input_data_rev2 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_out_data_13 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_out_data_68 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    input_data1_U : component FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_input_data1
    generic map (
        DataWidth => 64,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    input_data_rev2_U : component FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_input_data_rev2
    generic map (
        DataWidth => 64,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_13_U : component FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_out_data_13
    generic map (
        DataWidth => 64,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_24_U : component FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_out_data_13
    generic map (
        DataWidth => 64,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_35_U : component FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_out_data_13
    generic map (
        DataWidth => 64,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_46_U : component FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_out_data_13
    generic map (
        DataWidth => 64,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_57_U : component FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_out_data_13
    generic map (
        DataWidth => 64,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    out_data_68_U : component FFT_R_dataflow_in_loop_VITIS_LOOP_89_1_out_data_68
    generic map (
        DataWidth => 64,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    bit_reversal_U0 : component FFT_R_bit_reversal
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    ctrl1_reg_c7_channel_U : component FFT_R_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
