...
entity fwd_fft_dataflow_in_loop_VITIS_LOOP_303_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_dataflow_in_loop_VITIS_LOOP_303_3 is 
...
attribute shreg_extract : string;
    ...
    signal ifmap_gen_x_U0_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal ctrl1_reg_c_channel1_dout : STD_LOGIC_VECTOR (15 downto 0);
    ...
    component fwd_fft_dataflow_in_loop_VITIS_LOOP_303_3_ifmap_RF_M_real IS
    generic (
        DataWidth : INTEGER;
    ...
    component fwd_fft_fifo_w16_d2_S_x1 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
...
begin
    ifmap_RF_M_real_U : component fwd_fft_dataflow_in_loop_VITIS_LOOP_303_3_ifmap_RF_M_real
    generic map (
        DataWidth => 16,
        AddressRange => 4096,
        AddressWidth => 12)
    ...
    ifmap_RF_M_imag_U : component fwd_fft_dataflow_in_loop_VITIS_LOOP_303_3_ifmap_RF_M_real
    generic map (
        DataWidth => 16,
        AddressRange => 4096,
        AddressWidth => 12)
    ...
    ctrl1_reg_c_channel1_U : component fwd_fft_fifo_w16_d2_S_x1
    port map (
        clk => ap_clk,
        reset => ap_rst,
