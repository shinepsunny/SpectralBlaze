...
entity fwd_fft_VITIS_LOOP_185_8_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_VITIS_LOOP_185_8_proc is 
...
attribute shreg_extract : string;
    ...
    signal and_ln190_reg_257 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln152_fu_130_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln152_reg_252 : STD_LOGIC_VECTOR (7 downto 0);
    signal and_ln190_fu_178_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln185_fu_197_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln185_reg_264 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln188_fu_203_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln188_reg_269 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln188_1_reg_274 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal zext_ln1065_fu_168_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    sptohp_32ns_16_2_no_dsp_1_U116 : component fwd_fft_sptohp_32ns_16_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    sptohp_32ns_16_2_no_dsp_1_U117 : component fwd_fft_sptohp_32ns_16_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif ((not(((c_fft_row_op_st_full_n = ap_const_logic_0) or ((ap_const_lv1_1 = and_ln190_reg_257) and (ap_const_logic_0 = Row_Buffer_full_n)))) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
                x_fu_76 <= add_ln185_reg_264;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                add_ln185_reg_264 <= add_ln185_fu_197_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                and_ln190_reg_257 <= and_ln190_fu_178_p2;
                trunc_ln152_reg_252 <= trunc_ln152_fu_130_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1057_fu_192_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                trunc_ln188_1_reg_274 <= out_fft3_dout(63 downto 32);
                trunc_ln188_reg_269 <= trunc_ln188_fu_203_p1;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, ctrl1_reg_empty_n, out_fft3_empty_n, c_fft_row_op_st_full_n, Row_Buffer_full_n, ap_CS_fsm_state2, icmp_ln1057_fu_192_p2, ap_CS_fsm_state5, and_ln190_reg_257)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state5 => 
                if ((not(((c_fft_row_op_st_full_n = ap_const_logic_0) or ((ap_const_lv1_1 = and_ln190_reg_257) and (ap_const_logic_0 = Row_Buffer_full_n)))) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state5;
                end if;
    ...
    Row_Buffer_blk_n_assign_proc : process(Row_Buffer_full_n, ap_CS_fsm_state5, and_ln190_reg_257)
    begin
        if (((ap_const_lv1_1 = and_ln190_reg_257) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    Row_Buffer_write_assign_proc : process(c_fft_row_op_st_full_n, Row_Buffer_full_n, ap_CS_fsm_state5, and_ln190_reg_257)
    begin
        if ((not(((c_fft_row_op_st_full_n = ap_const_logic_0) or ((ap_const_lv1_1 = and_ln190_reg_257) and (ap_const_logic_0 = Row_Buffer_full_n)))) and (ap_const_lv1_1 = and_ln190_reg_257) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    add_ln185_fu_197_p2 <= std_logic_vector(unsigned(x_fu_76) + unsigned(ap_const_lv8_1));
    and_ln190_fu_178_p2 <= (icmp_ln190_fu_172_p2 and cmp_i_i_fu_152_p2);
    ...
    ap_ST_fsm_state5_blk_assign_proc : process(c_fft_row_op_st_full_n, Row_Buffer_full_n, and_ln190_reg_257)
    begin
        if (((c_fft_row_op_st_full_n = ap_const_logic_0) or ((ap_const_lv1_1 = and_ln190_reg_257) and (ap_const_logic_0 = Row_Buffer_full_n)))) then 
    ...
    ap_block_state5_assign_proc : process(c_fft_row_op_st_full_n, Row_Buffer_full_n, and_ln190_reg_257)
    begin
                ap_block_state5 <= ((c_fft_row_op_st_full_n = ap_const_logic_0) or ((ap_const_lv1_1 = and_ln190_reg_257) and (ap_const_logic_0 = Row_Buffer_full_n)));
    end process;
    ...
    c_fft_row_op_st_write_assign_proc : process(c_fft_row_op_st_full_n, Row_Buffer_full_n, ap_CS_fsm_state5, and_ln190_reg_257)
    begin
        if ((not(((c_fft_row_op_st_full_n = ap_const_logic_0) or ((ap_const_lv1_1 = and_ln190_reg_257) and (ap_const_logic_0 = Row_Buffer_full_n)))) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    cmp_i_i_fu_152_p2 <= "0" when (pny_cast_fu_134_p1 = sub_i_i_fu_146_p2) else "1";
    ...
    grp_fu_124_p0 <= trunc_ln188_reg_269;
    grp_fu_127_p0 <= trunc_ln188_1_reg_274;
    icmp_ln1057_fu_192_p2 <= "1" when (x_fu_76 = trunc_ln152_reg_252) else "0";
    icmp_ln190_fu_172_p2 <= "1" when (signed(zext_ln1065_fu_168_p1) < signed(p_read2)) else "0";
    ...
    trunc_ln152_fu_130_p1 <= ctrl1_reg_dout(8 - 1 downto 0);
    trunc_ln188_fu_203_p1 <= out_fft3_dout(32 - 1 downto 0);
    zext_ln1065_fu_168_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln_fu_158_p4),32));
end behav;
