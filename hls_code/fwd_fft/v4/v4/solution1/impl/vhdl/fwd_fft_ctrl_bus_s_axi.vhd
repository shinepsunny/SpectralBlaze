...
entity fwd_fft_ctrl_bus_s_axi is
generic (
...
end entity fwd_fft_ctrl_bus_s_axi;
...
architecture behave of fwd_fft_ctrl_bus_s_axi is
    ...
    constant ADDR_CTRL1_REG_DATA_0  : INTEGER := 16#34#;
    constant ADDR_CTRL1_REG_CTRL    : INTEGER := 16#38#;
    constant ADDR_CTRL2_REG_DATA_0  : INTEGER := 16#3c#;
    constant ADDR_CTRL2_REG_CTRL    : INTEGER := 16#40#;
    constant ADDR_LAYER1_REG_DATA_0 : INTEGER := 16#44#;
    constant ADDR_LAYER1_REG_CTRL   : INTEGER := 16#48#;
    constant ADDR_LAYER2_REG_DATA_0 : INTEGER := 16#4c#;
    constant ADDR_LAYER2_REG_CTRL   : INTEGER := 16#50#;
    ...
    signal int_ctrl1_reg       : UNSIGNED(31 downto 0) := (others => '0');
    signal int_ctrl2_reg       : UNSIGNED(31 downto 0) := (others => '0');
    signal int_layer1_reg      : UNSIGNED(31 downto 0) := (others => '0');
    signal int_layer2_reg      : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_CTRL1_REG_DATA_0 =>
                        rdata_data <= RESIZE(int_ctrl1_reg(31 downto 0), 32);
                    when ADDR_CTRL2_REG_DATA_0 =>
                        rdata_data <= RESIZE(int_ctrl2_reg(31 downto 0), 32);
                    when ADDR_LAYER1_REG_DATA_0 =>
                        rdata_data <= RESIZE(int_layer1_reg(31 downto 0), 32);
                    when ADDR_LAYER2_REG_DATA_0 =>
                        rdata_data <= RESIZE(int_layer2_reg(31 downto 0), 32);
                    when others =>
                        NULL;
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    ctrl1_reg            <= STD_LOGIC_VECTOR(int_ctrl1_reg);
    ctrl2_reg            <= STD_LOGIC_VECTOR(int_ctrl2_reg);
    layer1_reg           <= STD_LOGIC_VECTOR(int_layer1_reg);
    layer2_reg           <= STD_LOGIC_VECTOR(int_layer2_reg);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CTRL1_REG_DATA_0) then
                    int_ctrl1_reg(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_ctrl1_reg(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CTRL2_REG_DATA_0) then
                    int_ctrl2_reg(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_ctrl2_reg(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYER1_REG_DATA_0) then
                    int_layer1_reg(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_layer1_reg(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYER2_REG_DATA_0) then
                    int_layer2_reg(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_layer2_reg(31 downto 0));
                end if;
            end if;
        end if;
    end process;
