...
entity fwd_fft_dataflow_in_loop_VITIS_LOOP_358_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_dataflow_in_loop_VITIS_LOOP_358_3 is 
...
attribute shreg_extract : string;
    ...
    component fwd_fft_dataflow_in_loop_VITIS_LOOP_358_3_ifmap_RF_M_real IS
    generic (
        DataWidth : INTEGER;
...
begin
    ifmap_RF_M_real_U : component fwd_fft_dataflow_in_loop_VITIS_LOOP_358_3_ifmap_RF_M_real
    generic map (
        DataWidth => 16,
        AddressRange => 4096,
        AddressWidth => 12)
    ...
    ifmap_RF_M_imag_U : component fwd_fft_dataflow_in_loop_VITIS_LOOP_358_3_ifmap_RF_M_real
    generic map (
        DataWidth => 16,
        AddressRange => 4096,
        AddressWidth => 12)
