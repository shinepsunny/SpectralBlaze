...
entity FFT_R_dataflow_parent_loop_proc is
port (
...
architecture behav of FFT_R_dataflow_parent_loop_proc is 
...
begin
    ...
    dataflow_in_loop_VITIS_LOOP_72_1_U0_ap_continue_assign_proc : process(ap_continue, loop_dataflow_output_count, bound_minus_1)
    begin
        if ((not((loop_dataflow_output_count = bound_minus_1)) or (ap_continue = ap_const_logic_1))) then 
            ...
            dataflow_in_loop_VITIS_LOOP_72_1_U0_ap_continue <= ap_const_logic_0;
        end if; 
    end process;
