...
entity fwd_fft_Col_Wise_FFT is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_Col_Wise_FFT is 
...
attribute shreg_extract : string;
    ...
    signal empty_171_fu_98_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal empty_171_reg_113 : STD_LOGIC_VECTOR (15 downto 0);
    signal empty_172_fu_103_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_172_reg_118 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_dataflow_parent_loop_proc10_fu_82_c_fft_row_op_st_read : STD_LOGIC;
    signal grp_dataflow_parent_loop_proc10_fu_82_c_fft_col_op_st_din : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_dataflow_parent_loop_proc10_fu_82_c_fft_col_op_st_write : STD_LOGIC;
    signal grp_dataflow_parent_loop_proc10_fu_82_ap_start : STD_LOGIC;
    signal grp_dataflow_parent_loop_proc10_fu_82_ap_done : STD_LOGIC;
    signal grp_dataflow_parent_loop_proc10_fu_82_ap_ready : STD_LOGIC;
    signal grp_dataflow_parent_loop_proc10_fu_82_ap_idle : STD_LOGIC;
    signal grp_dataflow_parent_loop_proc10_fu_82_ap_continue : STD_LOGIC;
    signal grp_dataflow_parent_loop_proc10_fu_82_ap_start_reg : STD_LOGIC := '0';
    signal ap_block_state1_ignore_call17 : BOOLEAN;
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal ap_sync_grp_dataflow_parent_loop_proc10_fu_82_ap_ready : STD_LOGIC;
    signal ap_sync_grp_dataflow_parent_loop_proc10_fu_82_ap_done : STD_LOGIC;
    signal ap_block_state2_on_subcall_done : BOOLEAN;
    signal ap_sync_reg_grp_dataflow_parent_loop_proc10_fu_82_ap_ready : STD_LOGIC := '0';
    signal ap_sync_reg_grp_dataflow_parent_loop_proc10_fu_82_ap_done : STD_LOGIC := '0';
...
begin
    grp_dataflow_parent_loop_proc10_fu_82 : component fwd_fft_dataflow_parent_loop_proc10
    port map (
        layer1_reg_load_cast => empty_171_reg_113,
        ctrl2_reg_load_cast => empty_172_reg_118,
        c_fft_row_op_st_dout => c_fft_row_op_st_dout,
        c_fft_row_op_st_empty_n => c_fft_row_op_st_empty_n,
        c_fft_row_op_st_read => grp_dataflow_parent_loop_proc10_fu_82_c_fft_row_op_st_read,
        p_read => empty_reg_108,
        c_fft_col_op_st_din => grp_dataflow_parent_loop_proc10_fu_82_c_fft_col_op_st_din,
        c_fft_col_op_st_full_n => c_fft_col_op_st_full_n,
        c_fft_col_op_st_write => grp_dataflow_parent_loop_proc10_fu_82_c_fft_col_op_st_write,
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ctrl2_reg_load_cast_ap_vld => ap_const_logic_1,
        p_read_ap_vld => ap_const_logic_1,
        ap_start => grp_dataflow_parent_loop_proc10_fu_82_ap_start,
        ap_done => grp_dataflow_parent_loop_proc10_fu_82_ap_done,
        ap_ready => grp_dataflow_parent_loop_proc10_fu_82_ap_ready,
        ap_idle => grp_dataflow_parent_loop_proc10_fu_82_ap_idle,
        ap_continue => grp_dataflow_parent_loop_proc10_fu_82_ap_continue);
    ...
    ap_sync_reg_grp_dataflow_parent_loop_proc10_fu_82_ap_done_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_grp_dataflow_parent_loop_proc10_fu_82_ap_done <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (ap_const_boolean_0 = ap_block_state2_on_subcall_done))) then 
                    ap_sync_reg_grp_dataflow_parent_loop_proc10_fu_82_ap_done <= ap_const_logic_0;
                elsif ((grp_dataflow_parent_loop_proc10_fu_82_ap_done = ap_const_logic_1)) then 
                    ap_sync_reg_grp_dataflow_parent_loop_proc10_fu_82_ap_done <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_reg_grp_dataflow_parent_loop_proc10_fu_82_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_grp_dataflow_parent_loop_proc10_fu_82_ap_ready <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (ap_const_boolean_0 = ap_block_state2_on_subcall_done))) then 
                    ap_sync_reg_grp_dataflow_parent_loop_proc10_fu_82_ap_ready <= ap_const_logic_0;
                elsif ((grp_dataflow_parent_loop_proc10_fu_82_ap_ready = ap_const_logic_1)) then 
                    ap_sync_reg_grp_dataflow_parent_loop_proc10_fu_82_ap_ready <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                empty_171_reg_113 <= empty_171_fu_98_p1;
                empty_172_reg_118 <= empty_172_fu_103_p1;
                empty_reg_108 <= empty_fu_93_p1;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, ctrl1_reg_empty_n, ctrl2_reg_empty_n, layer1_reg_empty_n, ctrl1_reg_c_full_n, ctrl2_reg_c_full_n, layer1_reg_c_full_n, ap_CS_fsm_state2, ap_block_state2_on_subcall_done)
    begin
        case ap_CS_fsm is
    ...
    begin
        if (((ap_start = ap_const_logic_0) or (layer1_reg_c_full_n = ap_const_logic_0) or (ctrl2_reg_c_full_n = ap_const_logic_0) or (ctrl1_reg_c_full_n = ap_const_logic_0) or (layer1_reg_empty_n = ap_const_logic_0) or (ctrl2_reg_empty_n = ap_const_logic_0) or (ctrl1_reg_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) then 
    ...
    ap_block_state1_ignore_call17_assign_proc : process(ap_start, ap_done_reg, ctrl1_reg_empty_n, ctrl2_reg_empty_n, layer1_reg_empty_n, ctrl1_reg_c_full_n, ctrl2_reg_c_full_n, layer1_reg_c_full_n)
    begin
                ap_block_state1_ignore_call17 <= ((ap_start = ap_const_logic_0) or (layer1_reg_c_full_n = ap_const_logic_0) or (ctrl2_reg_c_full_n = ap_const_logic_0) or (ctrl1_reg_c_full_n = ap_const_logic_0) or (layer1_reg_empty_n = ap_const_logic_0) or (ctrl2_reg_empty_n = ap_const_logic_0) or (ctrl1_reg_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;


    ap_block_state2_on_subcall_done_assign_proc : process(ap_sync_grp_dataflow_parent_loop_proc10_fu_82_ap_ready, ap_sync_grp_dataflow_parent_loop_proc10_fu_82_ap_done)
    begin
                ap_block_state2_on_subcall_done <= ((ap_sync_grp_dataflow_parent_loop_proc10_fu_82_ap_ready and ap_sync_grp_dataflow_parent_loop_proc10_fu_82_ap_done) = ap_const_logic_0);
    end process;
    ...
    ap_sync_grp_dataflow_parent_loop_proc10_fu_82_ap_done <= (grp_dataflow_parent_loop_proc10_fu_82_ap_done or ap_sync_reg_grp_dataflow_parent_loop_proc10_fu_82_ap_done);
    ap_sync_grp_dataflow_parent_loop_proc10_fu_82_ap_ready <= (grp_dataflow_parent_loop_proc10_fu_82_ap_ready or ap_sync_reg_grp_dataflow_parent_loop_proc10_fu_82_ap_ready);
    c_fft_col_op_st_din <= grp_dataflow_parent_loop_proc10_fu_82_c_fft_col_op_st_din;

    c_fft_col_op_st_write_assign_proc : process(grp_dataflow_parent_loop_proc10_fu_82_c_fft_col_op_st_write, ap_CS_fsm_state2)
    begin
    ...
    c_fft_row_op_st_read_assign_proc : process(grp_dataflow_parent_loop_proc10_fu_82_c_fft_row_op_st_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            c_fft_row_op_st_read <= grp_dataflow_parent_loop_proc10_fu_82_c_fft_row_op_st_read;
        else 
    ...
    empty_171_fu_98_p1 <= layer1_reg_dout(16 - 1 downto 0);
    empty_172_fu_103_p1 <= ctrl2_reg_dout(8 - 1 downto 0);
    empty_fu_93_p1 <= ctrl1_reg_dout(8 - 1 downto 0);

    grp_dataflow_parent_loop_proc10_fu_82_ap_continue_assign_proc : process(ap_CS_fsm_state2, ap_block_state2_on_subcall_done)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (ap_const_boolean_0 = ap_block_state2_on_subcall_done))) then 
            grp_dataflow_parent_loop_proc10_fu_82_ap_continue <= ap_const_logic_1;
        else 
            grp_dataflow_parent_loop_proc10_fu_82_ap_continue <= ap_const_logic_0;
        end if; 
    end process;

    grp_dataflow_parent_loop_proc10_fu_82_ap_start <= grp_dataflow_parent_loop_proc10_fu_82_ap_start_reg;
