...
entity fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3 is 
...
attribute shreg_extract : string;
    ...
    signal ifmap_gen_x_U0_c_row_op_st_read : STD_LOGIC;
    ...
    signal ifmap_gen_x_U0_ap_return : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal ifmap_cons_y_U0_ap_start : STD_LOGIC;
    signal ifmap_cons_y_U0_ap_done : STD_LOGIC;
    signal ifmap_cons_y_U0_ap_continue : STD_LOGIC;
    signal ifmap_cons_y_U0_ap_idle : STD_LOGIC;
    signal ifmap_cons_y_U0_ap_ready : STD_LOGIC;
    signal ifmap_cons_y_U0_c_row_op_trans_st_din : STD_LOGIC_VECTOR (31 downto 0);
    signal ifmap_cons_y_U0_c_row_op_trans_st_write : STD_LOGIC;
    signal ifmap_cons_y_U0_ifmap_CF_M_real_address0 : STD_LOGIC_VECTOR (11 downto 0);
    signal ifmap_cons_y_U0_ifmap_CF_M_real_ce0 : STD_LOGIC;
    signal ifmap_cons_y_U0_ifmap_CF_M_imag_address0 : STD_LOGIC_VECTOR (11 downto 0);
    signal ifmap_cons_y_U0_ifmap_CF_M_imag_ce0 : STD_LOGIC;
    ...
    component fwd_fft_ifmap_cons_y IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real IS
    generic (
        DataWidth : INTEGER;
    ...
    component fwd_fft_fifo_w8_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
...
begin
    ifmap_RF_M_real_U : component fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real
    generic map (
        DataWidth => 16,
        AddressRange => 4096,
        AddressWidth => 12)
    port map (
        ...
        t_address0 => ifmap_cons_y_U0_ifmap_CF_M_real_address0,
        t_ce0 => ifmap_cons_y_U0_ifmap_CF_M_real_ce0,
        ...
        t_read => ifmap_cons_y_U0_ap_ready);

    ifmap_RF_M_imag_U : component fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real
    generic map (
        DataWidth => 16,
        AddressRange => 4096,
        AddressWidth => 12)
    port map (
        ...
        t_address0 => ifmap_cons_y_U0_ifmap_CF_M_imag_address0,
        t_ce0 => ifmap_cons_y_U0_ifmap_CF_M_imag_ce0,
        t_we0 => ap_const_logic_0,
        t_d0 => ap_const_lv16_0,
    ...
    port map (
        ...
        c_row_op_st_read => ifmap_gen_x_U0_c_row_op_st_read,
    ...
    ifmap_cons_y_U0 : component fwd_fft_ifmap_cons_y
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => ifmap_cons_y_U0_ap_start,
        ap_done => ifmap_cons_y_U0_ap_done,
        ap_continue => ifmap_cons_y_U0_ap_continue,
        ap_idle => ifmap_cons_y_U0_ap_idle,
        ap_ready => ifmap_cons_y_U0_ap_ready,
        c_row_op_trans_st_din => ifmap_cons_y_U0_c_row_op_trans_st_din,
        c_row_op_trans_st_full_n => c_row_op_trans_st_full_n,
        c_row_op_trans_st_write => ifmap_cons_y_U0_c_row_op_trans_st_write,
        ifmap_CF_M_real_address0 => ifmap_cons_y_U0_ifmap_CF_M_real_address0,
        ifmap_CF_M_real_ce0 => ifmap_cons_y_U0_ifmap_CF_M_real_ce0,
        ifmap_CF_M_real_q0 => ifmap_RF_M_real_t_q0,
        ifmap_CF_M_imag_address0 => ifmap_cons_y_U0_ifmap_CF_M_imag_address0,
        ifmap_CF_M_imag_ce0 => ifmap_cons_y_U0_ifmap_CF_M_imag_ce0,
        ifmap_CF_M_imag_q0 => ifmap_RF_M_imag_t_q0,
        p_read => ctrl1_reg_c_channel1_dout);

    ctrl1_reg_c_channel1_U : component fwd_fft_fifo_w8_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        ...
        if_read => ifmap_cons_y_U0_ap_ready);
    ...
    ap_done <= ifmap_cons_y_U0_ap_done;
    ap_idle <= (ifmap_gen_x_U0_ap_idle and ifmap_cons_y_U0_ap_idle and (ctrl1_reg_c_channel1_empty_n xor ap_const_logic_1) and (ifmap_RF_M_imag_t_empty_n xor ap_const_logic_1) and (ifmap_RF_M_real_t_empty_n xor ap_const_logic_1));
    ap_ready <= ifmap_gen_x_U0_ap_ready;
    ...
    c_row_op_trans_st_din <= ifmap_cons_y_U0_c_row_op_trans_st_din;
    c_row_op_trans_st_write <= ifmap_cons_y_U0_c_row_op_trans_st_write;
    ifmap_cons_y_U0_ap_continue <= ap_continue;
    ifmap_cons_y_U0_ap_start <= (ifmap_RF_M_real_t_empty_n and ifmap_RF_M_imag_t_empty_n and ctrl1_reg_c_channel1_empty_n);
