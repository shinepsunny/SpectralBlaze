...
entity FFT_C_fft_stage_Pipeline_VITIS_LOOP_39_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of FFT_C_fft_stage_Pipeline_VITIS_LOOP_39_1 is 
...
begin
    ...
    icmp_ln1057_fu_116_p2 <= "1" when (unsigned(zext_ln1057_1_fu_112_p1) < unsigned(p_partselect)) else "0";
