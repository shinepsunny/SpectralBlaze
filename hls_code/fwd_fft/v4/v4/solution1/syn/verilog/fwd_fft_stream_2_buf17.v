...
wire   [7:0] i_2_fu_121_p2;
wire   [7:0] empty_fu_93_p1;
wire   [2:0] p_cast_cast_cast_fu_97_p4;
wire   [2:0] sub_ln708_fu_137_p2;
wire   [2:0] sub_ln708_1_fu_143_p2;
reg   [5:0] tmp_fu_127_p4;
wire   [5:0] zext_ln708_1_fu_149_p1;
wire   [5:0] zext_ln708_2_fu_153_p1;
wire   [5:0] lshr_ln708_fu_157_p2;
wire   [5:0] lshr_ln708_1_fu_163_p2;
...
assign i_2_fu_121_p2 = (ap_sig_allocacmp_i_1 + 8'd1);

assign icmp_ln1057_fu_115_p2 = ((ap_sig_allocacmp_i_1 == empty_fu_93_p1) ? 1'b1 : 1'b0);

assign input_buffer_address0 = zext_ln708_fu_180_p1;

assign input_buffer_d0 = c_row_op_trans_st_read_reg_199;

assign lshr_ln708_1_fu_163_p2 = 6'd63 >> zext_ln708_2_fu_153_p1;

assign lshr_ln708_fu_157_p2 = tmp_fu_127_p4 >> zext_ln708_1_fu_149_p1;

assign p_Result_s_fu_169_p2 = (lshr_ln708_fu_157_p2 & lshr_ln708_1_fu_163_p2);

assign p_cast_cast_cast_fu_97_p4 = {{p_read[10:8]}};

assign sub_ln708_1_fu_143_p2 = ($signed(3'd6) - $signed(p_cast_cast_cast_fu_97_p4));
...
always @ (ap_sig_allocacmp_i_1) begin
    for (ap_tvar_int_0 = 6 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 5 - 0) begin
            ...
            tmp_fu_127_p4[ap_tvar_int_0] = ap_sig_allocacmp_i_1[5 - ap_tvar_int_0];
        end
    end
end

assign zext_ln708_1_fu_149_p1 = sub_ln708_fu_137_p2;

assign zext_ln708_2_fu_153_p1 = sub_ln708_1_fu_143_p2;
