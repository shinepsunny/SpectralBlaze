...
reg   [15:0] p_r_M_imag_28_reg_546;
...
reg   [6:0] k1_fu_60;
wire   [6:0] k1_18_fu_217_p2;
wire    ap_loop_init;
reg   [31:0] j1_fu_64;
wire   [31:0] j1_25_fu_283_p3;
reg   [31:0] m1_fu_68;
wire   [31:0] m1_18_fu_291_p3;
...
fwd_fft_hsub_16ns_16ns_16_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_5_full_dsp_1_U320(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hsub_16ns_16ns_16_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_5_full_dsp_1_U321(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(t1_M_real_fu_375_p1),
    .din1(p_r_reg_540),
...
fwd_fft_hsub_16ns_16ns_16_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hsub_16ns_16ns_16_5_full_dsp_1_U322(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(t1_M_imag_fu_380_p1),
    .din1(p_r_M_imag_28_reg_546),
...
fwd_fft_hmul_16ns_16ns_16_4_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_4_max_dsp_1_U323(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hmul_16ns_16ns_16_4_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_4_max_dsp_1_U324(
    .clk(ap_clk),
    .reset(ap_rst),
...
fwd_fft_hmul_16ns_16ns_16_4_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_4_max_dsp_1_U325(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(p_r_M_real_reg_488),
    .din1(w1_M_imag_reg_482),
...
fwd_fft_hmul_16ns_16ns_16_4_max_dsp_1 #(
    ...
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
hmul_16ns_16ns_16_4_max_dsp_1_U326(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(p_r_M_imag_reg_494),
    .din1(w1_M_real_reg_476),
...
assign add_ln23_fu_241_p2 = (trunc_ln1057_9_fu_233_p1 + trunc_ln1057_fu_229_p1);
...
assign j1_25_fu_283_p3 = ((or_ln27_fu_277_p2[0:0] == 1'b1) ? zext_ln27_fu_273_p1 : j1_fu_64);

assign k1_18_fu_217_p2 = (k1_fu_60 + 7'd1);

assign m1_17_fu_265_p3 = ((icmp_ln31_fu_253_p2[0:0] == 1'b1) ? add_ln34_fu_259_p2 : m1_fu_68);

assign m1_18_fu_291_p3 = ((icmp_ln27_fu_247_p2[0:0] == 1'b1) ? m1_fu_68 : m1_17_fu_265_p3);
...
assign trunc_ln1057_9_fu_233_p1 = j1_fu_64[5:0];
...
assign w_M_imag31_address0 = zext_ln22_fu_319_p1;

assign w_M_real42_address0 = zext_ln22_fu_319_p1;
