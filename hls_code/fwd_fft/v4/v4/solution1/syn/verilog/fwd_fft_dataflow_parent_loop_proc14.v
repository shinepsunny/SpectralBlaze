...
wire    dataflow_parent_loop_proc_U0_c_row_op_st_read;
wire   [31:0] dataflow_parent_loop_proc_U0_c_row_op_trans_st_din;
wire    dataflow_parent_loop_proc_U0_c_row_op_trans_st_write;
...
fwd_fft_dataflow_parent_loop_proc dataflow_parent_loop_proc_U0(
    ...
    .c_row_op_st_read(dataflow_parent_loop_proc_U0_c_row_op_st_read),
    .p_read(p_read),
    .c_row_op_trans_st_din(dataflow_parent_loop_proc_U0_c_row_op_trans_st_din),
    .c_row_op_trans_st_full_n(c_row_op_trans_st_full_n),
    .c_row_op_trans_st_write(dataflow_parent_loop_proc_U0_c_row_op_trans_st_write),
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
assign c_row_op_st_read = dataflow_parent_loop_proc_U0_c_row_op_st_read;

assign c_row_op_trans_st_din = dataflow_parent_loop_proc_U0_c_row_op_trans_st_din;

assign c_row_op_trans_st_write = dataflow_parent_loop_proc_U0_c_row_op_trans_st_write;
