...
entity fwd_fft_fft_stage_1_019_Pipeline_VITIS_LOOP_40_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fwd_fft_fft_stage_1_019_Pipeline_VITIS_LOOP_40_1 is 
...
begin
    ...
    add_ln40_fu_142_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_x_10) + unsigned(ap_const_lv7_2));
    ...
    icmp_ln1057_fu_116_p2 <= "1" when (unsigned(zext_ln1057_10_fu_112_p1) < unsigned(zext_ln40)) else "0";
    or_ln45_fu_131_p2 <= (trunc_ln1057_fu_127_p1 or ap_const_lv6_1);
    trunc_ln1057_fu_127_p1 <= ap_sig_allocacmp_x_10(6 - 1 downto 0);
    zext_ln1057_10_fu_112_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_x_10),8));
