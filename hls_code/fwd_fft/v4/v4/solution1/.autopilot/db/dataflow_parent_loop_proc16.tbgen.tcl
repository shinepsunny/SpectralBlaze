...
set C_modelArgList {
	{ layer1_reg_load_cast int 16 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer1_reg_load_cast", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portNum 62
set portList { 
	{ layer1_reg_load_cast sc_in sc_lv 16 signal 0 } 
	{ ctrl2_reg_load_cast sc_in sc_lv 8 signal 1 } 
	{ c_fft_col_op_st_dout sc_in sc_lv 32 signal 2 } 
	{ c_fft_col_op_st_empty_n sc_in sc_logic 1 signal 2 } 
	{ c_fft_col_op_st_read sc_out sc_logic 1 signal 2 } 
	...
	{ m_axi_gmem_WDATA sc_out sc_lv 128 signal 4 } 
	{ m_axi_gmem_WSTRB sc_out sc_lv 16 signal 4 } 
	...
	{ m_axi_gmem_RDATA sc_in sc_lv 128 signal 4 } 
	...
	{ fft_out sc_in sc_lv 64 signal 5 } 
	{ ap_clk sc_in sc_logic 1 clock -1 } 
	{ ap_rst sc_in sc_logic 1 reset -1 active_high_sync } 
	{ ctrl2_reg_load_cast_ap_vld sc_in sc_logic 1 invld 1 } 
	{ p_read_ap_vld sc_in sc_logic 1 invld 3 } 
	{ fft_out_ap_vld sc_in sc_logic 1 invld 5 } 
...
set NewPortList {[ 
	{ "name": "layer1_reg_load_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "layer1_reg_load_cast", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"InputProcess" : [
			{"ID" : "1", "Name" : "dataflow_parent_loop_proc13_U0"}],
		"OutputProcess" : [
			{"ID" : "1", "Name" : "dataflow_parent_loop_proc13_U0"}],
		"Port" : [
			...
			{"Name" : "c_fft_col_op_st", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "dataflow_parent_loop_proc13_U0", "Port" : "c_fft_col_op_st"}]},
			{"Name" : "p_read", "Type" : "None", "Direction" : "I"},
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "dataflow_parent_loop_proc13_U0", "Port" : "gmem"}]},
			{"Name" : "fft_out", "Type" : "None", "Direction" : "I"},
			{"Name" : "wr_ptr", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "dataflow_parent_loop_proc13_U0", "Port" : "wr_ptr"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_465_1", "PipelineType" : "dataflow",
				"LoopDec" : {"InfiniteLoop" : "0", "BodyInst" : "dataflow_parent_loop_proc13_U0", "has_continue" : "1"}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dataflow_parent_loop_proc13_U0", "Parent" : "0", "Child" : ["2"],
		...
		"HasNonBlockingOperation" : "0",
		"InputProcess" : [
			{"ID" : "2", "Name" : "dataflow_parent_loop_proc10_U0"}],
		"OutputProcess" : [
			{"ID" : "2", "Name" : "dataflow_parent_loop_proc10_U0"}],
		"Port" : [
			{"Name" : "ctrl2_reg_load_cast", "Type" : "None", "Direction" : "I"},
			{"Name" : "c_fft_col_op_st", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "dataflow_parent_loop_proc10_U0", "Port" : "c_fft_col_op_st"}]},
			{"Name" : "p_read", "Type" : "None", "Direction" : "I"},
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "dataflow_parent_loop_proc10_U0", "Port" : "gmem"}]},
			{"Name" : "fft_out", "Type" : "None", "Direction" : "I"},
			{"Name" : "wr_ptr", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "dataflow_parent_loop_proc10_U0", "Port" : "wr_ptr"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_468_2", "PipelineType" : "dataflow",
				"LoopDec" : {"InfiniteLoop" : "0", "BodyInst" : "dataflow_parent_loop_proc10_U0", "has_continue" : "1"}}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_parent_loop_proc13_U0.dataflow_parent_loop_proc10_U0", "Parent" : "1", "Child" : ["3"],
		...
		"HasNonBlockingOperation" : "0",
		"InputProcess" : [
			{"ID" : "3", "Name" : "dataflow_in_loop_VITIS_LOOP_471_3_U0"}],
		"OutputProcess" : [
			{"ID" : "3", "Name" : "dataflow_in_loop_VITIS_LOOP_471_3_U0"}],
		"Port" : [
			{"Name" : "ctrl2_reg_load_cast", "Type" : "None", "Direction" : "I"},
			{"Name" : "c_fft_col_op_st", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "dataflow_in_loop_VITIS_LOOP_471_3_U0", "Port" : "c_fft_col_op_st"}]},
			{"Name" : "p_read", "Type" : "None", "Direction" : "I"},
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "dataflow_in_loop_VITIS_LOOP_471_3_U0", "Port" : "gmem"}]},
			{"Name" : "fft_out", "Type" : "None", "Direction" : "I"},
			{"Name" : "wr_ptr", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "dataflow_in_loop_VITIS_LOOP_471_3_U0", "Port" : "wr_ptr"}]}],
		"Loop" : [
	...
	{"ID" : "3", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.dataflow_parent_loop_proc13_U0.dataflow_parent_loop_proc10_U0.dataflow_in_loop_VITIS_LOOP_471_3_U0", "Parent" : "2", "Child" : ["4", "5", "6", "7", "10", "15", "16"],
		...
		"InputProcess" : [
			...
			{"ID" : "7", "Name" : "ifmap_gen_y_U0"}],
		"OutputProcess" : [
			{"ID" : "10", "Name" : "ifmap_vec_write_U0"}],
		"Port" : [
			{"Name" : "c_fft_col_op_st", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "ifmap_gen_y_U0", "Port" : "c_fft_col_op_st"}]},
			{"Name" : "p_read", "Type" : "None", "Direction" : "I"},
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "ifmap_vec_write_U0", "Port" : "gmem"}]},
			{"Name" : "fft_out", "Type" : "None", "Direction" : "I"},
			{"Name" : "wr_ptr", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "ifmap_vec_write_U0", "Port" : "wr_ptr"}]}]},
	{"ID" : "4", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.dataflow_parent_loop_proc13_U0.dataflow_parent_loop_proc10_U0.dataflow_in_loop_VITIS_LOOP_471_3_U0.ifmap_CF_M_real_U", "Parent" : "3"},
	{"ID" : "5", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.dataflow_parent_loop_proc13_U0.dataflow_parent_loop_proc10_U0.dataflow_in_loop_VITIS_LOOP_471_3_U0.ifmap_CF_M_imag_U", "Parent" : "3"},
	{"ID" : "6", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.dataflow_parent_loop_proc13_U0.dataflow_parent_loop_proc10_U0.dataflow_in_loop_VITIS_LOOP_471_3_U0.entry_proc_U0", "Parent" : "3",
		"CDFG" : "entry_proc",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		...
		"Port" : [
			{"Name" : "fft_out", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "7", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.dataflow_parent_loop_proc13_U0.dataflow_parent_loop_proc10_U0.dataflow_in_loop_VITIS_LOOP_471_3_U0.ifmap_gen_y_U0", "Parent" : "3", "Child" : ["8", "9"],
		"CDFG" : "ifmap_gen_y",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "ifmap_CF_M_real", "Type" : "Memory", "Direction" : "O", "DependentProc" : "10", "DependentChan" : "4"},
			{"Name" : "ifmap_CF_M_imag", "Type" : "Memory", "Direction" : "O", "DependentProc" : "10", "DependentChan" : "5"},
			{"Name" : "p_read", "Type" : "None", "Direction" : "I"}],
		"Loop" : [
	...
	{"ID" : "8", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.dataflow_parent_loop_proc13_U0.dataflow_parent_loop_proc10_U0.dataflow_in_loop_VITIS_LOOP_471_3_U0.ifmap_gen_y_U0.mul_8ns_8ns_16_1_1_U441", "Parent" : "7"},
	{"ID" : "9", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.dataflow_parent_loop_proc13_U0.dataflow_parent_loop_proc10_U0.dataflow_in_loop_VITIS_LOOP_471_3_U0.ifmap_gen_y_U0.flow_control_loop_pipe_U", "Parent" : "7"},
	{"ID" : "10", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.dataflow_parent_loop_proc13_U0.dataflow_parent_loop_proc10_U0.dataflow_in_loop_VITIS_LOOP_471_3_U0.ifmap_vec_write_U0", "Parent" : "3", "Child" : ["11", "13", "14"],
		...
		"HasNonBlockingOperation" : "0",
		"Port" : [
			{"Name" : "ifmap_CF_M_real", "Type" : "Memory", "Direction" : "I", "DependentProc" : "7", "DependentChan" : "4",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "grp_ifmap_vec_write_Pipeline_VITIS_LOOP_419_2_fu_107", "Port" : "ifmap_CF_M_real", "Inst_start_state" : "6", "Inst_end_state" : "7"}]},
			{"Name" : "ifmap_CF_M_imag", "Type" : "Memory", "Direction" : "I", "DependentProc" : "7", "DependentChan" : "5",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "grp_ifmap_vec_write_Pipeline_VITIS_LOOP_419_2_fu_107", "Port" : "ifmap_CF_M_imag", "Inst_start_state" : "6", "Inst_end_state" : "7"}]},
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "gmem_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "gmem_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "grp_ifmap_vec_write_Pipeline_VITIS_LOOP_419_2_fu_107", "Port" : "gmem", "Inst_start_state" : "6", "Inst_end_state" : "7"}]},
			{"Name" : "p_read", "Type" : "None", "Direction" : "I", "DependentProc" : "6", "DependentChan" : "15", "DependentChanDepth" : "2", "DependentChanType" : "1"},
			{"Name" : "p_read1", "Type" : "None", "Direction" : "I", "DependentProc" : "7", "DependentChan" : "16", "DependentChanDepth" : "2", "DependentChanType" : "1"},
			{"Name" : "wr_ptr", "Type" : "OVld", "Direction" : "IO"}],
		"Loop" : [
	...
	{"ID" : "11", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.dataflow_parent_loop_proc13_U0.dataflow_parent_loop_proc10_U0.dataflow_in_loop_VITIS_LOOP_471_3_U0.ifmap_vec_write_U0.grp_ifmap_vec_write_Pipeline_VITIS_LOOP_419_2_fu_107", "Parent" : "10", "Child" : ["12"],
	...
	{"ID" : "12", "Level" : "6", "Path" : "`AUTOTB_DUT_INST.dataflow_parent_loop_proc13_U0.dataflow_parent_loop_proc10_U0.dataflow_in_loop_VITIS_LOOP_471_3_U0.ifmap_vec_write_U0.grp_ifmap_vec_write_Pipeline_VITIS_LOOP_419_2_fu_107.flow_control_loop_pipe_sequential_init_U", "Parent" : "11"},
	{"ID" : "13", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.dataflow_parent_loop_proc13_U0.dataflow_parent_loop_proc10_U0.dataflow_in_loop_VITIS_LOOP_471_3_U0.ifmap_vec_write_U0.mul_31ns_8ns_32_2_1_U452", "Parent" : "10"},
	{"ID" : "14", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.dataflow_parent_loop_proc13_U0.dataflow_parent_loop_proc10_U0.dataflow_in_loop_VITIS_LOOP_471_3_U0.ifmap_vec_write_U0.mul_31ns_9s_32_2_1_U453", "Parent" : "10"},
	{"ID" : "15", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.dataflow_parent_loop_proc13_U0.dataflow_parent_loop_proc10_U0.dataflow_in_loop_VITIS_LOOP_471_3_U0.fft_out_c_channel_U", "Parent" : "3"},
	{"ID" : "16", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.dataflow_parent_loop_proc13_U0.dataflow_parent_loop_proc10_U0.dataflow_in_loop_VITIS_LOOP_471_3_U0.ctrl1_reg_c_channel1_U", "Parent" : "3"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "236839"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "236839"}
]}
...
set Spec2ImplPortList { 
	layer1_reg_load_cast { ap_none {  { layer1_reg_load_cast in_data 0 16 } } }
