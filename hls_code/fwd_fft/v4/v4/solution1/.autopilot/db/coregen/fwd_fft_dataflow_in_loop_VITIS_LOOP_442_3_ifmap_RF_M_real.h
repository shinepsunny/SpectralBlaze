...
#ifndef _fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_H_
#define _fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore.h"

SC_MODULE(fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real) {
...
protected:
    ...
    fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore* fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore_U;
...
public:
    ...
    SC_CTOR(fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore_U = new fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore("fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore_U");
        fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore_U->clk      ( clk );
        fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore_U->reset    ( reset );
        fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore_U->ce0      ( i_ce0 );
        fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore_U->we0      ( i_we0 );
        fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore_U->address0 ( memcore_iaddr );
        fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore_U->d0       ( i_d0 );
        fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore_U->q0       ( i_q0 );

        fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore_U->ce1      ( t_ce0 );
        fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore_U->we1      ( t_we0 );
        fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore_U->address1 ( memcore_taddr );
        fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore_U->d1       ( t_d0 );
        fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "fwd_fft_dataflow_in_loop_VITIS_LOOP_442_3_ifmap_RF_M_real.trace");
            // ports
