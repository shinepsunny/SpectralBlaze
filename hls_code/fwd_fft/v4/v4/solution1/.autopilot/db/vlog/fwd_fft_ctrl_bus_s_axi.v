...
#(parameter
    ...
    output wire [31:0]                   ctrl1_reg,
    output wire [31:0]                   ctrl2_reg,
    output wire [31:0]                   layer1_reg,
    output wire [31:0]                   layer2_reg,
...
localparam
    ...
    ADDR_CTRL1_REG_DATA_0  = 7'h34,
    ADDR_CTRL1_REG_CTRL    = 7'h38,
    ADDR_CTRL2_REG_DATA_0  = 7'h3c,
    ADDR_CTRL2_REG_CTRL    = 7'h40,
    ADDR_LAYER1_REG_DATA_0 = 7'h44,
    ADDR_LAYER1_REG_CTRL   = 7'h48,
    ADDR_LAYER2_REG_DATA_0 = 7'h4c,
    ADDR_LAYER2_REG_CTRL   = 7'h50,
    WRIDLE                 = 2'd0,
    WRDATA                 = 2'd1,
    WRRESP                 = 2'd2,
    WRRESET                = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_ctrl1_reg = 'b0;
    reg  [31:0]                   int_ctrl2_reg = 'b0;
    reg  [31:0]                   int_layer1_reg = 'b0;
    reg  [31:0]                   int_layer2_reg = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_CTRL1_REG_DATA_0: begin
                    rdata <= int_ctrl1_reg[31:0];
                end
                ADDR_CTRL2_REG_DATA_0: begin
                    rdata <= int_ctrl2_reg[31:0];
                end
                ADDR_LAYER1_REG_DATA_0: begin
                    rdata <= int_layer1_reg[31:0];
                end
                ADDR_LAYER2_REG_DATA_0: begin
                    rdata <= int_layer2_reg[31:0];
                end
            endcase
        end
    end
...
assign ctrl1_reg         = int_ctrl1_reg;
assign ctrl2_reg         = int_ctrl2_reg;
assign layer1_reg        = int_layer1_reg;
assign layer2_reg        = int_layer2_reg;
// int_ap_start
always @(posedge ACLK) begin
    if (ARESET)
        int_ap_start <= 1'b0;
...
always @(posedge ACLK) begin
    if (ARESET)
        int_ctrl1_reg[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_CTRL1_REG_DATA_0)
            int_ctrl1_reg[31:0] <= (WDATA[31:0] & wmask) | (int_ctrl1_reg[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_ctrl2_reg[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_CTRL2_REG_DATA_0)
            int_ctrl2_reg[31:0] <= (WDATA[31:0] & wmask) | (int_ctrl2_reg[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_layer1_reg[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_LAYER1_REG_DATA_0)
            int_layer1_reg[31:0] <= (WDATA[31:0] & wmask) | (int_layer1_reg[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_layer2_reg[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_LAYER2_REG_DATA_0)
            int_layer2_reg[31:0] <= (WDATA[31:0] & wmask) | (int_layer2_reg[31:0] & ~wmask);
    end
end
