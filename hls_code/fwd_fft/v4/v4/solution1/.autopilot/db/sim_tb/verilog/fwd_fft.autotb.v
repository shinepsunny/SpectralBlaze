...
`define AUTOTB_DUT      fwd_fft
`define AUTOTB_DUT_INST AESL_inst_fwd_fft
`define AUTOTB_TOP      apatb_fwd_fft_top
`define AUTOTB_LAT_RESULT_FILE "fwd_fft.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "fwd_fft.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_fwd_fft_top
...
`define AESL_DEPTH_ctrl1_reg 1
`define AESL_DEPTH_ctrl2_reg 1
`define AESL_DEPTH_layer1_reg 1
`define AESL_DEPTH_layer2_reg 1
`define AUTOTB_TVIN_gmem  "./c.fwd_fft.autotvin_gmem.dat"
`define AUTOTB_TVIN_in1  "./c.fwd_fft.autotvin_in1.dat"
`define AUTOTB_TVIN_in2  "./c.fwd_fft.autotvin_in2.dat"
`define AUTOTB_TVIN_out_r  "./c.fwd_fft.autotvin_out_r.dat"
`define AUTOTB_TVIN_ctrl1_reg  "./c.fwd_fft.autotvin_ctrl1_reg.dat"
`define AUTOTB_TVIN_ctrl2_reg  "./c.fwd_fft.autotvin_ctrl2_reg.dat"
`define AUTOTB_TVIN_layer1_reg  "./c.fwd_fft.autotvin_layer1_reg.dat"
`define AUTOTB_TVIN_layer2_reg  "./c.fwd_fft.autotvin_layer2_reg.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.fwd_fft.autotvin_gmem.dat"
`define AUTOTB_TVIN_in1_out_wrapc  "./rtl.fwd_fft.autotvin_in1.dat"
`define AUTOTB_TVIN_in2_out_wrapc  "./rtl.fwd_fft.autotvin_in2.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.fwd_fft.autotvin_out_r.dat"
`define AUTOTB_TVIN_ctrl1_reg_out_wrapc  "./rtl.fwd_fft.autotvin_ctrl1_reg.dat"
`define AUTOTB_TVIN_ctrl2_reg_out_wrapc  "./rtl.fwd_fft.autotvin_ctrl2_reg.dat"
`define AUTOTB_TVIN_layer1_reg_out_wrapc  "./rtl.fwd_fft.autotvin_layer1_reg.dat"
`define AUTOTB_TVIN_layer2_reg_out_wrapc  "./rtl.fwd_fft.autotvin_layer2_reg.dat"
`define AUTOTB_TVOUT_gmem  "./c.fwd_fft.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.fwd_fft.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 301271;
parameter LENGTH_gmem = 3072;
parameter LENGTH_in1 = 1;
parameter LENGTH_in2 = 1;
parameter LENGTH_out_r = 1;
parameter LENGTH_ctrl1_reg = 1;
parameter LENGTH_ctrl2_reg = 1;
parameter LENGTH_layer1_reg = 1;
parameter LENGTH_layer2_reg = 1;
...
reg end_ctrl1_reg;
reg [31:0] size_ctrl1_reg;
reg [31:0] size_ctrl1_reg_backup;
reg end_ctrl2_reg;
reg [31:0] size_ctrl2_reg;
reg [31:0] size_ctrl2_reg_backup;
reg end_layer1_reg;
reg [31:0] size_layer1_reg;
reg [31:0] size_layer1_reg_backup;
reg end_layer2_reg;
reg [31:0] size_layer2_reg;
reg [31:0] size_layer2_reg_backup;
