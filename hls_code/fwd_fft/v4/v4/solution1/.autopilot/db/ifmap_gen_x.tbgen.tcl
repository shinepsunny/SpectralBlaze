...
set C_modelName {ifmap_gen_x}
set C_modelType { int 8 }
set C_modelArgList {
	{ c_row_op_st int 32 regular {fifo 0 volatile }  }
	{ ifmap_CF_M_real int 16 regular {array 4096 { 0 3 } 0 1 }  }
	{ ifmap_CF_M_imag int 16 regular {array 4096 { 0 3 } 0 1 }  }
	{ p_read int 8 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "c_row_op_st", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "ifmap_CF_M_real", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "ifmap_CF_M_imag", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ ifmap_CF_M_real_address0 sc_out sc_lv 12 signal 1 } 
	{ ifmap_CF_M_real_ce0 sc_out sc_logic 1 signal 1 } 
	{ ifmap_CF_M_real_we0 sc_out sc_logic 1 signal 1 } 
	{ ifmap_CF_M_real_d0 sc_out sc_lv 16 signal 1 } 
	{ ifmap_CF_M_imag_address0 sc_out sc_lv 12 signal 2 } 
	{ ifmap_CF_M_imag_ce0 sc_out sc_logic 1 signal 2 } 
	{ ifmap_CF_M_imag_we0 sc_out sc_logic 1 signal 2 } 
	{ ifmap_CF_M_imag_d0 sc_out sc_lv 16 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ifmap_CF_M_real_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ifmap_CF_M_real", "role": "we0" }} , 
 	{ "name": "ifmap_CF_M_real_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "ifmap_CF_M_real", "role": "d0" }} , 
 	...
 	{ "name": "ifmap_CF_M_imag_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ifmap_CF_M_imag", "role": "we0" }} , 
 	{ "name": "ifmap_CF_M_imag_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "ifmap_CF_M_imag", "role": "d0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8ns_8ns_16_1_1_U257", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	ifmap_CF_M_real { ap_memory {  { ifmap_CF_M_real_address0 mem_address 1 12 }  { ifmap_CF_M_real_ce0 mem_ce 1 1 }  { ifmap_CF_M_real_we0 mem_we 1 1 }  { ifmap_CF_M_real_d0 mem_din 1 16 } } }
	ifmap_CF_M_imag { ap_memory {  { ifmap_CF_M_imag_address0 mem_address 1 12 }  { ifmap_CF_M_imag_ce0 mem_ce 1 1 }  { ifmap_CF_M_imag_we0 mem_we 1 1 }  { ifmap_CF_M_imag_d0 mem_din 1 16 } } }
