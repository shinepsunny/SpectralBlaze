set moduleName ifmap_vec_write
set isTopModule 0
...
set C_modelName {ifmap_vec_write}
set C_modelType { void 0 }
set C_modelArgList {
	{ ifmap_CF_M_real int 32 regular {array 2048 { 1 1 } 1 1 }  }
	{ ifmap_CF_M_imag int 32 regular {array 2048 { 1 1 } 1 1 }  }
	{ gmem int 128 regular {axi_master 1}  }
	{ p_read int 64 regular  }
	{ p_read1 int 8 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ifmap_CF_M_real", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "ifmap_CF_M_imag", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ ifmap_CF_M_real_address0 sc_out sc_lv 11 signal 0 } 
	{ ifmap_CF_M_real_ce0 sc_out sc_logic 1 signal 0 } 
	{ ifmap_CF_M_real_q0 sc_in sc_lv 32 signal 0 } 
	{ ifmap_CF_M_real_address1 sc_out sc_lv 11 signal 0 } 
	{ ifmap_CF_M_real_ce1 sc_out sc_logic 1 signal 0 } 
	{ ifmap_CF_M_real_q1 sc_in sc_lv 32 signal 0 } 
	{ ifmap_CF_M_imag_address0 sc_out sc_lv 11 signal 1 } 
	{ ifmap_CF_M_imag_ce0 sc_out sc_logic 1 signal 1 } 
	{ ifmap_CF_M_imag_q0 sc_in sc_lv 32 signal 1 } 
	{ ifmap_CF_M_imag_address1 sc_out sc_lv 11 signal 1 } 
	{ ifmap_CF_M_imag_ce1 sc_out sc_logic 1 signal 1 } 
	{ ifmap_CF_M_imag_q1 sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ifmap_CF_M_real_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ifmap_CF_M_real", "role": "q0" }} , 
 	{ "name": "ifmap_CF_M_real_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "ifmap_CF_M_real", "role": "address1" }} , 
 	{ "name": "ifmap_CF_M_real_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ifmap_CF_M_real", "role": "ce1" }} , 
 	{ "name": "ifmap_CF_M_real_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ifmap_CF_M_real", "role": "q1" }} , 
 	...
 	{ "name": "ifmap_CF_M_imag_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ifmap_CF_M_imag", "role": "q0" }} , 
 	{ "name": "ifmap_CF_M_imag_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "ifmap_CF_M_imag", "role": "address1" }} , 
 	{ "name": "ifmap_CF_M_imag_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ifmap_CF_M_imag", "role": "ce1" }} , 
 	{ "name": "ifmap_CF_M_imag_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ifmap_CF_M_imag", "role": "q1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "4"],
		...
		"Port" : [
			{"Name" : "ifmap_CF_M_real", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_ifmap_vec_write_Pipeline_VITIS_LOOP_419_2_fu_107", "Port" : "ifmap_CF_M_real", "Inst_start_state" : "6", "Inst_end_state" : "7"}]},
			{"Name" : "ifmap_CF_M_imag", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_ifmap_vec_write_Pipeline_VITIS_LOOP_419_2_fu_107", "Port" : "ifmap_CF_M_imag", "Inst_start_state" : "6", "Inst_end_state" : "7"}]},
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "gmem_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "gmem_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_ifmap_vec_write_Pipeline_VITIS_LOOP_419_2_fu_107", "Port" : "gmem", "Inst_start_state" : "6", "Inst_end_state" : "7"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_ifmap_vec_write_Pipeline_VITIS_LOOP_419_2_fu_107", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ifmap_vec_write_Pipeline_VITIS_LOOP_419_2_fu_107.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_31ns_8ns_32_2_1_U452", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_31ns_9s_32_2_1_U453", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "291"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "291"}
]}
...
set Spec2ImplPortList { 
	ifmap_CF_M_real { ap_memory {  { ifmap_CF_M_real_address0 mem_address 1 11 }  { ifmap_CF_M_real_ce0 mem_ce 1 1 }  { ifmap_CF_M_real_q0 mem_dout 0 32 }  { ifmap_CF_M_real_address1 MemPortADDR2 1 11 }  { ifmap_CF_M_real_ce1 MemPortCE2 1 1 }  { ifmap_CF_M_real_q1 MemPortDOUT2 0 32 } } }
	ifmap_CF_M_imag { ap_memory {  { ifmap_CF_M_imag_address0 mem_address 1 11 }  { ifmap_CF_M_imag_ce0 mem_ce 1 1 }  { ifmap_CF_M_imag_q0 mem_dout 0 32 }  { ifmap_CF_M_imag_address1 MemPortADDR2 1 11 }  { ifmap_CF_M_imag_ce1 MemPortCE2 1 1 }  { ifmap_CF_M_imag_q1 MemPortDOUT2 0 32 } } }
